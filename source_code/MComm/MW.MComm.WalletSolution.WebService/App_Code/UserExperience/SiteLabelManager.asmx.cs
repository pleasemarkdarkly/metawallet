...
namespace MW.MComm.WalletSolution.WebService.UserExperience
{
	...
	/// <remarks></remarks>
	// ------------------------------------------------------------------------------
	[WebService(Namespace = "http://modsystems.com/MW.MComm.WalletSolution.WebService/UserExperience/SiteLabelManager")]
	[XmlType(Namespace = "http://modsystems.com/MW.MComm.WalletSolution.WebService/UserExperience")]
	public class SiteLabelManager : System.Web.Services.WebService
	{
		...
		///
		/// <param name="item">The SiteLabel to be managed.</param>
		/// <param name="performCascadeOperation">Flag, indicating if a cascade operation should be performed on the SiteLabel item.</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.UserExperience.SiteLabelResults AddOneSiteLabel(BLL.UserExperience.SiteLabel item, bool performCascadeOperation)
		{
			...
			try
			{
				...
				BLL.UserExperience.SiteLabelManager.AddOneSiteLabel(item, performCascadeOperation);
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.UserExperience.SiteLabelResults UpdateOneSiteLabel(BLL.UserExperience.SiteLabel item, bool performCascadeOperation)
		{
			Components.UserExperience.SiteLabelResults results = new Components.UserExperience.SiteLabelResults();
			results.StatusDescription = "Results OK";
			try
			{
				// perform main method tasks
				BLL.UserExperience.SiteLabelManager.UpdateOneSiteLabel(item, performCascadeOperation);
				results.Results.Add(item);
			}
			catch (System.Exception ex)
			{
		...
		/// <param name="performCascadeOperation">Flag, indicating if a cascade delete should be performed on the SiteLabel item.</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.UserExperience.SiteLabelResults DeleteOneSiteLabel(BLL.UserExperience.SiteLabel item, bool performCascadeOperation)
		{
			Components.UserExperience.SiteLabelResults results = new Components.UserExperience.SiteLabelResults();
			results.StatusDescription = "Results OK";
			try
			{
				// perform main method tasks
				BLL.UserExperience.SiteLabelManager.DeleteOneSiteLabel(item, performCascadeOperation);
			}
			catch (System.Exception ex)
			{
				results.StatusCode = -1;
