...
namespace MW.MComm.WalletSolution.WebService.Payments
{
	...
	public class TransactionStatusManager : System.Web.Services.WebService
	{
		...
		///
		/// <param name="item">The TransactionStatus to be managed.</param>
		/// <param name="performCascadeOperation">Flag, indicating if a cascade operation should be performed on the TransactionStatus item.</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Payments.TransactionStatusResults AddOneTransactionStatus(BLL.Payments.TransactionStatus item, bool performCascadeOperation)
		{
			...
			try
			{
				...
				BLL.Payments.TransactionStatusManager.AddOneTransactionStatus(item, performCascadeOperation);
		...
		/// <param name="performCascadeOperation">Flag, indicating if a cascade delete should be performed on the TransactionStatus item.</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Payments.TransactionStatusResults DeleteOneTransactionStatus(BLL.Payments.TransactionStatus item, bool performCascadeOperation)
		{
			Components.Payments.TransactionStatusResults results = new Components.Payments.TransactionStatusResults();
			results.StatusDescription = "Results OK";
			try
			{
				// perform main method tasks
				BLL.Payments.TransactionStatusManager.DeleteOneTransactionStatus(item, performCascadeOperation);
			}
			catch (System.Exception ex)
			{
				results.StatusCode = -1;
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Payments.TransactionStatusResults UpdateOneTransactionStatus(BLL.Payments.TransactionStatus item, bool performCascadeOperation)
		{
			Components.Payments.TransactionStatusResults results = new Components.Payments.TransactionStatusResults();
			results.StatusDescription = "Results OK";
			try
			{
				// perform main method tasks
				BLL.Payments.TransactionStatusManager.UpdateOneTransactionStatus(item, performCascadeOperation);
				results.Results.Add(item);
			}
			catch (System.Exception ex)
			{
