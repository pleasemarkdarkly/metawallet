...
namespace MW.MComm.WalletSolution.WebService.Environments
{
	...
	public class DateFormatManager : System.Web.Services.WebService
	{
		...
		///
		/// <param name="item">The DateFormat to be managed.</param>
		/// <param name="performCascadeOperation">Flag, indicating if a cascade operation should be performed on the DateFormat item.</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Environments.DateFormatResults AddOneDateFormat(BLL.Environments.DateFormat item, bool performCascadeOperation)
		{
			...
			try
			{
				...
				BLL.Environments.DateFormatManager.AddOneDateFormat(item, performCascadeOperation);
		...
		/// <param name="performCascadeOperation">Flag, indicating if a cascade delete should be performed on the DateFormat item.</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Environments.DateFormatResults DeleteOneDateFormat(BLL.Environments.DateFormat item, bool performCascadeOperation)
		{
			Components.Environments.DateFormatResults results = new Components.Environments.DateFormatResults();
			results.StatusDescription = "Results OK";
			try
			{
				// perform main method tasks
				BLL.Environments.DateFormatManager.DeleteOneDateFormat(item, performCascadeOperation);
			}
			catch (System.Exception ex)
			{
				results.StatusCode = -1;
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Environments.DateFormatResults UpdateOneDateFormat(BLL.Environments.DateFormat item, bool performCascadeOperation)
		{
			Components.Environments.DateFormatResults results = new Components.Environments.DateFormatResults();
			results.StatusDescription = "Results OK";
			try
			{
				// perform main method tasks
				BLL.Environments.DateFormatManager.UpdateOneDateFormat(item, performCascadeOperation);
				results.Results.Add(item);
			}
			catch (System.Exception ex)
			{
