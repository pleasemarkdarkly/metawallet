...
namespace MW.MComm.WalletSolution.WebService.Customers
{
	...
	public class MetaPartnerContactManager : System.Web.Services.WebService
	{
		...
		///
		/// <param name="item">The MetaPartnerContact to be managed.</param>
		/// <param name="performCascadeOperation">Flag, indicating if a cascade operation should be performed on the MetaPartnerContact item.</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Customers.MetaPartnerContactResults AddOneMetaPartnerContact(BLL.Customers.MetaPartnerContact item, bool performCascadeOperation)
		{
			...
			try
			{
				...
				BLL.Customers.MetaPartnerContactManager.AddOneMetaPartnerContact(item, performCascadeOperation);
		...
		/// <param name="performCascadeOperation">Flag, indicating if a cascade delete should be performed on the MetaPartnerContact item.</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Customers.MetaPartnerContactResults DeleteOneMetaPartnerContact(BLL.Customers.MetaPartnerContact item, bool performCascadeOperation)
		{
			Components.Customers.MetaPartnerContactResults results = new Components.Customers.MetaPartnerContactResults();
			results.StatusDescription = "Results OK";
			try
			{
				// perform main method tasks
				BLL.Customers.MetaPartnerContactManager.DeleteOneMetaPartnerContact(item, performCascadeOperation);
			}
			catch (System.Exception ex)
			{
				results.StatusCode = -1;
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Customers.MetaPartnerContactResults UpdateOneMetaPartnerContact(BLL.Customers.MetaPartnerContact item, bool performCascadeOperation)
		{
			Components.Customers.MetaPartnerContactResults results = new Components.Customers.MetaPartnerContactResults();
			results.StatusDescription = "Results OK";
			try
			{
				// perform main method tasks
				BLL.Customers.MetaPartnerContactManager.UpdateOneMetaPartnerContact(item, performCascadeOperation);
				results.Results.Add(item);
			}
			catch (System.Exception ex)
			{
