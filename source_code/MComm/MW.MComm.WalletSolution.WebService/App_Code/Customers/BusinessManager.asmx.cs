...
namespace MW.MComm.WalletSolution.WebService.Customers
{
	...
	public class BusinessManager : System.Web.Services.WebService
	{
		...
		///
		/// <param name="item">The Business to be managed.</param>
		/// <param name="performCascadeOperation">Flag, indicating if a cascade operation should be performed on the Business item.</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Customers.BusinessResults AddOneBusiness(BLL.Customers.Business item, bool performCascadeOperation)
		{
			...
			try
			{
				...
				BLL.Customers.BusinessManager.AddOneBusiness(item, performCascadeOperation);
		...
		/// <param name="performCascadeOperation">Flag, indicating if a cascade delete should be performed on the Business item.</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Customers.BusinessResults DeleteOneBusiness(BLL.Customers.Business item, bool performCascadeOperation)
		{
			Components.Customers.BusinessResults results = new Components.Customers.BusinessResults();
			results.StatusDescription = "Results OK";
			try
			{
				// perform main method tasks
				BLL.Customers.BusinessManager.DeleteOneBusiness(item, performCascadeOperation);
			}
			catch (System.Exception ex)
			{
				results.StatusCode = -1;
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Customers.BusinessResults UpdateOneBusiness(BLL.Customers.Business item, bool performCascadeOperation)
		{
			Components.Customers.BusinessResults results = new Components.Customers.BusinessResults();
			results.StatusDescription = "Results OK";
			try
			{
				// perform main method tasks
				BLL.Customers.BusinessManager.UpdateOneBusiness(item, performCascadeOperation);
				results.Results.Add(item);
			}
			catch (System.Exception ex)
			{
