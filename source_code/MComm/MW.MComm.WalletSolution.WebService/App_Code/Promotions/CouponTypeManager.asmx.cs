...
namespace MW.MComm.WalletSolution.WebService.Promotions
{
	...
	public class CouponTypeManager : System.Web.Services.WebService
	{
		...
		///
		/// <param name="item">The CouponType to be managed.</param>
		/// <param name="performCascadeOperation">Flag, indicating if a cascade operation should be performed on the CouponType item.</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Promotions.CouponTypeResults AddOneCouponType(BLL.Promotions.CouponType item, bool performCascadeOperation)
		{
			...
			try
			{
				...
				BLL.Promotions.CouponTypeManager.AddOneCouponType(item, performCascadeOperation);
		...
		/// <param name="performCascadeOperation">Flag, indicating if a cascade delete should be performed on the CouponType item.</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Promotions.CouponTypeResults DeleteOneCouponType(BLL.Promotions.CouponType item, bool performCascadeOperation)
		{
			Components.Promotions.CouponTypeResults results = new Components.Promotions.CouponTypeResults();
			results.StatusDescription = "Results OK";
			try
			{
				// perform main method tasks
				BLL.Promotions.CouponTypeManager.DeleteOneCouponType(item, performCascadeOperation);
			}
			catch (System.Exception ex)
			{
				results.StatusCode = -1;
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Promotions.CouponTypeResults UpdateOneCouponType(BLL.Promotions.CouponType item, bool performCascadeOperation)
		{
			Components.Promotions.CouponTypeResults results = new Components.Promotions.CouponTypeResults();
			results.StatusDescription = "Results OK";
			try
			{
				// perform main method tasks
				BLL.Promotions.CouponTypeManager.UpdateOneCouponType(item, performCascadeOperation);
				results.Results.Add(item);
			}
			catch (System.Exception ex)
			{
