...
namespace MW.MComm.WalletSolution.WebService.Accounts
{
	...
	public class DebitAccountManager : System.Web.Services.WebService
	{
		...
		///
		/// <param name="item">The DebitAccount to be managed.</param>
		/// <param name="performCascadeOperation">Flag, indicating if a cascade operation should be performed on the DebitAccount item.</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Accounts.DebitAccountResults AddOneDebitAccount(BLL.Accounts.DebitAccount item, bool performCascadeOperation)
		{
			...
			try
			{
				...
				BLL.Accounts.DebitAccountManager.AddOneDebitAccount(item, performCascadeOperation);
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Accounts.DebitAccountResults UpdateOneDebitAccount(BLL.Accounts.DebitAccount item, bool performCascadeOperation)
		{
			Components.Accounts.DebitAccountResults results = new Components.Accounts.DebitAccountResults();
			results.StatusDescription = "Results OK";
			try
			{
				// perform main method tasks
				BLL.Accounts.DebitAccountManager.UpdateOneDebitAccount(item, performCascadeOperation);
				results.Results.Add(item);
			}
			catch (System.Exception ex)
			{
		...
		/// <param name="performCascadeOperation">Flag, indicating if a cascade delete should be performed on the DebitAccount item.</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Accounts.DebitAccountResults DeleteOneDebitAccount(BLL.Accounts.DebitAccount item, bool performCascadeOperation)
		{
			Components.Accounts.DebitAccountResults results = new Components.Accounts.DebitAccountResults();
			results.StatusDescription = "Results OK";
			try
			{
				// perform main method tasks
				BLL.Accounts.DebitAccountManager.DeleteOneDebitAccount(item, performCascadeOperation);
			}
			catch (System.Exception ex)
			{
				results.StatusCode = -1;
