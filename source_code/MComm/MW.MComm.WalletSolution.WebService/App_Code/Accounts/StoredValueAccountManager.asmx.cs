...
namespace MW.MComm.WalletSolution.WebService.Accounts
{
	...
	public class StoredValueAccountManager : System.Web.Services.WebService
	{
		...
		///
		/// <param name="item">The StoredValueAccount to be managed.</param>
		/// <param name="performCascadeOperation">Flag, indicating if a cascade operation should be performed on the StoredValueAccount item.</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Accounts.StoredValueAccountResults AddOneStoredValueAccount(BLL.Accounts.StoredValueAccount item, bool performCascadeOperation)
		{
			...
			try
			{
				...
				BLL.Accounts.StoredValueAccountManager.AddOneStoredValueAccount(item, performCascadeOperation);
		...
		/// <param name="performCascadeOperation">Flag, indicating if a cascade delete should be performed on the StoredValueAccount item.</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Accounts.StoredValueAccountResults DeleteOneStoredValueAccount(BLL.Accounts.StoredValueAccount item, bool performCascadeOperation)
		{
			Components.Accounts.StoredValueAccountResults results = new Components.Accounts.StoredValueAccountResults();
			results.StatusDescription = "Results OK";
			try
			{
				// perform main method tasks
				BLL.Accounts.StoredValueAccountManager.DeleteOneStoredValueAccount(item, performCascadeOperation);
			}
			catch (System.Exception ex)
			{
				results.StatusCode = -1;
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Accounts.StoredValueAccountResults UpdateOneStoredValueAccount(BLL.Accounts.StoredValueAccount item, bool performCascadeOperation)
		{
			Components.Accounts.StoredValueAccountResults results = new Components.Accounts.StoredValueAccountResults();
			results.StatusDescription = "Results OK";
			try
			{
				// perform main method tasks
				BLL.Accounts.StoredValueAccountManager.UpdateOneStoredValueAccount(item, performCascadeOperation);
				results.Results.Add(item);
			}
			catch (System.Exception ex)
			{
