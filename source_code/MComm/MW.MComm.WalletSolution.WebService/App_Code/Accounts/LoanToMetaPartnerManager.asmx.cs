...
namespace MW.MComm.WalletSolution.WebService.Accounts
{
	...
	public class LoanToMetaPartnerManager : System.Web.Services.WebService
	{
		...
		///
		/// <param name="item">The LoanToMetaPartner to be managed.</param>
		/// <param name="performCascadeOperation">Flag, indicating if a cascade operation should be performed on the LoanToMetaPartner item.</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Accounts.LoanToMetaPartnerResults AddOneLoanToMetaPartner(BLL.Accounts.LoanToMetaPartner item, bool performCascadeOperation)
		{
			...
			try
			{
				...
				BLL.Accounts.LoanToMetaPartnerManager.AddOneLoanToMetaPartner(item, performCascadeOperation);
		...
		/// <param name="performCascadeOperation">Flag, indicating if a cascade delete should be performed on the LoanToMetaPartner item.</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Accounts.LoanToMetaPartnerResults DeleteOneLoanToMetaPartner(BLL.Accounts.LoanToMetaPartner item, bool performCascadeOperation)
		{
			Components.Accounts.LoanToMetaPartnerResults results = new Components.Accounts.LoanToMetaPartnerResults();
			results.StatusDescription = "Results OK";
			try
			{
				// perform main method tasks
				BLL.Accounts.LoanToMetaPartnerManager.DeleteOneLoanToMetaPartner(item, performCascadeOperation);
			}
			catch (System.Exception ex)
			{
				results.StatusCode = -1;
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Accounts.LoanToMetaPartnerResults UpdateOneLoanToMetaPartner(BLL.Accounts.LoanToMetaPartner item, bool performCascadeOperation)
		{
			Components.Accounts.LoanToMetaPartnerResults results = new Components.Accounts.LoanToMetaPartnerResults();
			results.StatusDescription = "Results OK";
			try
			{
				// perform main method tasks
				BLL.Accounts.LoanToMetaPartnerManager.UpdateOneLoanToMetaPartner(item, performCascadeOperation);
				results.Results.Add(item);
			}
			catch (System.Exception ex)
			{
