...
namespace MW.MComm.WalletSolution.WebService.Notifications
{
	...
	public class NotificationDeliveryLogManager : System.Web.Services.WebService
	{
		...
		///
		/// <param name="item">The NotificationDeliveryLog to be managed.</param>
		/// <param name="performCascadeOperation">Flag, indicating if a cascade operation should be performed on the NotificationDeliveryLog item.</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Notifications.NotificationDeliveryLogResults AddOneNotificationDeliveryLog(BLL.Notifications.NotificationDeliveryLog item, bool performCascadeOperation)
		{
			...
			try
			{
				...
				BLL.Notifications.NotificationDeliveryLogManager.AddOneNotificationDeliveryLog(item, performCascadeOperation);
		...
		/// <param name="performCascadeOperation">Flag, indicating if a cascade delete should be performed on the NotificationDeliveryLog item.</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Notifications.NotificationDeliveryLogResults DeleteOneNotificationDeliveryLog(BLL.Notifications.NotificationDeliveryLog item, bool performCascadeOperation)
		{
			Components.Notifications.NotificationDeliveryLogResults results = new Components.Notifications.NotificationDeliveryLogResults();
			results.StatusDescription = "Results OK";
			try
			{
				// perform main method tasks
				BLL.Notifications.NotificationDeliveryLogManager.DeleteOneNotificationDeliveryLog(item, performCascadeOperation);
			}
			catch (System.Exception ex)
			{
				results.StatusCode = -1;
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Notifications.NotificationDeliveryLogResults UpdateOneNotificationDeliveryLog(BLL.Notifications.NotificationDeliveryLog item, bool performCascadeOperation)
		{
			Components.Notifications.NotificationDeliveryLogResults results = new Components.Notifications.NotificationDeliveryLogResults();
			results.StatusDescription = "Results OK";
			try
			{
				// perform main method tasks
				BLL.Notifications.NotificationDeliveryLogManager.UpdateOneNotificationDeliveryLog(item, performCascadeOperation);
				results.Results.Add(item);
			}
			catch (System.Exception ex)
			{
