...
using MW.MComm.SMS.WebService.Users;
using BLL = MW.MComm.SMS.BLL;
using MW.MComm.SMS.BLL.Users;
using MOD.Data;
using Utility = MW.MComm.SMS.Utility;
using Microsoft.Practices.EnterpriseLibrary.ExceptionHandling;

namespace MW.MComm.SMS.WebService.Users
{
	// ------------------------------------------------------------------------------
	...
	public class UserManager : System.Web.Services.WebService
	{
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Users.UserResults GetAllUserDataByCriteria(string userName, string firstName, string lastName, string lastModifiedDateStart, string lastModifiedDateEnd, string sortColumn, string sortDirection)
		{
			Components.Users.UserResults results = new Components.Users.UserResults();
			results.StatusDescription = "Results OK";
			try
			{
				// perform main method tasks
				results.Results = BLL.Users.UserManager.GetAllUserDataByCriteria(MOD.Data.SearchHelper.GetString(userName), MOD.Data.SearchHelper.GetString(firstName), MOD.Data.SearchHelper.GetString(lastName), MOD.Data.SearchHelper.GetDateTime(lastModifiedDateStart), MOD.Data.SearchHelper.GetDateTime(lastModifiedDateEnd), Globals.getDataOptions(sortColumn, sortDirection));
				results.TotalRecords = results.Results.Count;
			}
			catch (System.Exception ex)
			{
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Users.UserResults GetManyUserDataByCriteria(string userName, string firstName, string lastName, string lastModifiedDateStart, string lastModifiedDateEnd, int startIndex, int pageSize, int maximumListSize, string sortColumn, string sortDirection)
		{
			Components.Users.UserResults results = new Components.Users.UserResults();
			results.StatusDescription = "Results OK";
			try
			{
				...
				results.Results = BLL.Users.UserManager.GetManyUserDataByCriteria(MOD.Data.SearchHelper.GetString(userName), MOD.Data.SearchHelper.GetString(firstName), MOD.Data.SearchHelper.GetString(lastName), MOD.Data.SearchHelper.GetDateTime(lastModifiedDateStart), MOD.Data.SearchHelper.GetDateTime(lastModifiedDateEnd), out totalRecords, out maximumListSizeExceeded, Globals.getDataOptions(sortColumn, sortDirection, startIndex, pageSize, maximumListSize));
				results.TotalRecords = results.Results.Count;
			}
			catch (System.Exception ex)
			{
