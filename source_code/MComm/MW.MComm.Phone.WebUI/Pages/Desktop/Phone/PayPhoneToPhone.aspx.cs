...
namespace MW.MComm.Phone.WebUI.Pages.Desktop.Phone
{
	...
	/// <remarks></remarks>
	// ------------------------------------------------------------------------------
	public partial class PayPhoneToPhone : Components.Desktop.BasePage
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			{
				EventLog.WriteEntry("MW.MComm.Phone.WebUI", "Phone/PayPhoneToPhone page load");
			}
		}
