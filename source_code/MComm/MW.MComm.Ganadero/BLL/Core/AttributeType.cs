...
namespace MW.MComm.Ganadero.BLL.Core
{
	...
	// ------------------------------------------------------------------------------
	[Serializable()]
	[DataTransform(Name = "MW.MComm.Ganadero.DAL.Core.AttributeType")]
	public partial class AttributeType : BusinessObject
	{
		...
		{
			BLL.Core.AttributeType businessObject = BLL.Core.AttributeTypeManager.Load(attributeTypeCode);
		...
		public void Save(bool performCascade)
		{
			...
			string key = BLL.Core.AttributeType.GetCacheKey(typeof(BLL.Core.AttributeType), "PrimaryKey", PrimaryKey);
