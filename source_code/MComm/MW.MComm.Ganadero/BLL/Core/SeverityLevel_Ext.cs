...
{
	// ------------------------------------------------------------------------------
	/// <summary>This enumeration is for holding known SeverityLevel codes.</summary>
	///
	/// <remarks></remarks>
	// ------------------------------------------------------------------------------
	public enum SeverityLevelCode
	{
		/// <summary>None.</summary>
		None = 0,
		/// <summary>No severity (not a problem).</summary>
		OK = 1,
		/// <summary>A warning severity level.</summary>
		Warning = 2,
		/// <summary>A non critical severity level.</summary>
		NonCriticalError = 3,
		/// <summary>A critical error severity level.</summary>
		CriticalError = 4,
	}
	// ------------------------------------------------------------------------------
