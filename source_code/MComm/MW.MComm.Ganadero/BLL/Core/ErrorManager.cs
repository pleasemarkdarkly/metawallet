...
namespace MW.MComm.Ganadero.BLL.Core
{
	...
	public partial class ErrorManager
	{
		...
		// ------------------------------------------------------------------------------
		public static BLL.Core.Error Load(int errorNumber)
		{
			BLL.Core.Error businessObject = new BLL.Core.Error(errorNumber);
			string key = BLL.Core.Error.GetCacheKey(typeof(BLL.Core.Error), "PrimaryKey", businessObject.PrimaryKey);
			businessObject = (BLL.Core.Error)Utility.CacheManager.Cache[key];
		...
		public static void AddOneError(BLL.Core.Error item, bool performCascadeOperation )
		{
			try
			{
				...
				DAL.Core.Error.AddOneError(itemDAL, performCascadeOperation, ConfigurationInterface.DBOptions, ConfigurationInterface.DebugLevel);
		...
		public static void DeleteOneError(BLL.Core.Error item, bool performCascadeOperation )
		{
			try
			{
				...
				DAL.Core.Error itemDAL = new DAL.Core.Error();
				ReflectionHelper.Copy(item, itemDAL, true);
				DAL.Core.Error.DeleteOneError(itemDAL, performCascadeOperation, ConfigurationInterface.DBOptions, ConfigurationInterface.DebugLevel);
				ReflectionHelper.Copy(itemDAL, item, true);
				item.IsLoaded = false;
			}
			catch (System.Exception ex)
		...
		public static BLL.SortableList<BLL.Core.Error> GetAllErrorData(MOD.Data.DataOptions dataOptions)
		{
			try
			{
				...
				BLL.SortableList<BLL.Core.Error> sortableList = new BLL.SortableList<BLL.Core.Error>(DAL.Core.Error.GetAllErrorData(ConfigurationInterface.DBOptions, dataOptions, ConfigurationInterface.DebugLevel), true, true);
		...
		public static BLL.SortableList<BLL.Core.Error> GetAllErrorData()
		{
			try
			{
				...
				BLL.SortableList<BLL.Core.Error> sortableList = new BLL.SortableList<BLL.Core.Error>(DAL.Core.Error.GetAllErrorData(ConfigurationInterface.DBOptions, ConfigurationInterface.DefaultDataOptions, ConfigurationInterface.DebugLevel), true, true);
				foreach(BLL.Core.Error loopObject in sortableList)
				{
					loopObject.IsLoaded = true;
				}
		...
		public static BLL.Core.Error GetOneError(int errorNumber, MOD.Data.DataOptions dataOptions)
		{
			try
			{
				// perform main method tasks
				Globals.AddRequiredFilterProperties(dataOptions, ConfigurationInterface.CurrentUserID);
				DAL.Core.Error item = null;
				item = DAL.Core.Error.GetOneError(errorNumber, ConfigurationInterface.DBOptions, dataOptions, ConfigurationInterface.DebugLevel);
		...
		public static BLL.Core.Error GetOneError(int errorNumber)
		{
			try
			{
				...
				Globals.AddRequiredFilterProperties(ConfigurationInterface.DefaultDataOptions, ConfigurationInterface.CurrentUserID);
				DAL.Core.Error item = null;
				item = DAL.Core.Error.GetOneError(errorNumber, ConfigurationInterface.DBOptions, ConfigurationInterface.DefaultDataOptions, ConfigurationInterface.DebugLevel);
				BLL.Core.Error itemBLL = null;
				if (item != null)
				{
					itemBLL = new BLL.Core.Error();
		...
		public static BLL.Core.Error GetOneError(int errorNumber, MOD.Data.DatabaseOptions dbOptions, MOD.Data.DataOptions dataOptions, int debugLevel, Guid currentUserID)
		{
			try
			{
				...
				Globals.AddRequiredFilterProperties(dataOptions, currentUserID);
				DAL.Core.Error item = null;
				item = DAL.Core.Error.GetOneError(errorNumber, dbOptions, dataOptions, debugLevel);
				BLL.Core.Error itemBLL = null;
				if (item != null)
				{
					itemBLL = new BLL.Core.Error();
		...
		public static void UpdateOneError(BLL.Core.Error item, bool performCascadeOperation )
		{
			try
			{
				...
				DAL.Core.Error itemDAL = new DAL.Core.Error();
				ReflectionHelper.Copy(item, itemDAL, true);
				DAL.Core.Error.UpdateOneError(itemDAL, performCascadeOperation, ConfigurationInterface.DBOptions, ConfigurationInterface.DebugLevel);
				ReflectionHelper.Copy(itemDAL, item, true);
				item.IsLoaded = true;
			}
			catch (System.Exception ex)
