...
namespace MW.MComm.Ganadero.BLL.Core
{
	...
	// ------------------------------------------------------------------------------
	[Serializable()]
	[DataTransform(Name = "MW.MComm.Ganadero.DAL.Core.DebugAttribute")]
	public partial class DebugAttribute : BLL.Core.BaseAttribute
	{
		...
		{
			BLL.Core.DebugAttribute businessObject = BLL.Core.DebugAttributeManager.Load(baseAttributeID);
		...
		public new void Save(bool performCascade)
		{
			...
			string key = BLL.Core.DebugAttribute.GetCacheKey(typeof(BLL.Core.DebugAttribute), "PrimaryKey", PrimaryKey);
