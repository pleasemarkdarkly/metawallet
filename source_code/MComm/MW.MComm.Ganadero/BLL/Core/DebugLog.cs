...
namespace MW.MComm.Ganadero.BLL.Core
{
	...
	// ------------------------------------------------------------------------------
	[Serializable()]
	[DataTransform(Name = "MW.MComm.Ganadero.DAL.Core.DebugLog")]
	public partial class DebugLog : BusinessObject
	{
		...
		[XmlArray(ElementName="DebugAttributeValueLogList")]
		[XmlArrayItem(typeof(BLL.Core.DebugAttributeValueLog), ElementName="DebugAttributeValueLog")]
		public BLL.SortableList<BLL.Core.DebugAttributeValueLog> _debugAttributeValueLogList = null;
		...
		public virtual int SeverityLevelCode
		{
			...
			set
			{
				if (_severityLevelCode != value)
				{
					...
					// reset SeverityLevel
					BLL.BusinessObject vSeverityLevel = (BLL.BusinessObject) SeverityLevel;
					vSeverityLevel = null;
					_isDirty = true;
				}
			}
		...
		public virtual BLL.Core.SeverityLevel SeverityLevel
		{
			get
			{
				if (_severityLevel == null  && IsLoaded == true)
				{
		...
		public virtual BLL.SortableList<BLL.Core.DebugAttributeValueLog> DebugAttributeValueLogList
		{
			get
			{
				if (_debugAttributeValueLogList == null  && IsLoaded == true)
				{
			...
			set
			{
				if ((_debugAttributeValueLogList == null && value != null) ||
		...
		{
			BLL.Core.DebugLog businessObject = BLL.Core.DebugLogManager.Load(debugLogID);
		...
		public void Save(bool performCascade)
		{
			...
			string key = BLL.Core.DebugLog.GetCacheKey(typeof(BLL.Core.DebugLog), "PrimaryKey", PrimaryKey);
