...
namespace MW.MComm.Ganadero.BLL.Events
{
	...
	// ------------------------------------------------------------------------------
	[Serializable()]
	[DataTransform(Name = "MW.MComm.Ganadero.DAL.Events.AuditAttributeValueLog")]
	public partial class AuditAttributeValueLog : BusinessObject
	{
		...
		public virtual Guid AuditLogID
		{
			...
			set
			{
				if (_auditLogID != value)
				{
					...
					// reset AuditLog
					BLL.BusinessObject vAuditLog = (BLL.BusinessObject) AuditLog;
					vAuditLog = null;
					_isDirty = true;
				}
			}
		...
		public virtual Guid BaseAttributeID
		{
			...
			set
			{
				if (_baseAttributeID != value)
				{
					...
					BLL.BusinessObject vEventAttribute = (BLL.BusinessObject) EventAttribute;
		...
		public virtual BLL.Events.AuditLog AuditLog
		{
			get
			{
				if (_auditLog == null  && IsLoaded == true)
				{
		...
		public virtual BLL.Events.EventAttribute EventAttribute
		{
			get
			{
				if (_eventAttribute == null  && IsLoaded == true)
				{
		...
		{
			BLL.Events.AuditAttributeValueLog businessObject = BLL.Events.AuditAttributeValueLogManager.Load(auditAttributeValueLogID);
		...
		public void Save(bool performCascade)
		{
			...
			string key = BLL.Events.AuditAttributeValueLog.GetCacheKey(typeof(BLL.Events.AuditAttributeValueLog), "PrimaryKey", PrimaryKey);
