		...
		public static void LogOneDebugLog(DebugLog item, bool performCascadeOperation, MOD.Data.SqlProcAdapter dbAdapter)
		{
			try
			{
				...
				if (performCascadeOperation == true)
				{
					...
					{
						MOD.Data.SortableObjectCollection debugAttributeValueLogList = DAL.Core.DebugAttributeValueLog.GetAllDebugAttributeValueLogDataByDebugLogID(item.DebugLogID, dbAdapter);
