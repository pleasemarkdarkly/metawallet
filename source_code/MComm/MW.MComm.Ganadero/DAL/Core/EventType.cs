	...
	public partial class EventType : Utility.BaseDataAccessObject
	{
		...
		public static void AddOneEventType(EventType item, bool performCascadeOperation, MOD.Data.DatabaseOptions dbOptions, int debugLevel)
		{
			...
			catch (System.Exception ex)
			{
				...
				throw Utility.CustomAppException.WrapException(ex, "DAL.Core.AddOneEventType");
			}
			finally
			{
		...
		public static void AddOneEventType(EventType item, bool performCascadeOperation, MOD.Data.SqlProcAdapter dbAdapter)
		{
			try
			{
				...
				dbAdapter.ExecuteProcNQ("spCore_AddOneEventType", item, spParameters);
		...
		public static void DeleteOneEventType(EventType item, bool performCascadeOperation, MOD.Data.DatabaseOptions dbOptions, int debugLevel)
		{
			...
			catch (System.Exception ex)
			{
				...
				throw Utility.CustomAppException.WrapException(ex, "DAL.Core.DeleteOneEventType");
			}
			finally
			{
				dbManager.ClearAdapter();
		...
		public static void DeleteOneEventType(EventType item, bool performCascadeOperation, MOD.Data.SqlProcAdapter dbAdapter)
		{
			try
			{
				...
				MOD.Data.NamedObjectCollection spParameters = new MOD.Data.NamedObjectCollection();
				dbAdapter.ExecuteProcNQ("spCore_DeleteOneEventType", item, spParameters);
		...
		public static MOD.Data.SortableObjectCollection GetAllEventTypeData(MOD.Data.DatabaseOptions dbOptions, MOD.Data.DataOptions dataOptions, int debugLevel)
		{
			...
			try
			{
				...
				DataTable dt = dbAdapter.ExecuteProc("spCore_GetAllEventTypeData", null, spParameters);
			...
			{
				throw Utility.CustomAppException.WrapException(ex, "DAL.Core.GetAllEventTypeData");
			}
			finally
			{
				dbManager.ClearAdapter();
		...
		public static EventType GetOneEventType(int eventTypeCode, MOD.Data.DatabaseOptions dbOptions, MOD.Data.DataOptions dataOptions, int debugLevel)
		{
			...
			try
			{
				...
				DataTable dt = dbAdapter.ExecuteProc("spCore_GetOneEventType", null, spParameters);
			...
			{
				throw Utility.CustomAppException.WrapException(ex, "DAL.Core.GetOneEventType");
			}
			finally
			{
				dbManager.ClearAdapter();
		...
		public static void UpdateOneEventType(EventType item, bool performCascadeOperation, MOD.Data.DatabaseOptions dbOptions, int debugLevel)
		{
			...
			catch (System.Exception ex)
			{
				...
				throw Utility.CustomAppException.WrapException(ex, "DAL.Core.UpdateOneEventType");
			}
			finally
			{
				dbManager.ClearAdapter();
		...
		public static void UpdateOneEventType(EventType item, bool performCascadeOperation, MOD.Data.SqlProcAdapter dbAdapter)
		{
			try
			{
				// perform main method tasks
				MOD.Data.NamedObjectCollection spParameters = new MOD.Data.NamedObjectCollection();
				dbAdapter.ExecuteProcNQ("spCore_UpdateOneEventType", item, spParameters);
