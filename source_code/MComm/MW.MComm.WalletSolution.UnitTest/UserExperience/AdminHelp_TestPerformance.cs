...
{
    // ------------------------------------------------------------------------------
    /// <summary>This class is used to run BLL method tests for AdminHelp instances.</summary>
    ///
    /// File History:
    ...
    /// <remarks></remarks>
    // ------------------------------------------------------------------------------
    [TestFixture, FixtureCategory("Performance.UserExperience"), Author("Common"), Importance(TestImportance.Serious), TestsOn(typeof(BLL.UserExperience.AdminHelp))]
    public partial class AdminHelp_TestPerformance : BaseUnitTest
    {
        ...
        // ------------------------------------------------------------------------------
        public AdminHelp_TestPerformance() : base()
        {
        }
        ...
        // ------------------------------------------------------------------------------
        /// <summary>This method is the performance entity test for AdminHelp.</summary>
        // ------------------------------------------------------------------------------
        [Test]
        public void UserExperience_AdminHelp_PerformanceTest()
        {
            try
            {
                Console.WriteLine("******************** UserExperience_AdminHelp_PerformanceTest START ********************");
                ...
                TestHelper.ReportValueToConsole("UserExperience_AdminHelp_PerformanceTest: Value generation method: Random seed -- Current ticks", currentTicks.ToString());
                ...
                {
                    TestHelper.ReportValueToConsole("UserExperience_AdminHelp_PerformanceTest: " + TestHelper.GetUnitTestPerformanceLevelString((UnitTestPerformanceLevel)(i + 1)) + " time (in seconds)", perfTimeLevels[i]);
                }
                TestHelper.ReportValueToConsole("UserExperience_AdminHelp_PerformanceTest: " + TestHelper.GetUnitTestPerformanceLevelString(UnitTestPerformanceLevel.Unacceptable) + " time (in seconds) is beyond", perfTimeLevels[(((int)UnitTestPerformanceLevel.Unacceptable - 1) - 1)]);
                ...
                TestHelper.ReportValueToConsole("UserExperience_AdminHelp_PerformanceTest: page size", pageSize);
                TestHelper.ReportValueToConsole("UserExperience_AdminHelp_PerformanceTest: maxListSize", maxListSize);
                ...
                TestHelper.ReportValueToConsole("UserExperience_AdminHelp_PerformanceTest: GetManyAdminHelpDataByCriteria test count", loadCount.ToString());
                for (int i=0; i < loadCount; i++)
                {
                    long startTicks = 0;
                    long endTicks = 0;
                    double secondsInterval = 0.00;
                    BLL.SortableList<BLL.UserExperience.AdminHelp> items = null;

                    TestHelper.ReportValueToConsole("UserExperience_AdminHelp_PerformanceTest: Loop Iteration", i);
                    ...
                    TestHelper.ReportValueToConsole("UserExperience_AdminHelp_PerformanceTest: GetManyAdminHelpDataByCriteria acceptable search time (in seconds)", acceptableTime);
                    try
                    {
                        // get many
                        Results.ResetCurrentPerfMetric();
                        Results.SetPerfMetricName("UserExperience.AdminHelp.GetMany." + i.ToString());
                        items = AdminHelp_Manager.GetManyAdminHelpDataByCriteriaTest(dbOptions, Results);
                        TestHelper.ReportValueToConsole("UserExperience_AdminHelp_PerformanceTest: GetManyAdminHelpDataByCriteria succeeded for AdminHelp. The count", items.Count.ToString());
                        ...
                        perfStr = "GetManyAdminHelpDataByCriteria search time (in seconds) for AdminHelp count " + items.Count + " was " + avgCallsTime + ". " + TestHelper.GetUnitTestPerformanceLevelString(perfLevel) + ".";
                    ...
                    catch (System.Exception ex)
                    {
                        ...
                        {
                            UpdateUnitTestErrorInfo(UnitTestErrorType.Functional,"GetManyAdminHelpDataByCriteria failed for AdminHelp", itemStr, ex, strExtraInfo);
                        }
                    }

                    if (items != null)
                    {
                        TestHelper.ReportValueToConsole("UserExperience_AdminHelp_PerformanceTest: GetManyAdminHelpDataByCriteria acceptable serialization time (in seconds)", acceptableTime);
                        try
                        {
                            // serialize
                            Results.ResetCurrentPerfMetric();
                            Results.SetPerfMetricName("UserExperience.AdminHelp.Serialize." + i.ToString());
                            ...
                            perfLevel = TestHelper.GetPerformanceLevelFromTime(avgCallsTime, perfTimeLevels);
                            perfStr = "GetManyAdminHelpDataByCriteria serialization time (in seconds) for AdminHelp count " + items.Count + " was " + avgCallsTime + ". " + TestHelper.GetUnitTestPerformanceLevelString(perfLevel) + ".";
                            throw new UnitTestException(TestHelper.GetUnitTestErrorTypeForPerformanceLevel(perfLevel), perfStr, null);
                        }
                        catch (System.Exception ex)
                        {
                        ...
                        TestHelper.ReportValueToConsole("UserExperience_AdminHelp_PerformanceTest: GetManyAdminHelpDataByCriteria acceptable deserialization time (in seconds)", acceptableTime);
                        try
                        {
                            // deserialize
                            Results.ResetCurrentPerfMetric();
                            Results.SetPerfMetricName("UserExperience.AdminHelp.Deserialize." + i.ToString());
                            ...
                            items = (BLL.SortableList<BLL.UserExperience.AdminHelp>)oItems;
                            int itemCount = items.Count;
                            oItems = null;
                            items = null;

                            perfLevel = TestHelper.GetPerformanceLevelFromTime(avgCallsTime, perfTimeLevels);
                            perfStr = "GetManyAdminHelpDataByCriteria deserialization time (in seconds) for AdminHelp count " + itemCount + " was " + avgCallsTime + ". " + TestHelper.GetUnitTestPerformanceLevelString(perfLevel) + ".";
                            throw new UnitTestException(TestHelper.GetUnitTestErrorTypeForPerformanceLevel(perfLevel), perfStr, null);
                        }
                        catch (System.Exception ex)
                        {
                ...
                if (numGetDataSearches > 0)
                {
                    ...
                    TestHelper.ReportValueToConsole("UserExperience_AdminHelp_PerformanceTest: GetManyAdminHelpDataByCriteria AVERAGE SEARCH TIME (in seconds)", avgGetDataSearchSecs);
                }
                else
                {
                    Console.WriteLine("UserExperience_AdminHelp_PerformanceTest: GetManyAdminHelpDataByCriteria -- Could not perform search. NO AVERAGE SEARCH TIME AVAILABLE.");
                }
                if (numSerializations > 0)
                {
                    avgSerializeDataSecs /= numSerializations;
                    TestHelper.ReportValueToConsole("UserExperience_AdminHelp_PerformanceTest: GetManyAdminHelpDataByCriteria AVERAGE SERIALIZATION TIME (in seconds)", avgSerializeDataSecs);
                }
                else
                {
                    Console.WriteLine("UserExperience_AdminHelp_PerformanceTest: GetManyAdminHelpDataByCriteria -- Could not serialize. NO AVERAGE SERIALIZATION TIME AVAILABLE.");
                }
                if (numDeserializations > 0)
                {
                    avgDeserializeDataSecs /= numDeserializations;
                    TestHelper.ReportValueToConsole("UserExperience_AdminHelp_PerformanceTest: GetManyAdminHelpDataByCriteria AVERAGE DESERIALIZATION TIME (in seconds)", avgDeserializeDataSecs);
                }
                else
                {
                    Console.WriteLine("UserExperience_AdminHelp_PerformanceTest: GetManyAdminHelpDataByCriteria -- Could not deserialize. NO AVERAGE DESERIALIZATION TIME AVAILABLE.");
                }
                ...
                Console.WriteLine("******************** UserExperience_AdminHelp_PerformanceTest END **********************");
                Console.WriteLine();
                Console.WriteLine();
                if ((ErrorIndex > 0) || (WarningIndex > 0))
                {
                    Console.WriteLine("==================== UserExperience_AdminHelp_PerformanceTest Error/Warning Details ====");
                    Console.WriteLine();
                }
            }
            catch (System.Exception ex)
