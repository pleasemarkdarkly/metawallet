...
namespace MW.MComm.WalletSolution.UnitTest.UserExperience
{
    ...
    /// <remarks></remarks>
    // ------------------------------------------------------------------------------
    [TestFixture, FixtureCategory("Performance.UserExperience"), Author("Common"), Importance(TestImportance.Serious), TestsOn(typeof(BLL.UserExperience.SiteHelpDefinition))]
    public partial class SiteHelpDefinition_TestPerformance : BaseUnitTest
    {
        ...
        // ------------------------------------------------------------------------------
        public SiteHelpDefinition_TestPerformance() : base()
        {
        }
        ...
        // ------------------------------------------------------------------------------
        /// <summary>This method is the performance entity test for SiteHelpDefinition.</summary>
        // ------------------------------------------------------------------------------
        [Test]
        public void UserExperience_SiteHelpDefinition_PerformanceTest()
        {
            try
            {
                Console.WriteLine("******************** UserExperience_SiteHelpDefinition_PerformanceTest START ********************");
                ...
                Console.WriteLine("GetAllSiteHelpDefinitionData test count is {0}.", loadCount.ToString());
                for (int i=0; i < loadCount; i++)
                {
                    try
                    {
                        BLL.SortableList<BLL.UserExperience.SiteHelpDefinition> items = SiteHelpDefinition_Manager.GetAllSiteHelpDefinitionDataTest(Results);
                        Console.WriteLine("GetAllSiteHelpDefinitionData succeeded for SiteHelpDefinition.");
                        ...
                        items = (BLL.SortableList<BLL.UserExperience.SiteHelpDefinition>)oItems;
                        oItems = null;
                        items = null;
                    }
                    catch (System.Exception ex)
                    {
                        ...
                        {
                            UpdateUnitTestErrorInfo(UnitTestErrorType.Functional, "GetAllSiteHelpDefinitionData failed for SiteHelpDefinition", itemStr, ex, strExtraInfo);
                        }
                    }
                }

                Console.WriteLine("******************** UserExperience_SiteHelpDefinition_PerformanceTest END **********************");
                Console.WriteLine();
                Console.WriteLine();
                if ((ErrorIndex > 0) || (WarningIndex > 0))
                {
                    Console.WriteLine("==================== UserExperience_SiteHelpDefinition_PerformanceTest Error/Warning Details ====");
                    Console.WriteLine();
                }
            }
            catch (System.Exception ex)
