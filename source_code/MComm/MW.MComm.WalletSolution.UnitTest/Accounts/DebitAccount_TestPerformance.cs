...
namespace MW.MComm.WalletSolution.UnitTest.Accounts
{
    ...
    /// <remarks></remarks>
    // ------------------------------------------------------------------------------
    [TestFixture, FixtureCategory("Performance.Accounts"), Author("Common"), Importance(TestImportance.Serious), TestsOn(typeof(BLL.Accounts.DebitAccount))]
    public partial class DebitAccount_TestPerformance : BaseUnitTest
    {
        ...
        // ------------------------------------------------------------------------------
        public DebitAccount_TestPerformance() : base()
        {
        }
        ...
        // ------------------------------------------------------------------------------
        /// <summary>This method is the performance entity test for DebitAccount.</summary>
        // ------------------------------------------------------------------------------
        [Test]
        public void Accounts_DebitAccount_PerformanceTest()
        {
            try
            {
                Console.WriteLine("******************** Accounts_DebitAccount_PerformanceTest START ********************");
                ...
                TestHelper.ReportValueToConsole("Accounts_DebitAccount_PerformanceTest: Value generation method: Random seed -- Current ticks", currentTicks.ToString());
                ...
                {
                    TestHelper.ReportValueToConsole("Accounts_DebitAccount_PerformanceTest: " + TestHelper.GetUnitTestPerformanceLevelString((UnitTestPerformanceLevel)(i + 1)) + " time (in seconds)", perfTimeLevels[i]);
                }
                TestHelper.ReportValueToConsole("Accounts_DebitAccount_PerformanceTest: " + TestHelper.GetUnitTestPerformanceLevelString(UnitTestPerformanceLevel.Unacceptable) + " time (in seconds) is beyond", perfTimeLevels[(((int)UnitTestPerformanceLevel.Unacceptable - 1) - 1)]);
                ...
                TestHelper.ReportValueToConsole("Accounts_DebitAccount_PerformanceTest: page size", pageSize);
                TestHelper.ReportValueToConsole("Accounts_DebitAccount_PerformanceTest: maxListSize", maxListSize);
                ...
                TestHelper.ReportValueToConsole("Accounts_DebitAccount_PerformanceTest: GetManyDebitAccountDataByCriteria test count", loadCount.ToString());
                for (int i=0; i < loadCount; i++)
                {
                    long startTicks = 0;
                    long endTicks = 0;
                    double secondsInterval = 0.00;
                    BLL.SortableList<BLL.Accounts.DebitAccount> items = null;

                    TestHelper.ReportValueToConsole("Accounts_DebitAccount_PerformanceTest: Loop Iteration", i);
                    ...
                    TestHelper.ReportValueToConsole("Accounts_DebitAccount_PerformanceTest: GetManyDebitAccountDataByCriteria acceptable search time (in seconds)", acceptableTime);
                    try
                    {
                        // get many
                        Results.ResetCurrentPerfMetric();
                        Results.SetPerfMetricName("Accounts.DebitAccount.GetMany." + i.ToString());
                        items = DebitAccount_Manager.GetManyDebitAccountDataByCriteriaTest(dbOptions, Results);
                        TestHelper.ReportValueToConsole("Accounts_DebitAccount_PerformanceTest: GetManyDebitAccountDataByCriteria succeeded for DebitAccount. The count", items.Count.ToString());
                        ...
                        perfStr = "GetManyDebitAccountDataByCriteria search time (in seconds) for DebitAccount count " + items.Count + " was " + avgCallsTime + ". " + TestHelper.GetUnitTestPerformanceLevelString(perfLevel) + ".";
                    ...
                    if (items != null)
                    {
                        TestHelper.ReportValueToConsole("Accounts_DebitAccount_PerformanceTest: GetManyDebitAccountDataByCriteria acceptable serialization time (in seconds)", acceptableTime);
                        try
                        {
                            // serialize
                            Results.ResetCurrentPerfMetric();
                            Results.SetPerfMetricName("Accounts.DebitAccount.Serialize." + i.ToString());
                            ...
                            perfLevel = TestHelper.GetPerformanceLevelFromTime(avgCallsTime, perfTimeLevels);
                            perfStr = "GetManyDebitAccountDataByCriteria serialization time (in seconds) for DebitAccount count " + items.Count + " was " + avgCallsTime + ". " + TestHelper.GetUnitTestPerformanceLevelString(perfLevel) + ".";
                            throw new UnitTestException(TestHelper.GetUnitTestErrorTypeForPerformanceLevel(perfLevel), perfStr, null);
                        }
                        catch (System.Exception ex)
                        {
                        ...
                        TestHelper.ReportValueToConsole("Accounts_DebitAccount_PerformanceTest: GetManyDebitAccountDataByCriteria acceptable deserialization time (in seconds)", acceptableTime);
                        try
                        {
                            // deserialize
                            Results.ResetCurrentPerfMetric();
                            Results.SetPerfMetricName("Accounts.DebitAccount.Deserialize." + i.ToString());
                            ...
                            perfLevel = TestHelper.GetPerformanceLevelFromTime(avgCallsTime, perfTimeLevels);
                            perfStr = "GetManyDebitAccountDataByCriteria deserialization time (in seconds) for DebitAccount count " + itemCount + " was " + avgCallsTime + ". " + TestHelper.GetUnitTestPerformanceLevelString(perfLevel) + ".";
                            throw new UnitTestException(TestHelper.GetUnitTestErrorTypeForPerformanceLevel(perfLevel), perfStr, null);
                        }
                        catch (System.Exception ex)
                        {
                ...
                if (numGetDataSearches > 0)
                {
                    ...
                    TestHelper.ReportValueToConsole("Accounts_DebitAccount_PerformanceTest: GetManyDebitAccountDataByCriteria AVERAGE SEARCH TIME (in seconds)", avgGetDataSearchSecs);
                }
                else
                {
                    Console.WriteLine("Accounts_DebitAccount_PerformanceTest: GetManyDebitAccountDataByCriteria -- Could not perform search. NO AVERAGE SEARCH TIME AVAILABLE.");
                }
                if (numSerializations > 0)
                {
                    avgSerializeDataSecs /= numSerializations;
                    TestHelper.ReportValueToConsole("Accounts_DebitAccount_PerformanceTest: GetManyDebitAccountDataByCriteria AVERAGE SERIALIZATION TIME (in seconds)", avgSerializeDataSecs);
                }
                else
                {
                    Console.WriteLine("Accounts_DebitAccount_PerformanceTest: GetManyDebitAccountDataByCriteria -- Could not serialize. NO AVERAGE SERIALIZATION TIME AVAILABLE.");
                }
                if (numDeserializations > 0)
                {
                    avgDeserializeDataSecs /= numDeserializations;
                    TestHelper.ReportValueToConsole("Accounts_DebitAccount_PerformanceTest: GetManyDebitAccountDataByCriteria AVERAGE DESERIALIZATION TIME (in seconds)", avgDeserializeDataSecs);
                }
                else
                {
                    Console.WriteLine("Accounts_DebitAccount_PerformanceTest: GetManyDebitAccountDataByCriteria -- Could not deserialize. NO AVERAGE DESERIALIZATION TIME AVAILABLE.");
                }
                ...
                Console.WriteLine("******************** Accounts_DebitAccount_PerformanceTest END **********************");
                Console.WriteLine();
                Console.WriteLine();
                if ((ErrorIndex > 0) || (WarningIndex > 0))
                {
                    Console.WriteLine("==================== Accounts_DebitAccount_PerformanceTest Error/Warning Details ====");
                    Console.WriteLine();
                }
            }
            catch (System.Exception ex)
