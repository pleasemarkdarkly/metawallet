...
namespace MW.MComm.WalletSolution.UnitTest.Accounts
{
    ...
    /// <remarks></remarks>
    // ------------------------------------------------------------------------------
    [TestFixture, FixtureCategory("Performance.Accounts"), Author("Common"), Importance(TestImportance.Serious), TestsOn(typeof(BLL.Accounts.AccountSubType))]
    public partial class AccountSubType_TestPerformance : BaseUnitTest
    {
        ...
        // ------------------------------------------------------------------------------
        public AccountSubType_TestPerformance() : base()
        {
        }
        ...
        // ------------------------------------------------------------------------------
        /// <summary>This method is the performance entity test for AccountSubType.</summary>
        // ------------------------------------------------------------------------------
        [Test]
        public void Accounts_AccountSubType_PerformanceTest()
        {
            try
            {
                Console.WriteLine("******************** Accounts_AccountSubType_PerformanceTest START ********************");
                ...
                Console.WriteLine("GetAllAccountSubTypeData test count is {0}.", loadCount.ToString());
                for (int i=0; i < loadCount; i++)
                {
                    try
                    {
                        BLL.SortableList<BLL.Accounts.AccountSubType> items = AccountSubType_Manager.GetAllAccountSubTypeDataTest(Results);
                        Console.WriteLine("GetAllAccountSubTypeData succeeded for AccountSubType.");
                        ...
                        items = (BLL.SortableList<BLL.Accounts.AccountSubType>)oItems;
                        oItems = null;
                        items = null;
                    }
                    catch (System.Exception ex)
                    {
                        ...
                        {
                            UpdateUnitTestErrorInfo(UnitTestErrorType.Functional, "GetAllAccountSubTypeData failed for AccountSubType", itemStr, ex, strExtraInfo);
                        }
                    }
                }

                Console.WriteLine("******************** Accounts_AccountSubType_PerformanceTest END **********************");
                Console.WriteLine();
                Console.WriteLine();
                if ((ErrorIndex > 0) || (WarningIndex > 0))
                {
                    Console.WriteLine("==================== Accounts_AccountSubType_PerformanceTest Error/Warning Details ====");
                    Console.WriteLine();
                }
            }
            catch (System.Exception ex)
