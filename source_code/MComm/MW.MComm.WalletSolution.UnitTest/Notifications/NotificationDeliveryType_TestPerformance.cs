...
namespace MW.MComm.WalletSolution.UnitTest.Notifications
{
    ...
    /// <remarks></remarks>
    // ------------------------------------------------------------------------------
    [TestFixture, FixtureCategory("Performance.Notifications"), Author("Common"), Importance(TestImportance.Serious), TestsOn(typeof(BLL.Notifications.NotificationDeliveryType))]
    public partial class NotificationDeliveryType_TestPerformance : BaseUnitTest
    {
        ...
        // ------------------------------------------------------------------------------
        public NotificationDeliveryType_TestPerformance() : base()
        {
        }
        ...
        // ------------------------------------------------------------------------------
        /// <summary>This method is the performance entity test for NotificationDeliveryType.</summary>
        // ------------------------------------------------------------------------------
        [Test]
        public void Notifications_NotificationDeliveryType_PerformanceTest()
        {
            try
            {
                Console.WriteLine("******************** Notifications_NotificationDeliveryType_PerformanceTest START ********************");
                ...
                Console.WriteLine("GetAllNotificationDeliveryTypeData test count is {0}.", loadCount.ToString());
                for (int i=0; i < loadCount; i++)
                {
                    try
                    {
                        BLL.SortableList<BLL.Notifications.NotificationDeliveryType> items = NotificationDeliveryType_Manager.GetAllNotificationDeliveryTypeDataTest(Results);
                        Console.WriteLine("GetAllNotificationDeliveryTypeData succeeded for NotificationDeliveryType.");
                        ...
                        items = (BLL.SortableList<BLL.Notifications.NotificationDeliveryType>)oItems;
                        oItems = null;
                        items = null;
                    }
                    catch (System.Exception ex)
                    {
                        ...
                        {
                            UpdateUnitTestErrorInfo(UnitTestErrorType.Functional, "GetAllNotificationDeliveryTypeData failed for NotificationDeliveryType", itemStr, ex, strExtraInfo);
                        }
                    }
                }

                Console.WriteLine("******************** Notifications_NotificationDeliveryType_PerformanceTest END **********************");
                Console.WriteLine();
                Console.WriteLine();
                if ((ErrorIndex > 0) || (WarningIndex > 0))
                {
                    Console.WriteLine("==================== Notifications_NotificationDeliveryType_PerformanceTest Error/Warning Details ====");
                    Console.WriteLine();
                }
            }
            catch (System.Exception ex)
