...
namespace MW.MComm.WalletSolution.UnitTest.Events
{
    ...
    /// <remarks></remarks>
    // ------------------------------------------------------------------------------
    [TestFixture, FixtureCategory("Basic.Events"), Author("Common"), Importance(TestImportance.Serious), TestsOn(typeof(BLL.Events.AuditAttributeValueLog))]
    public partial class AuditAttributeValueLog_TestBasic : BaseUnitTest
    {
        ...
        // ------------------------------------------------------------------------------
        public AuditAttributeValueLog_TestBasic() : base()
        {
        }
        ...
        // ------------------------------------------------------------------------------
        /// <summary>This method is the basic entity test for AuditAttributeValueLog.</summary>
        // ------------------------------------------------------------------------------
        [Test]
        public void Events_AuditAttributeValueLog_BasicTest()
        {
            try
            {
                ...
                Console.WriteLine("******************** Events_AuditAttributeValueLog_BasicTest START ********************");
                ...
                BLL.Events.AuditAttributeValueLog item = null;
                int currentTicks = (int)DateTime.Now.Ticks;
                TestHelper.ReportValueToConsole("Events_AuditAttributeValueLog_BasicTest: Value generation method: Random seed -- Current ticks", currentTicks.ToString());
                ...
                TestHelper.ReportValueToConsole("Events_AuditAttributeValueLog_BasicTest: Next entity add load count", loadCount.ToString());
                ...
                // add items
                //
                TestHelper.ReportValueToConsole("Events_AuditAttributeValueLog_BasicTest: Add AuditAttributeValueLog count", loadCount.ToString());
                for (int i=0; i < loadCount; i++)
                {
                    Results.IsCollision = false;
                    try
                    {
                        item = AuditAttributeValueLog_Manager.AddOneAuditAttributeValueLogTest(true, Results);
                        ...
                        else
                        {
                            ...
                            entityID["AuditAttributeValueLogID"] = item.AuditAttributeValueLogID;
                            idList.Add(entityID);
                            TestHelper.ReportValueToConsole("Events_AuditAttributeValueLog_BasicTest: Add succeeded for AuditAttributeValueLog", item.PrimaryKey.ToString());
                            ...
                            item = (BLL.Events.AuditAttributeValueLog)oItem;
                            oItem = null;
                            item = null;
                        }
                    }
                    catch (System.Exception ex)
                    {
                        ...
                        {
                            UpdateUnitTestErrorInfo(UnitTestErrorType.Functional, "Serialization failed for AuditAttributeValueLog", itemStr, serialEx, strExtraInfo);
                        }
                        ...
                        {
                            UpdateUnitTestErrorInfo(UnitTestErrorType.Functional, "Add failed for AuditAttributeValueLog", itemStr, ex, strExtraInfo);
                        }
                    }
                }

                // TODO: Assert Warning if AuditAttributeValueLog Add count is not the same as Update count
                ...
                Console.WriteLine("******************** Events_AuditAttributeValueLog_BasicTest END **********************");
                Console.WriteLine();
                Console.WriteLine();
                if ((ErrorIndex > 0) || (WarningIndex > 0))
                {
                    Console.WriteLine("==================== Events_AuditAttributeValueLog_BasicTest Error/Warning Details ====");
                    Console.WriteLine();
                }
            }
            catch (System.Exception ex)
