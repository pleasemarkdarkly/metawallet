...
{
	// ------------------------------------------------------------------------------
	/// <summary>Working Coupon Data is used to help manage Coupon information.</summary>
	///
	/// File History:
	...
	/// <remarks></remarks>
	// ------------------------------------------------------------------------------
	public partial class WorkingCouponData  : Components.Desktop.BaseListUserControl
	{
		#region Fields
		#endregion Fields
		#region Properties
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "WorkingCouponData.Page_Load"));
			}
			finally
			{
			}
		...
		private void dgPrimaryList_ItemDataBound(object sender, DataGridItemEventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "WorkingCouponData.dgPrimaryList_ItemDataBound"));
			}
			finally
			{
			}
		...
		{
			_collection = (BLL.SortableList<BLL.Promotions.Coupon>) Session["Promotions/CouponWorkingSet"];
			if (_collection != null)
			{
				((BLL.SortableList<BLL.Promotions.Coupon>)_collection).Sort(SortColumn, SortDirection);
		...
		public void dgPrimaryList_ItemCommand(object sender, EventArgs e)
		{
			...
			if (_collection != null)
			{
				...
				else if (args.CommandName == "Select")
				{
					int hashCode = int.Parse(args.CommandArgument.ToString());
					BLL.Promotions.Coupon item = ((BLL.SortableList<BLL.Promotions.Coupon>)_collection).Find(hashCode);
					Session["Promotions/CouponWorkingSetItem"] = item.PrimaryIndex;
				}
			}
		}
		// ------------------------------------------------------------------------------
		...
		///
		// ------------------------------------------------------------------------------
		public void AddItem(BLL.Promotions.Coupon item)
		{
			_collection = (BLL.SortableList<BLL.Promotions.Coupon>) Session["Promotions/CouponWorkingSet"];
			if (_collection == null)
			{
				_collection = new BLL.SortableList<BLL.Promotions.Coupon>();
			}
			...
			else
			{
				...
				TotalRecords = _collection.Count;
				Session["Promotions/CouponWorkingSetItem"] = item.PrimaryIndex;
				Globals.AddStatusMessage("Coupon working set item added.");
			}
			Session["Promotions/CouponWorkingSet"] = _collection;
		}
		// ------------------------------------------------------------------------------
		/// <summary>Item command event handler for Coupon list.</summary>
		///
		// ------------------------------------------------------------------------------
		public void RemoveItem(BLL.Promotions.Coupon item)
		{
			Globals.ClearMessages();
			_collection = (BLL.SortableList<BLL.Promotions.Coupon>) Session["Promotions/CouponWorkingSet"];
			if (_collection != null)
			{
				...
				Globals.AddStatusMessage("Coupon working set item removed.");
			}
			Session["Promotions/CouponWorkingSet"] = _collection;
		}
		// ------------------------------------------------------------------------------
		...
		private void Page_PreRender(object sender, EventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "WorkingCouponData.Page_PreRender"));
			}
			finally
			{
			}
