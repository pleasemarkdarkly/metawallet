...
{
	// ------------------------------------------------------------------------------
	/// <summary>Search Meta Partner Coupon Data is used to help manage MetaPartnerCoupon information.</summary>
	///
	/// File History:
	...
	/// <remarks></remarks>
	// ------------------------------------------------------------------------------
	public partial class SearchMetaPartnerCouponData  : Components.Desktop.BaseSearchUserControl
	{
		#region Fields
		#endregion Fields
		#region Properties
		...
		// ------------------------------------------------------------------------------
		/// <summary>Load page for Meta Partner Coupon search.</summary>
		///
		// ------------------------------------------------------------------------------
		private void Page_Load(object sender, System.EventArgs e)
		{
			try
			{
				workingMetaPartnerCouponData.Visible = ProvideWorkingSet;
				base.OnLoad(); // base list control manages loading data
				if (WorkflowMode != WorkflowMode.Internal)
				{
					if (Session["SearchPromotions/MetaPartnerCouponData"] != null)
					{
						_collection = (BLL.SortableList<BLL.Promotions.MetaPartnerCoupon>)Session["SearchPromotions/MetaPartnerCouponData"];
					}
				}
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "SearchMetaPartnerCouponData.Page_Load"));
			}
			finally
			{
			}
		...
		private void editMetaPartnerCoupon_MetaPartnerCouponAdded(BaseFormlUserControl sender, EntityEditEventArgs e)
		{
			...
			{
				Globals.AddErrorMessage(this.Page, "Collection already contains this Meta Partner Coupon", new object[0]);
			}
			else
			{
		...
		private void dgPrimaryList_ItemDataBound(object sender, DataGridItemEventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "SearchMetaPartnerCouponData.dgPrimaryList_ItemDataBound"));
			}
			finally
			{
			}
		...
		// ------------------------------------------------------------------------------
		/// <summary>Set Meta Partner Coupon information from the ui.</summary>
		///
		// ------------------------------------------------------------------------------
		protected override void SetDataFromForm()
		{
			Session["CouponCode"] = GetStringFromTextBox(txtCouponCode);
		...
		protected override void LoadCollectionFromDatabase()
		{
			try
			{
				...
				int? couponCode = MOD.Data.SearchHelper.GetInt(Session["CouponCode"]);
				...
				{
					_collection = BLL.Promotions.MetaPartnerCouponManager.GetManyMetaPartnerCouponDataByCriteria(couponCode, startDate, endDate, lastModifiedDateStart, lastModifiedDateEnd, out totalRecords, out maximumListSizeExceeded, this.DataOptions);
					Session["SearchPromotions/MetaPartnerCouponData"] = _collection;
		...
		public void dgPrimaryList_ItemCommand(object sender, EventArgs e)
		{
			...
			if (args.CommandName == "Add" || args.CommandName == "Edit" || args.CommandName == "Delete")
			{
				...
				{
					workingMetaPartnerCouponData.AddItem(item);
				}
		...
		private void Page_PreRender(object sender, EventArgs e)
		{
			try
			{
				...
				if (IsPostBack == false)
				{
					txtCouponCode.Text = MOD.Data.DataHelper.GetString(Session["CouponCode"], "");
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "SearchMetaPartnerCouponData.Page_PreRender"));
			}
			finally
			{
			}
		...
		// ------------------------------------------------------------------------------
		/// <summary>Clear search form for Meta Partner Coupon.</summary>
		///
		// ------------------------------------------------------------------------------
		...
		// ------------------------------------------------------------------------------
		/// <summary>Perform search for Meta Partner Coupon items.</summary>
		///
		// ------------------------------------------------------------------------------
		private void btnSearch_Click(object sender, EventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "SearchMetaPartnerCouponData.btnSearch_Click"));
			}
			finally
			{
			}
