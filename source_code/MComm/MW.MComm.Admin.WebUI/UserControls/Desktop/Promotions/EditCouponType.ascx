...
<%@ Control Language="c#" AutoEventWireup="false" CodeFile ="EditCouponType.ascx.cs" Inherits="MW.MComm.Admin.WebUI.UserControls.Desktop.Promotions.EditCouponType" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
...
<wilson:masterpage id="Masterpage" runat="server" templatefile="~/Templates/Desktop/DetailControl.ascx">
	<wilson:contentregion id="Title" runat="server">
		<asp:Label id="lblTitle" CssClass="subtitle" Runat="server">Edit Coupon&nbsp;Type</asp:Label>&nbsp;<asp:Label id="lblTitleMessage" CssClass="subtitle" Runat="server"></asp:Label>
	...
	<wilson:contentregion id="ItemInfo" runat="server">
		...
		<table>
			<tr>
				...
				<td>
					<span class="ID">
					<MODC:PropVal id="propCouponTypeCode" runat="server" prop="CouponTypeItem.CouponTypeCode" cssclass="ID"></MODC:PropVal>
					</span>
				</td>
			</tr>
			<tr>
				...
				<td>
					<span class="ID">
					<MODC:PropVal id="propCouponTypeName" runat="server" prop="CouponTypeItem.CouponTypeName" cssclass="ID"></MODC:PropVal>
					</span>
				</td>
			</tr>
		</table>
	...
	<MODC:PageSection id="Section_Basics" visible="false" runat="server">
		<table>
			<tr>
				<td valign="top"><span class="FormLabelRequired"><asp:Label ID="lblCouponTypeCodeDisplay" runat="server">Coupon&nbsp;Type&nbsp;Code:</asp:Label></span></td>
				<td valign="top">
					<asp:TextBox id="txtCouponTypeCode" tabIndex="1" runat="server" maxLength="5" Width="100" CssClass="FormNormal"></asp:TextBox>
					<asp:RangeValidator id="valCouponTypeCode" ControlToValidate="txtCouponTypeCode" EnableClientScript="False" Display="Dynamic" Runat="server" Type="Integer" MinimumValue="-2147483648" MaximumValue="2147483647" ErrorMessage="Must be a valid int from -2147483648 to 2147483647." ></asp:RangeValidator>
					<asp:RequiredFieldValidator id="valCouponTypeCodeRequired" ControlToValidate="txtCouponTypeCode" EnableClientScript="False" Display="Dynamic" Runat="server" ErrorMessage="Please enter a valid int from 1 to 2147483647." ></asp:RequiredFieldValidator>
				</td>
			</tr>
			<tr>
				<td valign="top"><span class="FormLabelRequired"><asp:Label ID="lblCouponTypeNameDisplay" runat="server">Coupon&nbsp;Type&nbsp;Name:</asp:Label></span></td>
				<td valign="top">
					<asp:TextBox id="txtCouponTypeName" tabIndex="2" runat="server" maxLength="255" Width="300" CssClass="FormNormal"></asp:TextBox>
					<asp:RequiredFieldValidator id="valCouponTypeNameRequired" ControlToValidate="txtCouponTypeName" EnableClientScript="False" Display="Dynamic" Runat="server" ErrorMessage="Please enter some text." ></asp:RequiredFieldValidator>
				</td>
			</tr>
			<tr>
