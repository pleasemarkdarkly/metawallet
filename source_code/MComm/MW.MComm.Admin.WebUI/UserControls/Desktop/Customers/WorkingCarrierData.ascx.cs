...
{
	// ------------------------------------------------------------------------------
	/// <summary>Working Carrier Data is used to help manage Carrier information.</summary>
	///
	/// File History:
	...
	/// <remarks></remarks>
	// ------------------------------------------------------------------------------
	public partial class WorkingCarrierData  : Components.Desktop.BaseListUserControl
	{
		#region Fields
		#endregion Fields
		#region Properties
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "WorkingCarrierData.Page_Load"));
			}
			finally
			{
			}
		...
		private void dgPrimaryList_ItemDataBound(object sender, DataGridItemEventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "WorkingCarrierData.dgPrimaryList_ItemDataBound"));
			}
			finally
			{
			}
		...
		{
			_collection = (BLL.SortableList<BLL.Customers.Carrier>) Session["Customers/CarrierWorkingSet"];
			if (_collection != null)
			{
				((BLL.SortableList<BLL.Customers.Carrier>)_collection).Sort(SortColumn, SortDirection);
		...
		public void dgPrimaryList_ItemCommand(object sender, EventArgs e)
		{
			...
			if (_collection != null)
			{
				...
				else if (args.CommandName == "Select")
				{
					int hashCode = int.Parse(args.CommandArgument.ToString());
					BLL.Customers.Carrier item = ((BLL.SortableList<BLL.Customers.Carrier>)_collection).Find(hashCode);
					Session["Customers/CarrierWorkingSetItem"] = item.PrimaryIndex;
				}
			}
		}
		// ------------------------------------------------------------------------------
		...
		///
		// ------------------------------------------------------------------------------
		public void AddItem(BLL.Customers.Carrier item)
		{
			_collection = (BLL.SortableList<BLL.Customers.Carrier>) Session["Customers/CarrierWorkingSet"];
			if (_collection == null)
			{
				_collection = new BLL.SortableList<BLL.Customers.Carrier>();
			}
			...
			else
			{
				...
				TotalRecords = _collection.Count;
				Session["Customers/CarrierWorkingSetItem"] = item.PrimaryIndex;
				Globals.AddStatusMessage("Carrier working set item added.");
			}
			Session["Customers/CarrierWorkingSet"] = _collection;
		}
		// ------------------------------------------------------------------------------
		/// <summary>Item command event handler for Carrier list.</summary>
		///
		// ------------------------------------------------------------------------------
		public void RemoveItem(BLL.Customers.Carrier item)
		{
			Globals.ClearMessages();
			_collection = (BLL.SortableList<BLL.Customers.Carrier>) Session["Customers/CarrierWorkingSet"];
			if (_collection != null)
			{
				...
				Globals.AddStatusMessage("Carrier working set item removed.");
			}
			Session["Customers/CarrierWorkingSet"] = _collection;
		}
		// ------------------------------------------------------------------------------
		...
		private void Page_PreRender(object sender, EventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "WorkingCarrierData.Page_PreRender"));
			}
			finally
			{
			}
