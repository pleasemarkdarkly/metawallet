...
<%@ Control Language="c#" AutoEventWireup="false" CodeFile ="ListCarrierData.ascx.cs" Inherits="MW.MComm.Admin.WebUI.UserControls.Desktop.Customers.ListCarrierData" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
...
<wilson:masterpage id="Masterpage" runat="server" templatefile="~/Templates/Desktop/ListControl.ascx">
	<wilson:contentregion id="Title" runat="server">
		<asp:Label id="lblTitle" CssClass="subtitle" Runat="server">Carrier List</asp:Label>
