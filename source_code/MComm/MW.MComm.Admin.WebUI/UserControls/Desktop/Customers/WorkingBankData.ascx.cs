...
{
	// ------------------------------------------------------------------------------
	/// <summary>Working Bank Data is used to help manage Bank information.</summary>
	///
	/// File History:
	...
	/// <remarks></remarks>
	// ------------------------------------------------------------------------------
	public partial class WorkingBankData  : Components.Desktop.BaseListUserControl
	{
		#region Fields
		#endregion Fields
		#region Properties
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "WorkingBankData.Page_Load"));
			}
			finally
			{
			}
		...
		private void dgPrimaryList_ItemDataBound(object sender, DataGridItemEventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "WorkingBankData.dgPrimaryList_ItemDataBound"));
			}
			finally
			{
			}
		...
		{
			_collection = (BLL.SortableList<BLL.Customers.Bank>) Session["Customers/BankWorkingSet"];
			if (_collection != null)
			{
				((BLL.SortableList<BLL.Customers.Bank>)_collection).Sort(SortColumn, SortDirection);
		...
		public void dgPrimaryList_ItemCommand(object sender, EventArgs e)
		{
			...
			if (_collection != null)
			{
				...
				else if (args.CommandName == "Select")
				{
					int hashCode = int.Parse(args.CommandArgument.ToString());
					BLL.Customers.Bank item = ((BLL.SortableList<BLL.Customers.Bank>)_collection).Find(hashCode);
					Session["Customers/BankWorkingSetItem"] = item.PrimaryIndex;
				}
			}
		}
		// ------------------------------------------------------------------------------
		...
		///
		// ------------------------------------------------------------------------------
		public void AddItem(BLL.Customers.Bank item)
		{
			_collection = (BLL.SortableList<BLL.Customers.Bank>) Session["Customers/BankWorkingSet"];
			if (_collection == null)
			{
				_collection = new BLL.SortableList<BLL.Customers.Bank>();
			}
			...
			else
			{
				...
				TotalRecords = _collection.Count;
				Session["Customers/BankWorkingSetItem"] = item.PrimaryIndex;
				Globals.AddStatusMessage("Bank working set item added.");
			}
			Session["Customers/BankWorkingSet"] = _collection;
		}
		// ------------------------------------------------------------------------------
		/// <summary>Item command event handler for Bank list.</summary>
		///
		// ------------------------------------------------------------------------------
		public void RemoveItem(BLL.Customers.Bank item)
		{
			Globals.ClearMessages();
			_collection = (BLL.SortableList<BLL.Customers.Bank>) Session["Customers/BankWorkingSet"];
			if (_collection != null)
			{
				...
				Globals.AddStatusMessage("Bank working set item removed.");
			}
			Session["Customers/BankWorkingSet"] = _collection;
		}
		// ------------------------------------------------------------------------------
		...
		private void Page_PreRender(object sender, EventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "WorkingBankData.Page_PreRender"));
			}
			finally
			{
			}
