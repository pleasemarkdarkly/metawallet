...
<%@ Control Language="c#" AutoEventWireup="false" CodeFile ="EditLoanToMetaPartner.ascx.cs" Inherits="MW.MComm.Admin.WebUI.UserControls.Desktop.Accounts.EditLoanToMetaPartner" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
...
<wilson:masterpage id="Masterpage" runat="server" templatefile="~/Templates/Desktop/DetailControl.ascx">
	<wilson:contentregion id="Title" runat="server">
		<asp:Label id="lblTitle" CssClass="subtitle" Runat="server">Edit Loan&nbsp;To&nbsp;Meta&nbsp;Partner</asp:Label>&nbsp;<asp:Label id="lblTitleMessage" CssClass="subtitle" Runat="server"></asp:Label>
	...
	<wilson:contentregion id="ItemInfo" runat="server">
		...
		<table>
			<tr>
				...
				<td>
					<span class="ID">
					<MODC:PropVal id="propAccountID" runat="server" prop="LoanToMetaPartnerItem.AccountID" cssclass="ID"></MODC:PropVal>
					</span>
				</td>
			</tr>
			<tr>
				...
				<td>
					<span class="ID">
					<MODC:PropVal id="propMetaPartnerID" runat="server" prop="LoanToMetaPartnerItem.MetaPartnerID" cssclass="ID"></MODC:PropVal>
					</span>
				</td>
			</tr>
		</table>
	...
	<MODC:PageSection id="Section_Basics" visible="false" runat="server">
		<table>
			<tr>
				<td valign="top"><span class="FormLabelRequired"><asp:Label ID="lblAccountIDDisplay" runat="server">Loan&nbsp;Account:</asp:Label></span></td>
				<td valign="top">
					<asp:DropDownList id="ddlAccountID" tabIndex="1" runat="server" CssClass="FormNormal"></asp:DropDownList>
					<asp:Label id="lblAccountIDWorkingSet" runat="server" CssClass="FormNormal"> (from Loan&nbsp;Account working set)</asp:Label>
