...
<%@ Control Language="c#" AutoEventWireup="false" CodeFile ="EditCreditCardType.ascx.cs" Inherits="MW.MComm.Admin.WebUI.UserControls.Desktop.Accounts.EditCreditCardType" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
...
<wilson:masterpage id="Masterpage" runat="server" templatefile="~/Templates/Desktop/DetailControl.ascx">
	<wilson:contentregion id="Title" runat="server">
		<asp:Label id="lblTitle" CssClass="subtitle" Runat="server">Edit Credit&nbsp;Card&nbsp;Type</asp:Label>&nbsp;<asp:Label id="lblTitleMessage" CssClass="subtitle" Runat="server"></asp:Label>
	</wilson:contentregion>
	<wilson:contentregion id="ItemInfo" runat="server">
		<div class="IDSection" id="ItemInfoContent" runat="server">
		<table>
			<tr>
				<td>Credit&nbsp;Card&nbsp;Type&nbsp;Code:</td>
				<td>
					<span class="ID">
					<MODC:PropVal id="propCreditCardTypeCode" runat="server" prop="CreditCardTypeItem.CreditCardTypeCode" cssclass="ID"></MODC:PropVal>
					</span>
				</td>
			</tr>
			<tr>
				<td>Credit&nbsp;Card&nbsp;Type&nbsp;Name:</td>
				<td>
					<span class="ID">
					<MODC:PropVal id="propCreditCardTypeName" runat="server" prop="CreditCardTypeItem.CreditCardTypeName" cssclass="ID"></MODC:PropVal>
					</span>
				</td>
			</tr>
		</table>
	...
	<MODC:PageSection id="Section_Basics" visible="false" runat="server">
		<table>
			<tr>
				<td valign="top"><span class="FormLabelRequired"><asp:Label ID="lblCreditCardTypeCodeDisplay" runat="server">Credit&nbsp;Card&nbsp;Type&nbsp;Code:</asp:Label></span></td>
				<td valign="top">
					<asp:TextBox id="txtCreditCardTypeCode" tabIndex="1" runat="server" maxLength="5" Width="100" CssClass="FormNormal"></asp:TextBox>
					<asp:RangeValidator id="valCreditCardTypeCode" ControlToValidate="txtCreditCardTypeCode" EnableClientScript="False" Display="Dynamic" Runat="server" Type="Integer" MinimumValue="-2147483648" MaximumValue="2147483647" ErrorMessage="Must be a valid int from -2147483648 to 2147483647." ></asp:RangeValidator>
					<asp:RequiredFieldValidator id="valCreditCardTypeCodeRequired" ControlToValidate="txtCreditCardTypeCode" EnableClientScript="False" Display="Dynamic" Runat="server" ErrorMessage="Please enter a valid int from 1 to 2147483647." ></asp:RequiredFieldValidator>
				</td>
			</tr>
			<tr>
				<td valign="top"><span class="FormLabelRequired"><asp:Label ID="lblCreditCardTypeNameDisplay" runat="server">Credit&nbsp;Card&nbsp;Type&nbsp;Name:</asp:Label></span></td>
				<td valign="top">
					<asp:TextBox id="txtCreditCardTypeName" tabIndex="2" runat="server" maxLength="255" Width="300" CssClass="FormNormal"></asp:TextBox>
					<asp:RequiredFieldValidator id="valCreditCardTypeNameRequired" ControlToValidate="txtCreditCardTypeName" EnableClientScript="False" Display="Dynamic" Runat="server" ErrorMessage="Please enter some text." ></asp:RequiredFieldValidator>
				</td>
			</tr>
			<tr>
