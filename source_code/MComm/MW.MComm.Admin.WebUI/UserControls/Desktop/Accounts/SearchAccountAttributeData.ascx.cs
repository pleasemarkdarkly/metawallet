...
{
	// ------------------------------------------------------------------------------
	/// <summary>Search Account Attribute Data is used to help manage AccountAttribute information.</summary>
	///
	/// File History:
	...
	/// <remarks></remarks>
	// ------------------------------------------------------------------------------
	public partial class SearchAccountAttributeData  : Components.Desktop.BaseSearchUserControl
	{
		#region Fields
		#endregion Fields
		#region Properties
		...
		// ------------------------------------------------------------------------------
		/// <summary>Load page for Account Attribute search.</summary>
		///
		// ------------------------------------------------------------------------------
		private void Page_Load(object sender, System.EventArgs e)
		{
			try
			{
				workingAccountAttributeData.Visible = ProvideWorkingSet;
				base.OnLoad(); // base list control manages loading data
				if (WorkflowMode != WorkflowMode.Internal)
				{
					if (Session["SearchAccounts/AccountAttributeData"] != null)
					{
						_collection = (BLL.SortableList<BLL.Accounts.AccountAttribute>)Session["SearchAccounts/AccountAttributeData"];
					}
				}
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "SearchAccountAttributeData.Page_Load"));
			}
			finally
			{
			}
		...
		private void editAccountAttribute_AccountAttributeAdded(BaseFormlUserControl sender, EntityEditEventArgs e)
		{
			...
			{
				Globals.AddErrorMessage(this.Page, "Collection already contains this Account Attribute", new object[0]);
			}
			else
			{
		...
		private void dgPrimaryList_ItemDataBound(object sender, DataGridItemEventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "SearchAccountAttributeData.dgPrimaryList_ItemDataBound"));
			}
			finally
			{
			}
		...
		// ------------------------------------------------------------------------------
		/// <summary>Set Account Attribute information from the ui.</summary>
		///
		// ------------------------------------------------------------------------------
		...
		protected override void LoadCollectionFromDatabase()
		{
			try
			{
				...
				{
					_collection = BLL.Accounts.AccountAttributeManager.GetManyAccountAttributeDataByCriteria(attributeName, attributeTypeCode, dataTypeCode, lastModifiedDateStart, lastModifiedDateEnd, out totalRecords, out maximumListSizeExceeded, this.DataOptions);
					Session["SearchAccounts/AccountAttributeData"] = _collection;
		...
		public void dgPrimaryList_ItemCommand(object sender, EventArgs e)
		{
			...
			if (args.CommandName == "Add" || args.CommandName == "Edit" || args.CommandName == "Delete")
			{
				...
				{
					workingAccountAttributeData.AddItem(item);
				}
		...
		private void Page_PreRender(object sender, EventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "SearchAccountAttributeData.Page_PreRender"));
			}
			finally
			{
			}
		...
		// ------------------------------------------------------------------------------
		/// <summary>Clear search form for Account Attribute.</summary>
		///
		// ------------------------------------------------------------------------------
		...
		// ------------------------------------------------------------------------------
		/// <summary>Perform search for Account Attribute items.</summary>
		///
		// ------------------------------------------------------------------------------
		private void btnSearch_Click(object sender, EventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "SearchAccountAttributeData.btnSearch_Click"));
			}
			finally
			{
			}
