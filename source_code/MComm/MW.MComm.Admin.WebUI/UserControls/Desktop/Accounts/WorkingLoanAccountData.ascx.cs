...
{
	// ------------------------------------------------------------------------------
	/// <summary>Working Loan Account Data is used to help manage LoanAccount information.</summary>
	///
	/// File History:
	...
	/// <remarks></remarks>
	// ------------------------------------------------------------------------------
	public partial class WorkingLoanAccountData  : Components.Desktop.BaseListUserControl
	{
		#region Fields
		#endregion Fields
		#region Properties
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "WorkingLoanAccountData.Page_Load"));
			}
			finally
			{
			}
		...
		private void dgPrimaryList_ItemDataBound(object sender, DataGridItemEventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "WorkingLoanAccountData.dgPrimaryList_ItemDataBound"));
			}
			finally
			{
			}
		...
		{
			_collection = (BLL.SortableList<BLL.Accounts.LoanAccount>) Session["Accounts/LoanAccountWorkingSet"];
			if (_collection != null)
			{
				((BLL.SortableList<BLL.Accounts.LoanAccount>)_collection).Sort(SortColumn, SortDirection);
		...
		public void dgPrimaryList_ItemCommand(object sender, EventArgs e)
		{
			...
			if (_collection != null)
			{
				...
				else if (args.CommandName == "Select")
				{
					int hashCode = int.Parse(args.CommandArgument.ToString());
					BLL.Accounts.LoanAccount item = ((BLL.SortableList<BLL.Accounts.LoanAccount>)_collection).Find(hashCode);
					Session["Accounts/LoanAccountWorkingSetItem"] = item.PrimaryIndex;
				}
			}
		}
		// ------------------------------------------------------------------------------
		...
		///
		// ------------------------------------------------------------------------------
		public void AddItem(BLL.Accounts.LoanAccount item)
		{
			_collection = (BLL.SortableList<BLL.Accounts.LoanAccount>) Session["Accounts/LoanAccountWorkingSet"];
			if (_collection == null)
			{
				_collection = new BLL.SortableList<BLL.Accounts.LoanAccount>();
			}
			...
			else
			{
				...
				TotalRecords = _collection.Count;
				Session["Accounts/LoanAccountWorkingSetItem"] = item.PrimaryIndex;
				Globals.AddStatusMessage("Loan Account working set item added.");
			}
			Session["Accounts/LoanAccountWorkingSet"] = _collection;
		}
		// ------------------------------------------------------------------------------
		/// <summary>Item command event handler for Loan Account list.</summary>
		///
		// ------------------------------------------------------------------------------
		public void RemoveItem(BLL.Accounts.LoanAccount item)
		{
			Globals.ClearMessages();
			_collection = (BLL.SortableList<BLL.Accounts.LoanAccount>) Session["Accounts/LoanAccountWorkingSet"];
			if (_collection != null)
			{
				...
				Globals.AddStatusMessage("Loan Account working set item removed.");
			}
			Session["Accounts/LoanAccountWorkingSet"] = _collection;
		}
		// ------------------------------------------------------------------------------
		...
		private void Page_PreRender(object sender, EventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "WorkingLoanAccountData.Page_PreRender"));
			}
			finally
			{
			}
