...
<%@ Control Language="c#" AutoEventWireup="false" CodeFile ="EditAccount.ascx.cs" Inherits="MW.MComm.Admin.WebUI.UserControls.Desktop.Accounts.EditAccount" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
...
<wilson:masterpage id="Masterpage" runat="server" templatefile="~/Templates/Desktop/DetailControl.ascx">
	<wilson:contentregion id="Title" runat="server">
		<asp:Label id="lblTitle" CssClass="subtitle" Runat="server">Edit Account</asp:Label>&nbsp;<asp:Label id="lblTitleMessage" CssClass="subtitle" Runat="server"></asp:Label>
	...
	<wilson:contentregion id="ItemInfo" runat="server">
		...
		<table>
			<tr>
				...
				<td>
					<span class="ID">
					<MODC:PropVal id="propAccountID" runat="server" prop="AccountItem.AccountID" cssclass="ID"></MODC:PropVal>
					</span>
				</td>
			</tr>
			<tr>
				...
				<td>
					<span class="ID">
					<MODC:PropVal id="propAccountName" runat="server" prop="AccountItem.AccountName" cssclass="ID"></MODC:PropVal>
					</span>
				</td>
			</tr>
		</table>
	...
	<MODC:PageSection id="Section_Basics" visible="false" runat="server">
		<table>
			...
			<tr>
				...
				<td valign="top">
					<asp:TextBox id="txtAccountName" tabIndex="3" runat="server" maxLength="255" Width="300" CssClass="FormNormal"></asp:TextBox>
			...
			<tr>
				...
				<td valign="top">
					<asp:DropDownList id="ddlAccountSubTypeCode" tabIndex="4" runat="server" CssClass="FormNormal"></asp:DropDownList>
