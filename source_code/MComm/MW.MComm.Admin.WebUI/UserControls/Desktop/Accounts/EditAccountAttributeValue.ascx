...
<%@ Control Language="c#" AutoEventWireup="false" CodeFile ="EditAccountAttributeValue.ascx.cs" Inherits="MW.MComm.Admin.WebUI.UserControls.Desktop.Accounts.EditAccountAttributeValue" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
...
<wilson:masterpage id="Masterpage" runat="server" templatefile="~/Templates/Desktop/DetailControl.ascx">
	<wilson:contentregion id="Title" runat="server">
		<asp:Label id="lblTitle" CssClass="subtitle" Runat="server">Edit Account&nbsp;Attribute&nbsp;Value</asp:Label>&nbsp;<asp:Label id="lblTitleMessage" CssClass="subtitle" Runat="server"></asp:Label>
	</wilson:contentregion>
	<wilson:contentregion id="ItemInfo" runat="server">
		<div class="IDSection" id="ItemInfoContent" runat="server">
		<table>
			<tr>
				<td>Account&nbsp;Attribute&nbsp;Value&nbsp;ID:</td>
				<td>
					<span class="ID">
					<MODC:PropVal id="propAccountAttributeValueID" runat="server" prop="AccountAttributeValueItem.AccountAttributeValueID" cssclass="ID"></MODC:PropVal>
					</span>
				</td>
			</tr>
		</table>
	...
	<MODC:PageSection id="Section_Basics" visible="false" runat="server">
		<table>
			<tr>
				<td valign="top"><span class="FormLabelRequired"><asp:Label ID="lblAccountAttributeValueIDDisplay" runat="server">Account&nbsp;Attribute&nbsp;Value&nbsp;ID:</asp:Label></span></td>
				<td valign="top">
					<asp:Label id="lblAccountAttributeValueID" runat="server" CssClass="FormNormal"></asp:Label>
				</td>
			</tr>
			<tr>
				<td valign="top"><span class="FormLabelRequired"><asp:Label ID="lblAccountIDDisplay" runat="server">Account:</asp:Label></span></td>
				<td valign="top">
					<asp:DropDownList id="ddlAccountID" tabIndex="2" runat="server" CssClass="FormNormal"></asp:DropDownList>
					<asp:Label id="lblAccountIDWorkingSet" runat="server" CssClass="FormNormal"> (from Account working set)</asp:Label>
					<a id="lnkAccountIDWorkingSet" runat="server" onclick="javascript:return PromptToDiscardChanges();" class="FormNormal">search</a>
					<asp:CompareValidator id="valAccountID" ControlToValidate="ddlAccountID" EnableClientScript="False" Display="Dynamic" Runat="server" Type="String" ValueToCompare="0" Operator="NotEqual" ErrorMessage="Please select a value from the list." ></asp:CompareValidator>
				</td>
			</tr>
			<tr>
				<td valign="top"><span class="FormLabelRequired"><asp:Label ID="lblBaseAttributeIDDisplay" runat="server">Account&nbsp;Attribute:</asp:Label></span></td>
				<td valign="top">
					<asp:DropDownList id="ddlBaseAttributeID" tabIndex="3" runat="server" CssClass="FormNormal"></asp:DropDownList>
					<asp:Label id="lblBaseAttributeIDWorkingSet" runat="server" CssClass="FormNormal"> (from Account&nbsp;Attribute working set)</asp:Label>
	...
	<MODC:PageSection id="Section_Additional_Info" visible="false" runat="server">
		<table>
			<tr>
				<td valign="top"><span class="FormLabelOptional"><asp:Label ID="lblParameterValueDisplay" runat="server">Parameter&nbsp;Value:</asp:Label></span></td>
				<td valign="top">
					<asp:TextBox id="txtParameterValue" tabIndex="4" runat="server" maxLength="255" Width="300" CssClass="FormNormal"></asp:TextBox>
				</td>
			</tr>
		</table>
	</MODC:PageSection>
