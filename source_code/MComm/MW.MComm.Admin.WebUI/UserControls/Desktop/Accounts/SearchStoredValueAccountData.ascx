...
<%@ Control Language="c#" AutoEventWireup="false" CodeFile ="SearchStoredValueAccountData.ascx.cs" Inherits="MW.MComm.Admin.WebUI.UserControls.Desktop.Accounts.SearchStoredValueAccountData" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
<%@ Register TagPrefix="MOD" TagName="EditStoredValueAccount" SRC="~/UserControls/Desktop/Accounts/EditStoredValueAccount.ascx" %>
<%@ Register TagPrefix="MOD" TagName="WorkingStoredValueAccountData" SRC="~/UserControls/Desktop/Accounts/WorkingStoredValueAccountData.ascx" %>
...
<wilson:masterpage id="Masterpage" runat="server" templatefile="~/Templates/Desktop/PaginatedSearchControl.ascx">
	<wilson:contentregion id="Title" runat="server">
		<asp:Label id="lblTitle" CssClass="subtitle" Runat="server">Stored&nbsp;Value&nbsp;Account Search</asp:Label>
	...
	<asp:DataGrid id="dgPrimaryList" Runat="server" AutoGenerateColumns="False" GridLines="None" AllowSorting="True" HeaderStyle-CssClass="tableHeader" SelectedItemStyle-CssClass="selTableCell" ItemStyle-CssClass="tableCell" AlternatingItemStyle-CssClass="altTableCell" OnItemCommand="dgPrimaryList_ItemCommand">
		...
		<Columns>
			...
			<asp:TemplateColumn HeaderText="">
				<ItemTemplate>
					<asp:LinkButton CssClass="FormNormal" ID="lnkAdd" TabIndex="103" Width="20" Runat="server" CausesValidation="false" CommandName="Add" CommandArgument='<%#((MW.MComm.WalletSolution.BLL.Accounts.StoredValueAccount)Container.DataItem).GetHashCode()%>'>Add</asp:LinkButton>
				</ItemTemplate>
			</asp:TemplateColumn>
		</Columns>
	</asp:DataGrid>
	...
	<wilson:contentregion id="WorkingSet" runat="server">
		<MOD:WorkingStoredValueAccountData id="workingStoredValueAccountData" AccessMode="Edit" DisplayMode="SingleView" RequiresAuthentication="true" WorkflowMode="External" runat="server"></MOD:WorkingStoredValueAccountData>
	</wilson:contentregion>
</wilson:masterpage>