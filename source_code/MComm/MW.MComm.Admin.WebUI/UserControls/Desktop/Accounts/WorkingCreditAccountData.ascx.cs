...
{
	// ------------------------------------------------------------------------------
	/// <summary>Working Credit Account Data is used to help manage CreditAccount information.</summary>
	///
	/// File History:
	...
	/// <remarks></remarks>
	// ------------------------------------------------------------------------------
	public partial class WorkingCreditAccountData  : Components.Desktop.BaseListUserControl
	{
		#region Fields
		#endregion Fields
		#region Properties
		...
		// ------------------------------------------------------------------------------
		/// <summary>Load page for Credit Account listing.</summary>
		///
		// ------------------------------------------------------------------------------
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "WorkingCreditAccountData.Page_Load"));
			}
			finally
			{
			}
		...
		private void dgPrimaryList_ItemDataBound(object sender, DataGridItemEventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "WorkingCreditAccountData.dgPrimaryList_ItemDataBound"));
			}
			finally
			{
			}
		...
		{
			_collection = (BLL.SortableList<BLL.Accounts.CreditAccount>) Session["Accounts/CreditAccountWorkingSet"];
			if (_collection != null)
			{
				((BLL.SortableList<BLL.Accounts.CreditAccount>)_collection).Sort(SortColumn, SortDirection);
		...
		public void dgPrimaryList_ItemCommand(object sender, EventArgs e)
		{
			...
			if (_collection != null)
			{
				...
				else if (args.CommandName == "Select")
				{
					int hashCode = int.Parse(args.CommandArgument.ToString());
					BLL.Accounts.CreditAccount item = ((BLL.SortableList<BLL.Accounts.CreditAccount>)_collection).Find(hashCode);
					Session["Accounts/CreditAccountWorkingSetItem"] = item.PrimaryIndex;
				}
			}
		}
		// ------------------------------------------------------------------------------
		...
		///
		// ------------------------------------------------------------------------------
		public void AddItem(BLL.Accounts.CreditAccount item)
		{
			_collection = (BLL.SortableList<BLL.Accounts.CreditAccount>) Session["Accounts/CreditAccountWorkingSet"];
			if (_collection == null)
			{
				_collection = new BLL.SortableList<BLL.Accounts.CreditAccount>();
			}
			...
			else
			{
				...
				TotalRecords = _collection.Count;
				Session["Accounts/CreditAccountWorkingSetItem"] = item.PrimaryIndex;
				Globals.AddStatusMessage("Credit Account working set item added.");
			}
			Session["Accounts/CreditAccountWorkingSet"] = _collection;
		}
		// ------------------------------------------------------------------------------
		/// <summary>Item command event handler for Credit Account list.</summary>
		///
		// ------------------------------------------------------------------------------
		public void RemoveItem(BLL.Accounts.CreditAccount item)
		{
			Globals.ClearMessages();
			_collection = (BLL.SortableList<BLL.Accounts.CreditAccount>) Session["Accounts/CreditAccountWorkingSet"];
			if (_collection != null)
			{
				...
				Globals.AddStatusMessage("Credit Account working set item removed.");
			}
			Session["Accounts/CreditAccountWorkingSet"] = _collection;
		}
		// ------------------------------------------------------------------------------
		...
		private void Page_PreRender(object sender, EventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "WorkingCreditAccountData.Page_PreRender"));
			}
			finally
			{
			}
