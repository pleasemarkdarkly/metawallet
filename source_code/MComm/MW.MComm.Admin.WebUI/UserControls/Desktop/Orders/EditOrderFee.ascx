...
<%@ Control Language="c#" AutoEventWireup="false" CodeFile ="EditOrderFee.ascx.cs" Inherits="MW.MComm.Admin.WebUI.UserControls.Desktop.Orders.EditOrderFee" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
...
<wilson:masterpage id="Masterpage" runat="server" templatefile="~/Templates/Desktop/DetailControl.ascx">
	<wilson:contentregion id="Title" runat="server">
		<asp:Label id="lblTitle" CssClass="subtitle" Runat="server">Edit Order&nbsp;Fee</asp:Label>&nbsp;<asp:Label id="lblTitleMessage" CssClass="subtitle" Runat="server"></asp:Label>
	...
	<wilson:contentregion id="ItemInfo" runat="server">
		...
		<table>
			<tr>
				...
				<td>
					<span class="ID">
					<MODC:PropVal id="propOrderID" runat="server" prop="OrderFeeItem.OrderID" cssclass="ID"></MODC:PropVal>
					</span>
				</td>
			</tr>
			<tr>
				...
				<td>
					<span class="ID">
					<MODC:PropVal id="propFeeCode" runat="server" prop="OrderFeeItem.FeeCode" cssclass="ID"></MODC:PropVal>
					</span>
				</td>
			</tr>
		</table>
