...
{
	// ------------------------------------------------------------------------------
	/// <summary>Working Order Data is used to help manage Order information.</summary>
	///
	/// File History:
	...
	/// <remarks></remarks>
	// ------------------------------------------------------------------------------
	public partial class WorkingOrderData  : Components.Desktop.BaseListUserControl
	{
		#region Fields
		#endregion Fields
		#region Properties
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "WorkingOrderData.Page_Load"));
			}
			finally
			{
			}
		...
		private void dgPrimaryList_ItemDataBound(object sender, DataGridItemEventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "WorkingOrderData.dgPrimaryList_ItemDataBound"));
			}
			finally
			{
			}
		...
		{
			_collection = (BLL.SortableList<BLL.Orders.Order>) Session["Orders/OrderWorkingSet"];
			if (_collection != null)
			{
				((BLL.SortableList<BLL.Orders.Order>)_collection).Sort(SortColumn, SortDirection);
		...
		public void dgPrimaryList_ItemCommand(object sender, EventArgs e)
		{
			...
			if (_collection != null)
			{
				...
				else if (args.CommandName == "Select")
				{
					int hashCode = int.Parse(args.CommandArgument.ToString());
					BLL.Orders.Order item = ((BLL.SortableList<BLL.Orders.Order>)_collection).Find(hashCode);
					Session["Orders/OrderWorkingSetItem"] = item.PrimaryIndex;
				}
			}
		}
		// ------------------------------------------------------------------------------
		...
		///
		// ------------------------------------------------------------------------------
		public void AddItem(BLL.Orders.Order item)
		{
			_collection = (BLL.SortableList<BLL.Orders.Order>) Session["Orders/OrderWorkingSet"];
			if (_collection == null)
			{
				_collection = new BLL.SortableList<BLL.Orders.Order>();
			}
			...
			else
			{
				...
				TotalRecords = _collection.Count;
				Session["Orders/OrderWorkingSetItem"] = item.PrimaryIndex;
				Globals.AddStatusMessage("Order working set item added.");
			}
			Session["Orders/OrderWorkingSet"] = _collection;
		}
		// ------------------------------------------------------------------------------
		/// <summary>Item command event handler for Order list.</summary>
		///
		// ------------------------------------------------------------------------------
		public void RemoveItem(BLL.Orders.Order item)
		{
			Globals.ClearMessages();
			_collection = (BLL.SortableList<BLL.Orders.Order>) Session["Orders/OrderWorkingSet"];
			if (_collection != null)
			{
				...
				Globals.AddStatusMessage("Order working set item removed.");
			}
			Session["Orders/OrderWorkingSet"] = _collection;
		}
		// ------------------------------------------------------------------------------
		...
		private void Page_PreRender(object sender, EventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "WorkingOrderData.Page_PreRender"));
			}
			finally
			{
			}
