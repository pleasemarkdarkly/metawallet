...
<%@ Control Language="c#" AutoEventWireup="false" CodeFile ="ListEventData.ascx.cs" Inherits="MW.MComm.Admin.WebUI.UserControls.Desktop.Events.ListEventData" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
...
<wilson:masterpage id="Masterpage" runat="server" templatefile="~/Templates/Desktop/ListControl.ascx">
	<wilson:contentregion id="Title" runat="server">
		<asp:Label id="lblTitle" CssClass="subtitle" Runat="server">Event List</asp:Label>
