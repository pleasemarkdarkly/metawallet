	...
	public partial class ListEventTypeData  : Components.Desktop.BaseListUserControl
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			try
			{
				...
				if (_selectedIndex > -1)
				{
					this.editEventType.EventTypeItem = (BLL.Events.EventType) Collection[_selectedIndex];
				}
		...
		private void dgPrimaryList_ItemDataBound(object sender, DataGridItemEventArgs e)
		{
			try
			{
				...
				{
					BLL.Events.EventType vEventType = (BLL.Events.EventType)e.Item.DataItem;
		...
		{
			_collection = BLL.Events.EventTypeManager.GetAllEventTypeData(Globals.DBOptions, DataOptions, Globals.DebugLevel, Globals.CurrentUserID);
		}
		// ------------------------------------------------------------------------------
		...
		public void dgPrimaryList_ItemCommand(object sender, EventArgs e)
		{
			...
			if (args.CommandName == "Edit" || args.CommandName == "Delete")
			{
				...
				BLL.Events.EventType item = ((BLL.SortableList<BLL.Events.EventType>)_collection).Find(hashCode);
