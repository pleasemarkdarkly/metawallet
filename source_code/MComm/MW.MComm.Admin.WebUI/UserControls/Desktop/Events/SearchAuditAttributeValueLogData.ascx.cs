...
{
	// ------------------------------------------------------------------------------
	/// <summary>Search Audit Attribute Value Log Data is used to help manage AuditAttributeValueLog information.</summary>
	///
	/// File History:
	...
	/// <remarks></remarks>
	// ------------------------------------------------------------------------------
	public partial class SearchAuditAttributeValueLogData  : Components.Desktop.BaseSearchUserControl
	{
		#region Fields
		#endregion Fields
		#region Properties
		...
		public bool UseValidation
		{
			...
			set
			{
				...
				editAuditAttributeValueLog.UseValidation = value;
			}
		}
		...
		// ------------------------------------------------------------------------------
		/// <summary>Load page for Audit Attribute Value Log search.</summary>
		///
		// ------------------------------------------------------------------------------
		private void Page_Load(object sender, System.EventArgs e)
		{
			try
			{
				workingAuditAttributeValueLogData.Visible = ProvideWorkingSet;
				base.OnLoad(); // base list control manages loading data
				if (WorkflowMode != WorkflowMode.Internal)
				{
					if (Session["SearchEvents/AuditAttributeValueLogData"] != null)
					{
						_collection = (BLL.SortableList<BLL.Events.AuditAttributeValueLog>)Session["SearchEvents/AuditAttributeValueLogData"];
					}
				}
				// Set current item into child control
				if (_selectedIndex > -1)
				{
					this.editAuditAttributeValueLog.AuditAttributeValueLogItem = (BLL.Events.AuditAttributeValueLog) Collection[_selectedIndex];
				}
				this.editAuditAttributeValueLog.AuditAttributeValueLogAdded += new EntityEditEventHandler(editAuditAttributeValueLog_AuditAttributeValueLogAdded);
				this.editAuditAttributeValueLog.AuditAttributeValueLogRemoved += new EntityEditEventHandler(editAuditAttributeValueLog_AuditAttributeValueLogRemoved);
			}
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "SearchAuditAttributeValueLogData.Page_Load"));
			}
			finally
			{
			}
		...
		// ------------------------------------------------------------------------------
		/// <summary>Item added event handler for Audit Attribute Value Log.</summary>
		///
		// ------------------------------------------------------------------------------
		private void editAuditAttributeValueLog_AuditAttributeValueLogAdded(BaseFormlUserControl sender, EntityEditEventArgs e)
		{
			if (_collection.Contains(e.Entity))
			{
				Globals.AddErrorMessage(this.Page, "Collection already contains this Audit Attribute Value Log", new object[0]);
			}
			else
			{
		...
		// ------------------------------------------------------------------------------
		/// <summary>Item removed event handler for Audit Attribute Value Log.</summary>
		///
		// ------------------------------------------------------------------------------
		private void editAuditAttributeValueLog_AuditAttributeValueLogRemoved(BaseFormlUserControl sender, EntityEditEventArgs e)
		{
			_collection.Add(e.Entity);
		}
		// ------------------------------------------------------------------------------
		/// <summary>Binding for a list of Audit Attribute Value Log.</summary>
		///
		// ------------------------------------------------------------------------------
		private void dgPrimaryList_ItemDataBound(object sender, DataGridItemEventArgs e)
		{
			try
			{
				...
				{
					BLL.Events.AuditAttributeValueLog vAuditAttributeValueLog = (BLL.Events.AuditAttributeValueLog)e.Item.DataItem;
					SetControlText(e.Item,"lblPrimaryName", MOD.Data.DataHelper.GetString(vAuditAttributeValueLog.PrimaryName, ""));
					SetControlText(e.Item,"lblAttributeValue", MOD.Data.DataHelper.GetString(vAuditAttributeValueLog.AttributeValue, ""));
					SetControlText(e.Item,"lblCreatedDate", MOD.Data.DataHelper.GetString(vAuditAttributeValueLog.CreatedDate, ""));
					SetControlText(e.Item,"lblLastModifiedDate", MOD.Data.DataHelper.GetString(vAuditAttributeValueLog.LastModifiedDate, ""));
					...
					foreach (DataGridColumn loopColumn in dgPrimaryList.Columns)
					{
						...
						{
							loopColumn.SortExpression = vAuditAttributeValueLog.PrimarySortColumn;
							break;
						}
					}
					...
					else
					{
						...
						lnkEditOut.NavigateUrl = Page.ResolveUrl(string.Format("EditAuditAttributeValueLog.aspx?mode=" + modeValue + "&message=&AuditAttributeValueLogID={0}", vAuditAttributeValueLog.AuditAttributeValueLogID));
					}
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "SearchAuditAttributeValueLogData.dgPrimaryList_ItemDataBound"));
			}
			finally
			{
			}
		...
		// ------------------------------------------------------------------------------
		/// <summary>Set Audit Attribute Value Log information from the ui.</summary>
		///
		// ------------------------------------------------------------------------------
		...
		// ------------------------------------------------------------------------------
		/// <summary>Get Audit Attribute Value Log information from the database.</summary>
		///
		// ------------------------------------------------------------------------------
		protected override void LoadCollectionFromDatabase()
		{
			try
			{
				...
				{
					_collection = BLL.Events.AuditAttributeValueLogManager.GetManyAuditAttributeValueLogDataByCriteria(attributeValue, lastModifiedDateStart, lastModifiedDateEnd, out totalRecords, out maximumListSizeExceeded, this.DataOptions);
					Session["SearchEvents/AuditAttributeValueLogData"] = _collection;
		...
		// ------------------------------------------------------------------------------
		/// <summary>Item command event handler for Audit Attribute Value Log list.</summary>
		///
		// ------------------------------------------------------------------------------
		public void dgPrimaryList_ItemCommand(object sender, EventArgs e)
		{
			...
			if (args.CommandName == "Add" || args.CommandName == "Edit" || args.CommandName == "Delete")
			{
				...
				BLL.Events.AuditAttributeValueLog item = ((BLL.SortableList<BLL.Events.AuditAttributeValueLog>)_collection).Find(hashCode);
				if (args.CommandName == "Add")
				{
					workingAuditAttributeValueLogData.AddItem(item);
				}
				else if (args.CommandName == "Edit")
				{
					this.editAuditAttributeValueLog.AuditAttributeValueLogItem = item;
				}
		...
		// ------------------------------------------------------------------------------
		/// <summary>Page pre render event handler for Audit Attribute Value Log.</summary>
		///
		// ------------------------------------------------------------------------------
		private void Page_PreRender(object sender, EventArgs e)
		{
			try
			{
				...
				dgPrimaryList.DataKeyField = "AuditAttributeValueLogID";
				dgPrimaryList.DataBind();
				if (this.WorkflowMode == MOD.Data.WorkflowMode.Internal)
				{
					editAuditAttributeValueLog.Visible = true;
					btnNew.Visible = false;
				}
				else
				{
					editAuditAttributeValueLog.Visible = false;
					btnNew.Visible = true;
				}
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "SearchAuditAttributeValueLogData.Page_PreRender"));
			}
			finally
			{
			}
		...
		private void btnNew_Click(object sender, EventArgs e)
		{
			...
			Response.Redirect(Page.ResolveUrl(string.Format("EditAuditAttributeValueLog.aspx?mode=" + MOD.Data.AccessMode.Add.ToString() + "&AuditAttributeValueLogID=" + MOD.Data.DataHelper.GetString(MOD.Data.DefaultValue.Guid, "") + "")));
		}
		
		// ------------------------------------------------------------------------------
		/// <summary>Clear search form for Audit Attribute Value Log.</summary>
		///
		// ------------------------------------------------------------------------------
		...
		// ------------------------------------------------------------------------------
		/// <summary>Perform search for Audit Attribute Value Log items.</summary>
		///
		// ------------------------------------------------------------------------------
		private void btnSearch_Click(object sender, EventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "SearchAuditAttributeValueLogData.btnSearch_Click"));
			}
			finally
			{
			}
