...
<%@ Control Language="c#" AutoEventWireup="false" CodeFile ="EditPaymentTransactionAttributeValueLog.ascx.cs" Inherits="MW.MComm.Admin.WebUI.UserControls.Desktop.Payments.EditPaymentTransactionAttributeValueLog" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
...
<wilson:masterpage id="Masterpage" runat="server" templatefile="~/Templates/Desktop/DetailControl.ascx">
	<wilson:contentregion id="Title" runat="server">
		<asp:Label id="lblTitle" CssClass="subtitle" Runat="server">Edit Payment&nbsp;Transaction&nbsp;Attribute&nbsp;Value&nbsp;Log</asp:Label>&nbsp;<asp:Label id="lblTitleMessage" CssClass="subtitle" Runat="server"></asp:Label>
	</wilson:contentregion>
	<wilson:contentregion id="ItemInfo" runat="server">
		<div class="IDSection" id="ItemInfoContent" runat="server">
		<table>
			<tr>
				<td>Payment&nbsp;Transaction&nbsp;Attribute&nbsp;Value&nbsp;Log&nbsp;ID:</td>
				<td>
					<span class="ID">
					<MODC:PropVal id="propPaymentTransactionAttributeValueLogID" runat="server" prop="PaymentTransactionAttributeValueLogItem.PaymentTransactionAttributeValueLogID" cssclass="ID"></MODC:PropVal>
					</span>
				</td>
			</tr>
		</table>
	...
	<MODC:PageSection id="Section_Basics" visible="false" runat="server">
		<table>
			<tr>
				<td valign="top"><span class="FormLabelRequired"><asp:Label ID="lblPaymentTransactionAttributeValueLogIDDisplay" runat="server">Payment&nbsp;Transaction&nbsp;Attribute&nbsp;Value&nbsp;Log&nbsp;ID:</asp:Label></span></td>
				<td valign="top">
					<asp:Label id="lblPaymentTransactionAttributeValueLogID" runat="server" CssClass="FormNormal"></asp:Label>
				</td>
			</tr>
			<tr>
				<td valign="top"><span class="FormLabelRequired"><asp:Label ID="lblPaymentTransactionLogIDDisplay" runat="server">Payment&nbsp;Transaction&nbsp;Log:</asp:Label></span></td>
				<td valign="top">
					<asp:DropDownList id="ddlPaymentTransactionLogID" tabIndex="2" runat="server" CssClass="FormNormal"></asp:DropDownList>
					<asp:Label id="lblPaymentTransactionLogIDWorkingSet" runat="server" CssClass="FormNormal"> (from Payment&nbsp;Transaction&nbsp;Log working set)</asp:Label>
					<a id="lnkPaymentTransactionLogIDWorkingSet" runat="server" onclick="javascript:return PromptToDiscardChanges();" class="FormNormal">search</a>
					<asp:CompareValidator id="valPaymentTransactionLogID" ControlToValidate="ddlPaymentTransactionLogID" EnableClientScript="False" Display="Dynamic" Runat="server" Type="String" ValueToCompare="0" Operator="NotEqual" ErrorMessage="Please select a value from the list." ></asp:CompareValidator>
				</td>
			</tr>
			<tr>
	...
	<MODC:PageSection id="Section_Additional_Info" visible="false" runat="server">
		<table>
			<tr>
				...
				<td valign="top">
					<asp:TextBox id="txtAttributeValue" tabIndex="4" runat="server" maxLength="255" Width="300" CssClass="FormNormal"></asp:TextBox>
				</td>
			</tr>
		</table>
	</MODC:PageSection>
