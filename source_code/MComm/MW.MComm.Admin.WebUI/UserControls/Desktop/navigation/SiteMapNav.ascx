...
*/%>
<%@ Control Language="c#" Inherits="MW.MComm.Admin.WebUI.UserControls.Desktop.navigation.SiteMapNav" CodeFile="SiteMapNav.ascx.cs" %>
<asp:literal id="lblSiteMapNav" runat="server"></asp:literal>