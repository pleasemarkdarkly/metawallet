...
namespace MW.MComm.Admin.WebUI.UserControls.Desktop.navigation
{
	...
	/// <summary>
	///		Summary description for BreadCrumbNav.
	/// </summary>
	public partial class BreadCrumbNav : System.Web.UI.UserControl
	{
		protected void Page_Load(object sender, System.EventArgs e)
		{
			if(!IsPostBack)
			{
				lblBreadCrumbNav.Text = Globals.getRenderedSiteNav(Globals.BreadCrumbNavigationXsl);
			}
		}
