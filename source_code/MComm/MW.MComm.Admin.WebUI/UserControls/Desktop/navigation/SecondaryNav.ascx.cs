...
namespace MW.MComm.Admin.WebUI.UserControls.Desktop.navigation
{
	...
	/// <summary>
	///		Summary description for SecondaryNav.
	/// </summary>
	public partial class SecondaryNav : System.Web.UI.UserControl
	{
		protected void Page_Load(object sender, System.EventArgs e)
		{
			if(!IsPostBack)
			{
				lblSecondaryNav.Text = Globals.getRenderedSiteNav(Globals.SecondaryNavigationXsl);
			}
		}
