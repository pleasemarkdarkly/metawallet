...
<%@ Control Language="c#" AutoEventWireup="false" CodeFile ="EditFriendlyError.ascx.cs" Inherits="MW.MComm.Admin.WebUI.UserControls.Desktop.UserExperience.EditFriendlyError" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
...
<wilson:masterpage id="Masterpage" runat="server" templatefile="~/Templates/Desktop/DetailControl.ascx">
	<wilson:contentregion id="Title" runat="server">
		<asp:Label id="lblTitle" CssClass="subtitle" Runat="server">Edit Friendly&nbsp;Error</asp:Label>&nbsp;<asp:Label id="lblTitleMessage" CssClass="subtitle" Runat="server"></asp:Label>
	...
	<wilson:contentregion id="ItemInfo" runat="server">
		...
		<table>
			<tr>
				...
				<td>
					<span class="ID">
					<MODC:PropVal id="propErrorNumber" runat="server" prop="FriendlyErrorItem.ErrorNumber" cssclass="ID"></MODC:PropVal>
					</span>
				</td>
			</tr>
			<tr>
				...
				<td>
					<span class="ID">
					<MODC:PropVal id="propLocaleCode" runat="server" prop="FriendlyErrorItem.LocaleCode" cssclass="ID"></MODC:PropVal>
					</span>
				</td>
			</tr>
		</table>
	...
	<MODC:PageSection id="Section_Basics" visible="false" runat="server">
		<table>
			<tr>
				<td valign="top"><span class="FormLabelRequired"><asp:Label ID="lblErrorNumberDisplay" runat="server">Error:</asp:Label></span></td>
				<td valign="top">
					<asp:DropDownList id="ddlErrorNumber" tabIndex="1" runat="server" CssClass="FormNormal"></asp:DropDownList>
					<asp:CompareValidator id="valErrorNumber" ControlToValidate="ddlErrorNumber" EnableClientScript="False" Display="Dynamic" Runat="server" Type="String" ValueToCompare="0" Operator="NotEqual" ErrorMessage="Please select a value from the list." ></asp:CompareValidator>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td valign="top"><span class="FormLabelRequired"><asp:Label ID="lblFriendlyErrorMessageDisplay" runat="server">Friendly&nbsp;Error&nbsp;Message:</asp:Label></span></td>
				<td valign="top">
					<asp:TextBox id="txtFriendlyErrorMessage" tabIndex="3" runat="server" Width="300" CssClass="FormNormal" TextMode="MultiLine" Rows="5" Columns="100"></asp:TextBox>
					<asp:RequiredFieldValidator id="valFriendlyErrorMessageRequired" ControlToValidate="txtFriendlyErrorMessage" EnableClientScript="False" Display="Dynamic" Runat="server" ErrorMessage="Please enter some text." ></asp:RequiredFieldValidator>
				</td>
			</tr>
		</table>
	</MODC:PageSection>
