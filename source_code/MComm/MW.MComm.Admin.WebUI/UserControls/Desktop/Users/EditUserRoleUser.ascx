...
<%@ Control Language="c#" AutoEventWireup="false" CodeFile ="EditUserRoleUser.ascx.cs" Inherits="MW.MComm.Admin.WebUI.UserControls.Desktop.Users.EditUserRoleUser" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
...
<wilson:masterpage id="Masterpage" runat="server" templatefile="~/Templates/Desktop/DetailControl.ascx">
	<wilson:contentregion id="Title" runat="server">
		<asp:Label id="lblTitle" CssClass="subtitle" Runat="server">Edit User&nbsp;Role&nbsp;User</asp:Label>&nbsp;<asp:Label id="lblTitleMessage" CssClass="subtitle" Runat="server"></asp:Label>
	...
	<wilson:contentregion id="ItemInfo" runat="server">
		...
		<table>
			<tr>
				...
				<td>
					<span class="ID">
					<MODC:PropVal id="propUserRoleCode" runat="server" prop="UserRoleUserItem.UserRoleCode" cssclass="ID"></MODC:PropVal>
					</span>
				</td>
			</tr>
			<tr>
				...
				<td>
					<span class="ID">
					<MODC:PropVal id="propUserID" runat="server" prop="UserRoleUserItem.UserID" cssclass="ID"></MODC:PropVal>
					</span>
				</td>
			</tr>
		</table>
	...
	<MODC:PageSection id="Section_Basics" visible="false" runat="server">
		<table>
			...
			<tr>
				<td valign="top"><span class="FormLabelRequired"><asp:Label ID="lblUserIDDisplay" runat="server">User:</asp:Label></span></td>
				<td valign="top">
					<asp:DropDownList id="ddlUserID" tabIndex="2" runat="server" CssClass="FormNormal"></asp:DropDownList>
					<asp:Label id="lblUserIDWorkingSet" runat="server" CssClass="FormNormal"> (from User working set)</asp:Label>
					<a id="lnkUserIDWorkingSet" runat="server" onclick="javascript:return PromptToDiscardChanges();" class="FormNormal">search</a>
					<asp:CompareValidator id="valUserID" ControlToValidate="ddlUserID" EnableClientScript="False" Display="Dynamic" Runat="server" Type="String" ValueToCompare="0" Operator="NotEqual" ErrorMessage="Please select a value from the list." ></asp:CompareValidator>
				</td>
			</tr>
		</table>
	</MODC:PageSection>
