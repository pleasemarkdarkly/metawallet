...
{
	// ------------------------------------------------------------------------------
	/// <summary>Working Debug Attribute Value Log Data is used to help manage DebugAttributeValueLog information.</summary>
	///
	/// File History:
	...
	/// <remarks></remarks>
	// ------------------------------------------------------------------------------
	public partial class WorkingDebugAttributeValueLogData  : Components.Desktop.BaseListUserControl
	{
		#region Fields
		#endregion Fields
		#region Properties
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "WorkingDebugAttributeValueLogData.Page_Load"));
			}
			finally
			{
			}
		...
		private void dgPrimaryList_ItemDataBound(object sender, DataGridItemEventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "WorkingDebugAttributeValueLogData.dgPrimaryList_ItemDataBound"));
			}
			finally
			{
			}
		...
		{
			_collection = (BLL.SortableList<BLL.Core.DebugAttributeValueLog>) Session["Core/DebugAttributeValueLogWorkingSet"];
			if (_collection != null)
			{
				((BLL.SortableList<BLL.Core.DebugAttributeValueLog>)_collection).Sort(SortColumn, SortDirection);
		...
		public void dgPrimaryList_ItemCommand(object sender, EventArgs e)
		{
			...
			if (_collection != null)
			{
				...
				else if (args.CommandName == "Select")
				{
					int hashCode = int.Parse(args.CommandArgument.ToString());
					BLL.Core.DebugAttributeValueLog item = ((BLL.SortableList<BLL.Core.DebugAttributeValueLog>)_collection).Find(hashCode);
					Session["Core/DebugAttributeValueLogWorkingSetItem"] = item.PrimaryIndex;
				}
			}
		}
		// ------------------------------------------------------------------------------
		...
		///
		// ------------------------------------------------------------------------------
		public void AddItem(BLL.Core.DebugAttributeValueLog item)
		{
			_collection = (BLL.SortableList<BLL.Core.DebugAttributeValueLog>) Session["Core/DebugAttributeValueLogWorkingSet"];
			if (_collection == null)
			{
				_collection = new BLL.SortableList<BLL.Core.DebugAttributeValueLog>();
			}
			...
			else
			{
				...
				TotalRecords = _collection.Count;
				Session["Core/DebugAttributeValueLogWorkingSetItem"] = item.PrimaryIndex;
				Globals.AddStatusMessage("Debug Attribute Value Log working set item added.");
			}
			Session["Core/DebugAttributeValueLogWorkingSet"] = _collection;
		}
		// ------------------------------------------------------------------------------
		/// <summary>Item command event handler for Debug Attribute Value Log list.</summary>
		///
		// ------------------------------------------------------------------------------
		public void RemoveItem(BLL.Core.DebugAttributeValueLog item)
		{
			Globals.ClearMessages();
			_collection = (BLL.SortableList<BLL.Core.DebugAttributeValueLog>) Session["Core/DebugAttributeValueLogWorkingSet"];
			if (_collection != null)
			{
				...
				Globals.AddStatusMessage("Debug Attribute Value Log working set item removed.");
			}
			Session["Core/DebugAttributeValueLogWorkingSet"] = _collection;
		}
		// ------------------------------------------------------------------------------
		...
		private void Page_PreRender(object sender, EventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "WorkingDebugAttributeValueLogData.Page_PreRender"));
			}
			finally
			{
			}
