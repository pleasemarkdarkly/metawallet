...
<%@ Control Language="c#" AutoEventWireup="false" CodeFile ="EditAttributeType.ascx.cs" Inherits="MW.MComm.Admin.WebUI.UserControls.Desktop.Core.EditAttributeType" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
...
<wilson:masterpage id="Masterpage" runat="server" templatefile="~/Templates/Desktop/DetailControl.ascx">
	<wilson:contentregion id="Title" runat="server">
		<asp:Label id="lblTitle" CssClass="subtitle" Runat="server">Edit Attribute&nbsp;Type</asp:Label>&nbsp;<asp:Label id="lblTitleMessage" CssClass="subtitle" Runat="server"></asp:Label>
	</wilson:contentregion>
	<wilson:contentregion id="ItemInfo" runat="server">
		<div class="IDSection" id="ItemInfoContent" runat="server">
		<table>
			<tr>
				<td>Attribute&nbsp;Type&nbsp;Code:</td>
				<td>
					<span class="ID">
					<MODC:PropVal id="propAttributeTypeCode" runat="server" prop="AttributeTypeItem.AttributeTypeCode" cssclass="ID"></MODC:PropVal>
					</span>
				</td>
			</tr>
			<tr>
				...
				<td>
					<span class="ID">
					<MODC:PropVal id="propAttributeTypeName" runat="server" prop="AttributeTypeItem.AttributeTypeName" cssclass="ID"></MODC:PropVal>
					</span>
				</td>
			</tr>
		</table>
	...
	<MODC:PageSection id="Section_Basics" visible="false" runat="server">
		<table>
			<tr>
				<td valign="top"><span class="FormLabelRequired"><asp:Label ID="lblAttributeTypeCodeDisplay" runat="server">Attribute&nbsp;Type&nbsp;Code:</asp:Label></span></td>
				<td valign="top">
					<asp:TextBox id="txtAttributeTypeCode" tabIndex="1" runat="server" maxLength="5" Width="100" CssClass="FormNormal"></asp:TextBox>
					<asp:RangeValidator id="valAttributeTypeCode" ControlToValidate="txtAttributeTypeCode" EnableClientScript="False" Display="Dynamic" Runat="server" Type="Integer" MinimumValue="-2147483648" MaximumValue="2147483647" ErrorMessage="Must be a valid int from -2147483648 to 2147483647." ></asp:RangeValidator>
					<asp:RequiredFieldValidator id="valAttributeTypeCodeRequired" ControlToValidate="txtAttributeTypeCode" EnableClientScript="False" Display="Dynamic" Runat="server" ErrorMessage="Please enter a valid int from 1 to 2147483647." ></asp:RequiredFieldValidator>
				</td>
			</tr>
			<tr>
				<td valign="top"><span class="FormLabelRequired"><asp:Label ID="lblAttributeTypeNameDisplay" runat="server">Attribute&nbsp;Type&nbsp;Name:</asp:Label></span></td>
				<td valign="top">
					<asp:TextBox id="txtAttributeTypeName" tabIndex="2" runat="server" maxLength="100" Width="150" CssClass="FormNormal"></asp:TextBox>
					<asp:RequiredFieldValidator id="valAttributeTypeNameRequired" ControlToValidate="txtAttributeTypeName" EnableClientScript="False" Display="Dynamic" Runat="server" ErrorMessage="Please enter some text." ></asp:RequiredFieldValidator>
				</td>
			</tr>
			<tr>
