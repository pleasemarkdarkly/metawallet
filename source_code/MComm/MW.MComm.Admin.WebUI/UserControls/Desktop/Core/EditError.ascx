...
<%@ Control Language="c#" AutoEventWireup="false" CodeFile ="EditError.ascx.cs" Inherits="MW.MComm.Admin.WebUI.UserControls.Desktop.Core.EditError" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
...
<wilson:masterpage id="Masterpage" runat="server" templatefile="~/Templates/Desktop/DetailControl.ascx">
	<wilson:contentregion id="Title" runat="server">
		<asp:Label id="lblTitle" CssClass="subtitle" Runat="server">Edit Error</asp:Label>&nbsp;<asp:Label id="lblTitleMessage" CssClass="subtitle" Runat="server"></asp:Label>
	...
	<wilson:contentregion id="ItemInfo" runat="server">
		...
		<table>
			<tr>
				...
				<td>
					<span class="ID">
					<MODC:PropVal id="propErrorNumber" runat="server" prop="ErrorItem.ErrorNumber" cssclass="ID"></MODC:PropVal>
					</span>
				</td>
			</tr>
		</table>
	...
	<MODC:PageSection id="Section_Basics" visible="false" runat="server">
		<table>
			<tr>
				<td valign="top"><span class="FormLabelRequired"><asp:Label ID="lblErrorNumberDisplay" runat="server">Error&nbsp;Number:</asp:Label></span></td>
				<td valign="top">
					<asp:TextBox id="txtErrorNumber" tabIndex="1" runat="server" maxLength="5" Width="100" CssClass="FormNormal"></asp:TextBox>
					...
					<asp:RequiredFieldValidator id="valErrorNumberRequired" ControlToValidate="txtErrorNumber" EnableClientScript="False" Display="Dynamic" Runat="server" ErrorMessage="Please enter a valid int from 1 to 2147483647." ></asp:RequiredFieldValidator>
				</td>
			</tr>
			<tr>
				<td valign="top"><span class="FormLabelRequired"><asp:Label ID="lblErrorTitleDisplay" runat="server">Error&nbsp;Title:</asp:Label></span></td>
				<td valign="top">
					<asp:TextBox id="txtErrorTitle" tabIndex="2" runat="server" maxLength="100" Width="150" CssClass="FormNormal"></asp:TextBox>
					<asp:RequiredFieldValidator id="valErrorTitleRequired" ControlToValidate="txtErrorTitle" EnableClientScript="False" Display="Dynamic" Runat="server" ErrorMessage="Please enter some text." ></asp:RequiredFieldValidator>
				</td>
			</tr>
		</table>
	</MODC:PageSection>
	<MODC:PageSection id="Section_Additional_Info" visible="false" runat="server">
		<table>
			<tr>
				<td valign="top"><span class="FormLabelOptional"><asp:Label ID="lblErrorMessageDisplay" runat="server">Error&nbsp;Message:</asp:Label></span></td>
				<td valign="top">
					<asp:TextBox id="txtErrorMessage" tabIndex="3" runat="server" Width="300" CssClass="FormNormal" TextMode="MultiLine" Rows="5" Columns="100"></asp:TextBox>
				</td>
			</tr>
		</table>
	</MODC:PageSection>
