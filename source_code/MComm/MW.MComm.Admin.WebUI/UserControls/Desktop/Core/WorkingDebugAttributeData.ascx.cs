...
{
	// ------------------------------------------------------------------------------
	/// <summary>Working Debug Attribute Data is used to help manage DebugAttribute information.</summary>
	///
	/// File History:
	...
	/// <remarks></remarks>
	// ------------------------------------------------------------------------------
	public partial class WorkingDebugAttributeData  : Components.Desktop.BaseListUserControl
	{
		#region Fields
		#endregion Fields
		#region Properties
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "WorkingDebugAttributeData.Page_Load"));
			}
			finally
			{
			}
		...
		private void dgPrimaryList_ItemDataBound(object sender, DataGridItemEventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "WorkingDebugAttributeData.dgPrimaryList_ItemDataBound"));
			}
			finally
			{
			}
		...
		{
			_collection = (BLL.SortableList<BLL.Core.DebugAttribute>) Session["Core/DebugAttributeWorkingSet"];
			if (_collection != null)
			{
				((BLL.SortableList<BLL.Core.DebugAttribute>)_collection).Sort(SortColumn, SortDirection);
		...
		public void dgPrimaryList_ItemCommand(object sender, EventArgs e)
		{
			...
			if (_collection != null)
			{
				...
				else if (args.CommandName == "Select")
				{
					int hashCode = int.Parse(args.CommandArgument.ToString());
					BLL.Core.DebugAttribute item = ((BLL.SortableList<BLL.Core.DebugAttribute>)_collection).Find(hashCode);
					Session["Core/DebugAttributeWorkingSetItem"] = item.PrimaryIndex;
				}
			}
		}
		// ------------------------------------------------------------------------------
		...
		///
		// ------------------------------------------------------------------------------
		public void AddItem(BLL.Core.DebugAttribute item)
		{
			_collection = (BLL.SortableList<BLL.Core.DebugAttribute>) Session["Core/DebugAttributeWorkingSet"];
			if (_collection == null)
			{
				_collection = new BLL.SortableList<BLL.Core.DebugAttribute>();
			}
			...
			else
			{
				...
				TotalRecords = _collection.Count;
				Session["Core/DebugAttributeWorkingSetItem"] = item.PrimaryIndex;
				Globals.AddStatusMessage("Debug Attribute working set item added.");
			}
			Session["Core/DebugAttributeWorkingSet"] = _collection;
		}
		// ------------------------------------------------------------------------------
		/// <summary>Item command event handler for Debug Attribute list.</summary>
		///
		// ------------------------------------------------------------------------------
		public void RemoveItem(BLL.Core.DebugAttribute item)
		{
			Globals.ClearMessages();
			_collection = (BLL.SortableList<BLL.Core.DebugAttribute>) Session["Core/DebugAttributeWorkingSet"];
			if (_collection != null)
			{
				...
				Globals.AddStatusMessage("Debug Attribute working set item removed.");
			}
			Session["Core/DebugAttributeWorkingSet"] = _collection;
		}
		// ------------------------------------------------------------------------------
		...
		private void Page_PreRender(object sender, EventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "WorkingDebugAttributeData.Page_PreRender"));
			}
			finally
			{
			}
