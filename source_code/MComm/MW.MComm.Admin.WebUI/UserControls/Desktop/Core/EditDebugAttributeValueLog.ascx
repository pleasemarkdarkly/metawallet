...
<%@ Control Language="c#" AutoEventWireup="false" CodeFile ="EditDebugAttributeValueLog.ascx.cs" Inherits="MW.MComm.Admin.WebUI.UserControls.Desktop.Core.EditDebugAttributeValueLog" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
...
<wilson:masterpage id="Masterpage" runat="server" templatefile="~/Templates/Desktop/DetailControl.ascx">
	<wilson:contentregion id="Title" runat="server">
		<asp:Label id="lblTitle" CssClass="subtitle" Runat="server">Edit Debug&nbsp;Attribute&nbsp;Value&nbsp;Log</asp:Label>&nbsp;<asp:Label id="lblTitleMessage" CssClass="subtitle" Runat="server"></asp:Label>
	</wilson:contentregion>
	<wilson:contentregion id="ItemInfo" runat="server">
		<div class="IDSection" id="ItemInfoContent" runat="server">
		<table>
			<tr>
				<td>Debug&nbsp;Attribute&nbsp;Value&nbsp;Log&nbsp;ID:</td>
				<td>
					<span class="ID">
					<MODC:PropVal id="propDebugAttributeValueLogID" runat="server" prop="DebugAttributeValueLogItem.DebugAttributeValueLogID" cssclass="ID"></MODC:PropVal>
					</span>
				</td>
			</tr>
		</table>
	...
	<MODC:PageSection id="Section_Basics" visible="false" runat="server">
		<table>
			<tr>
				<td valign="top"><span class="FormLabelRequired"><asp:Label ID="lblDebugAttributeValueLogIDDisplay" runat="server">Debug&nbsp;Attribute&nbsp;Value&nbsp;Log&nbsp;ID:</asp:Label></span></td>
				<td valign="top">
					<asp:Label id="lblDebugAttributeValueLogID" runat="server" CssClass="FormNormal"></asp:Label>
				</td>
			</tr>
			<tr>
				<td valign="top"><span class="FormLabelRequired"><asp:Label ID="lblDebugLogIDDisplay" runat="server">Debug&nbsp;Log:</asp:Label></span></td>
				<td valign="top">
					<asp:DropDownList id="ddlDebugLogID" tabIndex="2" runat="server" CssClass="FormNormal"></asp:DropDownList>
					<asp:Label id="lblDebugLogIDWorkingSet" runat="server" CssClass="FormNormal"> (from Debug&nbsp;Log working set)</asp:Label>
					<a id="lnkDebugLogIDWorkingSet" runat="server" onclick="javascript:return PromptToDiscardChanges();" class="FormNormal">search</a>
					<asp:CompareValidator id="valDebugLogID" ControlToValidate="ddlDebugLogID" EnableClientScript="False" Display="Dynamic" Runat="server" Type="String" ValueToCompare="0" Operator="NotEqual" ErrorMessage="Please select a value from the list." ></asp:CompareValidator>
				</td>
			</tr>
			<tr>
				<td valign="top"><span class="FormLabelRequired"><asp:Label ID="lblBaseAttributeIDDisplay" runat="server">Debug&nbsp;Attribute:</asp:Label></span></td>
				<td valign="top">
					<asp:DropDownList id="ddlBaseAttributeID" tabIndex="3" runat="server" CssClass="FormNormal"></asp:DropDownList>
					<asp:Label id="lblBaseAttributeIDWorkingSet" runat="server" CssClass="FormNormal"> (from Debug&nbsp;Attribute working set)</asp:Label>
			...
			<tr>
				<td valign="top"><span class="FormLabelRequired"><asp:Label ID="lblAttributeValueDisplay" runat="server">Attribute&nbsp;Value:</asp:Label></span></td>
				<td valign="top">
					...
					<asp:RequiredFieldValidator id="valAttributeValueRequired" ControlToValidate="txtAttributeValue" EnableClientScript="False" Display="Dynamic" Runat="server" ErrorMessage="Please enter some text." ></asp:RequiredFieldValidator>
				</td>
			</tr>
		</table>
	</MODC:PageSection>
