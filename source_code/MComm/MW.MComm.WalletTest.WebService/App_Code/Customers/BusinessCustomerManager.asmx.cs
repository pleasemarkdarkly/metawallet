...
namespace MW.MComm.WalletTest.WebService.Customers
{
	...
	public class BusinessCustomerManager : System.Web.Services.WebService
	{
		...
		///
		/// <param name="businessMetaPartnerID">A property of BusinessCustomer item to be managed</param>
		/// <param name="customerMetaPartnerID">A property of BusinessCustomer item to be managed</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Customers.BusinessCustomerResults AddOneBusinessCustomer(string businessMetaPartnerID, string customerMetaPartnerID)
		{
			...
			try
			{
				...
				BLL.Customers.BusinessCustomer item = new BLL.Customers.BusinessCustomer();
				item.BusinessMetaPartnerID = MOD.Data.DataHelper.GetGuid(businessMetaPartnerID, MOD.Data.DefaultValue.Guid);
				item.CustomerMetaPartnerID = MOD.Data.DataHelper.GetGuid(customerMetaPartnerID, MOD.Data.DefaultValue.Guid);
				BLL.Customers.BusinessCustomerManager.AddOneBusinessCustomer(item, false);
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Customers.BusinessCustomerResults DeleteOneBusinessCustomer(string businessMetaPartnerID, string customerMetaPartnerID)
		{
			Components.Customers.BusinessCustomerResults results = new Components.Customers.BusinessCustomerResults();
			results.StatusDescription = "Results OK";
			try
			{
				...
				item.BusinessMetaPartnerID = MOD.Data.DataHelper.GetGuid(businessMetaPartnerID, MOD.Data.DefaultValue.Guid);
				item.CustomerMetaPartnerID = MOD.Data.DataHelper.GetGuid(customerMetaPartnerID, MOD.Data.DefaultValue.Guid);
				BLL.Customers.BusinessCustomerManager.DeleteOneBusinessCustomer(item, false);
			}
			catch (System.Exception ex)
			{
				results.StatusCode = -1;
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Customers.BusinessCustomerResults UpdateOneBusinessCustomer(string businessMetaPartnerID, string customerMetaPartnerID)
		{
			Components.Customers.BusinessCustomerResults results = new Components.Customers.BusinessCustomerResults();
			results.StatusDescription = "Results OK";
			try
			{
				...
				item.BusinessMetaPartnerID = MOD.Data.DataHelper.GetGuid(businessMetaPartnerID, MOD.Data.DefaultValue.Guid);
				item.CustomerMetaPartnerID = MOD.Data.DataHelper.GetGuid(customerMetaPartnerID, MOD.Data.DefaultValue.Guid);
				BLL.Customers.BusinessCustomerManager.UpdateOneBusinessCustomer(item, false);
				results.Results.Add(item);
			}
			catch (System.Exception ex)
			{
