...
namespace MW.MComm.WalletTest.WebService.Customers
{
	...
	public class LocationManager : System.Web.Services.WebService
	{
		...
		///
		/// <param name="locationID">A property of Location item to be managed</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Customers.LocationResults DeleteOneLocation(string locationID)
		{
			Components.Customers.LocationResults results = new Components.Customers.LocationResults();
			results.StatusDescription = "Results OK";
			try
			{
				...
				item.LocationID = MOD.Data.DataHelper.GetGuid(locationID, MOD.Data.DefaultValue.Guid);
				BLL.Customers.LocationManager.DeleteOneLocation(item, false);
			}
			catch (System.Exception ex)
			{
				results.StatusCode = -1;
		...
		///
		/// <param name="locationID">A property of Location item to be managed</param>
		/// <param name="locationTypeCode">A property of Location item to be managed</param>
		/// <param name="addressLine1">A property of Location item to be managed</param>
		/// <param name="addressLine2">A property of Location item to be managed</param>
		/// <param name="city">A property of Location item to be managed</param>
		/// <param name="stateProvince">A property of Location item to be managed</param>
		/// <param name="countryCode">A property of Location item to be managed</param>
		/// <param name="postalCode">A property of Location item to be managed</param>
		/// <param name="metaPartnerID">A property of Location item to be managed</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Customers.LocationResults UpsertOneLocation(string locationID, int locationTypeCode, string addressLine1, string addressLine2, string city, string stateProvince, int countryCode, string postalCode, string metaPartnerID)
		{
			Components.Customers.LocationResults results = new Components.Customers.LocationResults();
			results.StatusDescription = "Results OK";
			try
			{
				...
				BLL.Customers.LocationManager.UpsertOneLocation(item, false);
				results.Results.Add(item);
			}
			catch (System.Exception ex)
			{
