...
namespace MW.MComm.WalletTest.WebService.Customers
{
	...
	public class CarrierManager : System.Web.Services.WebService
	{
		...
		///
		/// <param name="metaPartnerID">A property of Carrier item to be managed</param>
		/// <param name="carrierCode">A property of Carrier item to be managed</param>
		/// <param name="serviceCharges">A property of Carrier item to be managed</param>
		/// <param name="metaPartnerSubTypeCode">A property of Carrier item to be managed</param>
		/// <param name="localeCode">A property of Carrier item to be managed</param>
		/// <param name="currencyCode">A property of Carrier item to be managed</param>
		/// <param name="dateFormatCode">A property of Carrier item to be managed</param>
		/// <param name="taxCode">A property of Carrier item to be managed</param>
		/// <param name="isActive">A property of Carrier item to be managed</param>
		/// <param name="metaPartnerName">A property of Carrier item to be managed</param>
		/// <param name="pictureImageURL">A property of Carrier item to be managed</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Customers.CarrierResults AddOneCarrier(string metaPartnerID, int carrierCode, string serviceCharges, int metaPartnerSubTypeCode, int localeCode, int currencyCode, int dateFormatCode, string taxCode, bool isActive, string metaPartnerName, string pictureImageURL)
		{
			...
			try
			{
				...
				BLL.Customers.CarrierManager.AddOneCarrier(item, false);
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Customers.CarrierResults DeleteOneCarrier(string metaPartnerID)
		{
			Components.Customers.CarrierResults results = new Components.Customers.CarrierResults();
			results.StatusDescription = "Results OK";
			try
			{
				...
				BLL.Customers.Carrier item = new BLL.Customers.Carrier();
				item.MetaPartnerID = MOD.Data.DataHelper.GetGuid(metaPartnerID, MOD.Data.DefaultValue.Guid);
				BLL.Customers.CarrierManager.DeleteOneCarrier(item, false);
			}
			catch (System.Exception ex)
			{
				results.StatusCode = -1;
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Customers.CarrierResults UpdateOneCarrier(string metaPartnerID, int carrierCode, string serviceCharges, int metaPartnerSubTypeCode, int localeCode, int currencyCode, int dateFormatCode, string taxCode, bool isActive, string metaPartnerName, string pictureImageURL)
		{
			Components.Customers.CarrierResults results = new Components.Customers.CarrierResults();
			results.StatusDescription = "Results OK";
			try
			{
				...
				item.MetaPartnerName = metaPartnerName;
				item.PictureImageURL = pictureImageURL;
				BLL.Customers.CarrierManager.UpdateOneCarrier(item, false);
				results.Results.Add(item);
			}
			catch (System.Exception ex)
			{
