...
namespace MW.MComm.WalletTest.WebService.Customers
{
	...
	public class MerchantManager : System.Web.Services.WebService
	{
		...
		///
		/// <param name="metaPartnerID">A property of Merchant item to be managed</param>
		/// <param name="serviceCharges">A property of Merchant item to be managed</param>
		/// <param name="metaPartnerSubTypeCode">A property of Merchant item to be managed</param>
		/// <param name="localeCode">A property of Merchant item to be managed</param>
		/// <param name="currencyCode">A property of Merchant item to be managed</param>
		/// <param name="dateFormatCode">A property of Merchant item to be managed</param>
		/// <param name="taxCode">A property of Merchant item to be managed</param>
		/// <param name="isActive">A property of Merchant item to be managed</param>
		/// <param name="metaPartnerName">A property of Merchant item to be managed</param>
		/// <param name="pictureImageURL">A property of Merchant item to be managed</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Customers.MerchantResults AddOneMerchant(string metaPartnerID, string serviceCharges, int metaPartnerSubTypeCode, int localeCode, int currencyCode, int dateFormatCode, string taxCode, bool isActive, string metaPartnerName, string pictureImageURL)
		{
			...
			try
			{
				...
				BLL.Customers.MerchantManager.AddOneMerchant(item, false);
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Customers.MerchantResults DeleteOneMerchant(string metaPartnerID)
		{
			Components.Customers.MerchantResults results = new Components.Customers.MerchantResults();
			results.StatusDescription = "Results OK";
			try
			{
				...
				BLL.Customers.Merchant item = new BLL.Customers.Merchant();
				item.MetaPartnerID = MOD.Data.DataHelper.GetGuid(metaPartnerID, MOD.Data.DefaultValue.Guid);
				BLL.Customers.MerchantManager.DeleteOneMerchant(item, false);
			}
			catch (System.Exception ex)
			{
				results.StatusCode = -1;
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Customers.MerchantResults UpdateOneMerchant(string metaPartnerID, string serviceCharges, int metaPartnerSubTypeCode, int localeCode, int currencyCode, int dateFormatCode, string taxCode, bool isActive, string metaPartnerName, string pictureImageURL)
		{
			Components.Customers.MerchantResults results = new Components.Customers.MerchantResults();
			results.StatusDescription = "Results OK";
			try
			{
				...
				item.MetaPartnerName = metaPartnerName;
				item.PictureImageURL = pictureImageURL;
				BLL.Customers.MerchantManager.UpdateOneMerchant(item, false);
				results.Results.Add(item);
			}
			catch (System.Exception ex)
			{
