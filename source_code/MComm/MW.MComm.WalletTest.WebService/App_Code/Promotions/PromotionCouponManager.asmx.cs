...
namespace MW.MComm.WalletTest.WebService.Promotions
{
	...
	public class PromotionCouponManager : System.Web.Services.WebService
	{
		...
		///
		/// <param name="promotionCode">A property of PromotionCoupon item to be managed</param>
		/// <param name="couponCode">A property of PromotionCoupon item to be managed</param>
		/// <param name="rank">A property of PromotionCoupon item to be managed</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Promotions.PromotionCouponResults AddOnePromotionCoupon(int promotionCode, int couponCode, int rank)
		{
			...
			try
			{
				...
				BLL.Promotions.PromotionCoupon item = new BLL.Promotions.PromotionCoupon();
				item.PromotionCode = promotionCode;
				item.CouponCode = couponCode;
				item.Rank = rank;
				BLL.Promotions.PromotionCouponManager.AddOnePromotionCoupon(item, false);
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Promotions.PromotionCouponResults DeleteOnePromotionCoupon(int promotionCode, int couponCode)
		{
			Components.Promotions.PromotionCouponResults results = new Components.Promotions.PromotionCouponResults();
			results.StatusDescription = "Results OK";
			try
			{
				...
				item.PromotionCode = promotionCode;
				item.CouponCode = couponCode;
				BLL.Promotions.PromotionCouponManager.DeleteOnePromotionCoupon(item, false);
			}
			catch (System.Exception ex)
			{
				results.StatusCode = -1;
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Promotions.PromotionCouponResults UpdateOnePromotionCoupon(int promotionCode, int couponCode, int rank)
		{
			Components.Promotions.PromotionCouponResults results = new Components.Promotions.PromotionCouponResults();
			results.StatusDescription = "Results OK";
			try
			{
				...
				item.CouponCode = couponCode;
				item.Rank = rank;
				BLL.Promotions.PromotionCouponManager.UpdateOnePromotionCoupon(item, false);
				results.Results.Add(item);
			}
			catch (System.Exception ex)
			{
