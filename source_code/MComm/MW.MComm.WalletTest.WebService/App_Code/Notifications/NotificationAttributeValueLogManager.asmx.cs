...
namespace MW.MComm.WalletTest.WebService.Notifications
{
	...
	public class NotificationAttributeValueLogManager : System.Web.Services.WebService
	{
		...
		///
		/// <param name="notificationAttributeValueLogID">A property of NotificationAttributeValueLog item to be managed</param>
		/// <param name="notificationLogID">A property of NotificationAttributeValueLog item to be managed</param>
		/// <param name="baseAttributeValueID">A property of NotificationAttributeValueLog item to be managed</param>
		/// <param name="attributeValue">A property of NotificationAttributeValueLog item to be managed</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Notifications.NotificationAttributeValueLogResults LogOneNotificationAttributeValueLog(string notificationAttributeValueLogID, string notificationLogID, string baseAttributeValueID, string attributeValue)
		{
			Components.Notifications.NotificationAttributeValueLogResults results = new Components.Notifications.NotificationAttributeValueLogResults();
			results.StatusDescription = "Results OK";
			try
			{
				...
				item.NotificationAttributeValueLogID = MOD.Data.DataHelper.GetGuid(notificationAttributeValueLogID, MOD.Data.DefaultValue.Guid);
				item.NotificationLogID = MOD.Data.DataHelper.GetGuid(notificationLogID, MOD.Data.DefaultValue.Guid);
				item.BaseAttributeValueID = MOD.Data.DataHelper.GetGuid(baseAttributeValueID, MOD.Data.DefaultValue.Guid);
				item.AttributeValue = attributeValue;
				BLL.Notifications.NotificationAttributeValueLogManager.LogOneNotificationAttributeValueLog(item, false);
				results.Results.Add(item);
			}
			catch (System.Exception ex)
			{
