...
namespace MW.MComm.WalletTest.WebService.Notifications
{
	...
	public class NotificationManager : System.Web.Services.WebService
	{
		...
		///
		/// <param name="notificationCode">A property of Notification item to be managed</param>
		/// <param name="notificationName">A property of Notification item to be managed</param>
		/// <param name="eventCode">A property of Notification item to be managed</param>
		/// <param name="description">A property of Notification item to be managed</param>
		/// <param name="isActive">A property of Notification item to be managed</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Notifications.NotificationResults AddOneNotification(int notificationCode, string notificationName, int eventCode, string description, bool isActive)
		{
			...
			try
			{
				...
				item.NotificationName = notificationName;
				item.EventCode = eventCode;
				item.Description = description;
				item.IsActive = isActive;
				BLL.Notifications.NotificationManager.AddOneNotification(item, false);
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Notifications.NotificationResults DeleteOneNotification(int notificationCode)
		{
			Components.Notifications.NotificationResults results = new Components.Notifications.NotificationResults();
			results.StatusDescription = "Results OK";
			try
			{
				...
				BLL.Notifications.Notification item = new BLL.Notifications.Notification();
				item.NotificationCode = notificationCode;
				BLL.Notifications.NotificationManager.DeleteOneNotification(item, false);
			}
			catch (System.Exception ex)
			{
				results.StatusCode = -1;
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Notifications.NotificationResults UpdateOneNotification(int notificationCode, string notificationName, int eventCode, string description, bool isActive)
		{
			Components.Notifications.NotificationResults results = new Components.Notifications.NotificationResults();
			results.StatusDescription = "Results OK";
			try
			{
				...
				item.Description = description;
				item.IsActive = isActive;
				BLL.Notifications.NotificationManager.UpdateOneNotification(item, false);
				results.Results.Add(item);
			}
			catch (System.Exception ex)
			{
