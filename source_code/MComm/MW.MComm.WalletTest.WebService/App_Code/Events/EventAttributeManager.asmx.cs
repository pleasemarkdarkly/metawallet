...
namespace MW.MComm.WalletTest.WebService.Events
{
	...
	public class EventAttributeManager : System.Web.Services.WebService
	{
		...
		///
		/// <param name="baseAttributeID">A property of EventAttribute item to be managed</param>
		/// <param name="attributeCode">A property of EventAttribute item to be managed</param>
		/// <param name="attributeName">A property of EventAttribute item to be managed</param>
		/// <param name="attributeTypeCode">A property of EventAttribute item to be managed</param>
		/// <param name="dataTypeCode">A property of EventAttribute item to be managed</param>
		/// <param name="description">A property of EventAttribute item to be managed</param>
		/// <param name="isActive">A property of EventAttribute item to be managed</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Events.EventAttributeResults AddOneEventAttribute(string baseAttributeID, int attributeCode, string attributeName, int attributeTypeCode, int dataTypeCode, string description, bool isActive)
		{
			...
			try
			{
				...
				BLL.Events.EventAttributeManager.AddOneEventAttribute(item, false);
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Events.EventAttributeResults DeleteOneEventAttribute(string baseAttributeID)
		{
			Components.Events.EventAttributeResults results = new Components.Events.EventAttributeResults();
			results.StatusDescription = "Results OK";
			try
			{
				...
				BLL.Events.EventAttribute item = new BLL.Events.EventAttribute();
				item.BaseAttributeID = MOD.Data.DataHelper.GetGuid(baseAttributeID, MOD.Data.DefaultValue.Guid);
				BLL.Events.EventAttributeManager.DeleteOneEventAttribute(item, false);
			}
			catch (System.Exception ex)
			{
				results.StatusCode = -1;
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Events.EventAttributeResults UpdateOneEventAttribute(string baseAttributeID, int attributeCode, string attributeName, int attributeTypeCode, int dataTypeCode, string description, bool isActive)
		{
			Components.Events.EventAttributeResults results = new Components.Events.EventAttributeResults();
			results.StatusDescription = "Results OK";
			try
			{
				...
				item.Description = description;
				item.IsActive = isActive;
				BLL.Events.EventAttributeManager.UpdateOneEventAttribute(item, false);
				results.Results.Add(item);
			}
			catch (System.Exception ex)
			{
