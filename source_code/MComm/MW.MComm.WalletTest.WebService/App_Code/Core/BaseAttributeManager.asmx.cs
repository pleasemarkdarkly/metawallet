...
namespace MW.MComm.WalletTest.WebService.Core
{
	...
	public class BaseAttributeManager : System.Web.Services.WebService
	{
		...
		///
		/// <param name="baseAttributeID">A property of BaseAttribute item to be managed</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Core.BaseAttributeResults DeleteOneBaseAttribute(string baseAttributeID)
		{
			Components.Core.BaseAttributeResults results = new Components.Core.BaseAttributeResults();
			results.StatusDescription = "Results OK";
			try
			{
				...
				BLL.Core.BaseAttributeManager.DeleteOneBaseAttribute(item, false);
			}
			catch (System.Exception ex)
			{
				results.StatusCode = -1;
		...
		///
		/// <param name="baseAttributeID">A property of BaseAttribute item to be managed</param>
		/// <param name="attributeName">A property of BaseAttribute item to be managed</param>
		/// <param name="attributeTypeCode">A property of BaseAttribute item to be managed</param>
		/// <param name="dataTypeCode">A property of BaseAttribute item to be managed</param>
		/// <param name="description">A property of BaseAttribute item to be managed</param>
		/// <param name="isActive">A property of BaseAttribute item to be managed</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Core.BaseAttributeResults UpsertOneBaseAttribute(string baseAttributeID, string attributeName, int attributeTypeCode, int dataTypeCode, string description, bool isActive)
		{
			Components.Core.BaseAttributeResults results = new Components.Core.BaseAttributeResults();
			results.StatusDescription = "Results OK";
			try
			{
				...
				BLL.Core.BaseAttributeManager.UpsertOneBaseAttribute(item, false);
				results.Results.Add(item);
			}
			catch (System.Exception ex)
			{
