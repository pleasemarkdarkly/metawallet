...
namespace MW.MComm.WalletTest.WebService.Core
{
	...
	public class DebugAttributeManager : System.Web.Services.WebService
	{
		...
		///
		/// <param name="baseAttributeID">A property of DebugAttribute item to be managed</param>
		/// <param name="attributeCode">A property of DebugAttribute item to be managed</param>
		/// <param name="attributeName">A property of DebugAttribute item to be managed</param>
		/// <param name="attributeTypeCode">A property of DebugAttribute item to be managed</param>
		/// <param name="dataTypeCode">A property of DebugAttribute item to be managed</param>
		/// <param name="description">A property of DebugAttribute item to be managed</param>
		/// <param name="isActive">A property of DebugAttribute item to be managed</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Core.DebugAttributeResults AddOneDebugAttribute(string baseAttributeID, int attributeCode, string attributeName, int attributeTypeCode, int dataTypeCode, string description, bool isActive)
		{
			...
			try
			{
				...
				BLL.Core.DebugAttributeManager.AddOneDebugAttribute(item, false);
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Core.DebugAttributeResults DeleteOneDebugAttribute(string baseAttributeID)
		{
			Components.Core.DebugAttributeResults results = new Components.Core.DebugAttributeResults();
			results.StatusDescription = "Results OK";
			try
			{
				...
				BLL.Core.DebugAttribute item = new BLL.Core.DebugAttribute();
				item.BaseAttributeID = MOD.Data.DataHelper.GetGuid(baseAttributeID, MOD.Data.DefaultValue.Guid);
				BLL.Core.DebugAttributeManager.DeleteOneDebugAttribute(item, false);
			}
			catch (System.Exception ex)
			{
				results.StatusCode = -1;
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Core.DebugAttributeResults UpdateOneDebugAttribute(string baseAttributeID, int attributeCode, string attributeName, int attributeTypeCode, int dataTypeCode, string description, bool isActive)
		{
			Components.Core.DebugAttributeResults results = new Components.Core.DebugAttributeResults();
			results.StatusDescription = "Results OK";
			try
			{
				...
				item.Description = description;
				item.IsActive = isActive;
				BLL.Core.DebugAttributeManager.UpdateOneDebugAttribute(item, false);
				results.Results.Add(item);
			}
			catch (System.Exception ex)
			{
