...
namespace MW.MComm.WalletTest.WebService.Payments
{
	...
	public class PaymentManager : System.Web.Services.WebService
	{
		...
		///
		/// <param name="paymentID">A property of Payment item to be managed</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Payments.PaymentResults DeleteOnePayment(string paymentID)
		{
			Components.Payments.PaymentResults results = new Components.Payments.PaymentResults();
			results.StatusDescription = "Results OK";
			try
			{
				...
				BLL.Payments.PaymentManager.DeleteOnePayment(item, false);
			}
			catch (System.Exception ex)
			{
				results.StatusCode = -1;
		...
		///
		/// <param name="paymentID">A property of Payment item to be managed</param>
		/// <param name="paymentAmount">A property of Payment item to be managed</param>
		/// <param name="paymentSubtotal">A property of Payment item to be managed</param>
		/// <param name="paymentTax">A property of Payment item to be managed</param>
		/// <param name="paymentServiceCharge">A property of Payment item to be managed</param>
		/// <param name="orderID">A property of Payment item to be managed</param>
		/// <param name="debitMetaPartnerID">A property of Payment item to be managed</param>
		/// <param name="sourceAccountID">A property of Payment item to be managed</param>
		/// <param name="creditMetaPartnerID">A property of Payment item to be managed</param>
		/// <param name="destinationAccountID">A property of Payment item to be managed</param>
		/// <param name="paymentStatusCode">A property of Payment item to be managed</param>
		/// <param name="paymentStatusMessage">A property of Payment item to be managed</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Payments.PaymentResults UpsertOnePayment(string paymentID, decimal paymentAmount, decimal paymentSubtotal, decimal paymentTax, decimal paymentServiceCharge, string orderID, string debitMetaPartnerID, string sourceAccountID, string creditMetaPartnerID, string destinationAccountID, int paymentStatusCode, string paymentStatusMessage)
		{
			Components.Payments.PaymentResults results = new Components.Payments.PaymentResults();
			results.StatusDescription = "Results OK";
			try
			{
				...
				item.PaymentSubtotal = paymentSubtotal;
				item.PaymentTax = paymentTax;
				item.PaymentServiceCharge = paymentServiceCharge;
				...
				item.SourceAccountID = MOD.Data.DataHelper.GetGuid(sourceAccountID, MOD.Data.DefaultValue.Guid);
				item.CreditMetaPartnerID = MOD.Data.DataHelper.GetGuid(creditMetaPartnerID, MOD.Data.DefaultValue.Guid);
				item.DestinationAccountID = MOD.Data.DataHelper.GetGuid(destinationAccountID, MOD.Data.DefaultValue.Guid);
				item.PaymentStatusCode = paymentStatusCode;
				item.PaymentStatusMessage = paymentStatusMessage;
				BLL.Payments.PaymentManager.UpsertOnePayment(item, false);
				results.Results.Add(item);
			}
			catch (System.Exception ex)
			{
