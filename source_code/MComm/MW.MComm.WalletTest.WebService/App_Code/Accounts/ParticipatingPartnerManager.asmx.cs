...
namespace MW.MComm.WalletTest.WebService.Accounts
{
	...
	public class ParticipatingPartnerManager : System.Web.Services.WebService
	{
		...
		///
		/// <param name="accountID">A property of ParticipatingPartner item to be managed</param>
		/// <param name="metaPartnerID">A property of ParticipatingPartner item to be managed</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Accounts.ParticipatingPartnerResults AddOneParticipatingPartner(string accountID, string metaPartnerID)
		{
			...
			try
			{
				...
				BLL.Accounts.ParticipatingPartner item = new BLL.Accounts.ParticipatingPartner();
				...
				BLL.Accounts.ParticipatingPartnerManager.AddOneParticipatingPartner(item, false);
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Accounts.ParticipatingPartnerResults DeleteOneParticipatingPartner(string accountID, string metaPartnerID)
		{
			Components.Accounts.ParticipatingPartnerResults results = new Components.Accounts.ParticipatingPartnerResults();
			results.StatusDescription = "Results OK";
			try
			{
				...
				item.AccountID = MOD.Data.DataHelper.GetGuid(accountID, MOD.Data.DefaultValue.Guid);
				item.MetaPartnerID = MOD.Data.DataHelper.GetGuid(metaPartnerID, MOD.Data.DefaultValue.Guid);
				BLL.Accounts.ParticipatingPartnerManager.DeleteOneParticipatingPartner(item, false);
			}
			catch (System.Exception ex)
			{
				results.StatusCode = -1;
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Accounts.ParticipatingPartnerResults UpdateOneParticipatingPartner(string accountID, string metaPartnerID)
		{
			Components.Accounts.ParticipatingPartnerResults results = new Components.Accounts.ParticipatingPartnerResults();
			results.StatusDescription = "Results OK";
			try
			{
				...
				item.AccountID = MOD.Data.DataHelper.GetGuid(accountID, MOD.Data.DefaultValue.Guid);
				item.MetaPartnerID = MOD.Data.DataHelper.GetGuid(metaPartnerID, MOD.Data.DefaultValue.Guid);
				BLL.Accounts.ParticipatingPartnerManager.UpdateOneParticipatingPartner(item, false);
				results.Results.Add(item);
			}
			catch (System.Exception ex)
			{
