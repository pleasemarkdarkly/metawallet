...
namespace MW.MComm.WalletSolution.BLL.Customers
{
  ...
  {
    #region Methods
    //handles the creation of an account in a self-service manner
    //obtains name and other data from the carrier database
    //if unsuccesful, teh return string contains a user friendly error message
    #endregion Methods
  }
}