...
namespace MW.MComm.WalletSolution.BLL.Core
{
	...
	// ------------------------------------------------------------------------------
	[Serializable()]
	[DataTransform(Name = "MW.MComm.WalletSolution.DAL.Core.BaseAttribute")]
	public partial class BaseAttribute : PersistedBusinessObject
	{
		#region Constants
		#endregion Constants
		#region Fields
		...
		public virtual int AttributeTypeCode
		{
			...
			set
			{
				if (_attributeTypeCode != value)
				{
					...
					_attributeType = null;
					// reset AttributeType
					BLL.PersistedBusinessObject vAttributeType = (BLL.PersistedBusinessObject) AttributeType;
					vAttributeType = null;
					_isDirty = true;
				}
			}
		...
		public virtual int DataTypeCode
		{
			...
			set
			{
				if (_dataTypeCode != value)
				{
					...
					_dataType = null;
					// reset DataType
					BLL.PersistedBusinessObject vDataType = (BLL.PersistedBusinessObject) DataType;
					vDataType = null;
					_isDirty = true;
				}
			}
		...
		public virtual BLL.Core.AttributeType AttributeType
		{
			get
			{
				if (_attributeType == null  && IsLazyLoadable == true)
				{
					...
					{
						_attributeTypeName = MOD.Data.DefaultValue.String;
					}
				}
		...
		public virtual BLL.Core.DataType DataType
		{
			get
			{
				if (_dataType == null  && IsLazyLoadable == true)
				{
					...
					{
						_dataTypeName = MOD.Data.DefaultValue.String;
					}
				}
				return _dataType;
			}
		...
		{
			BLL.Core.BaseAttribute businessObject = null;
