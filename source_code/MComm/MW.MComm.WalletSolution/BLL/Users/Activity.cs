...
namespace MW.MComm.WalletSolution.BLL.Users
{
	...
	// ------------------------------------------------------------------------------
	[Serializable()]
	[DataTransform(Name = "MW.MComm.WalletSolution.DAL.Users.Activity")]
	public partial class Activity : PersistedBusinessObject
	{
		#region Constants
		#endregion Constants
		#region Fields
		...
		{
			BLL.Users.Activity businessObject = null;
