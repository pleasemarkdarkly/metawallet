...
namespace MW.MComm.WalletSolution.DAL.Customers
{
	...
	public partial class MetaPartnerEmail : Utility.BaseDataAccessObject
	{
		...
		// ------------------------------------------------------------------
		public static void DeleteAllMetaPartnerEmailDataByMetaPartnerID(Guid metaPartnerID, MOD.Data.DatabaseOptions dbOptions, int debugLevel)
		{
			...
			try
			{
				...
				DeleteAllMetaPartnerEmailDataByMetaPartnerID(metaPartnerID, dbAdapter);
			...
			catch (System.Exception ex)
			{
				...
				throw Utility.CustomAppException.WrapException(ex, "DAL.Customers.DeleteAllMetaPartnerEmailDataByMetaPartnerID");
			}
			finally
			{
		...
		/// <exception cref="System.Exception">Thrown when prior exceptions are thrown</exception>
		// ------------------------------------------------------------------
		public static void DeleteAllMetaPartnerEmailDataByMetaPartnerID(Guid metaPartnerID, MOD.Data.SqlProcAdapter dbAdapter)
		{
			try
			{
				// perform main method tasks
				...
				dbAdapter.ExecuteProcNQ("spCustomers_DeleteAllMetaPartnerEmailDataByMetaPartnerID", null, spParameters);
		...
		/// <exception cref="System.Exception">Thrown when prior exceptions are thrown</exception>
		// ------------------------------------------------------------------
		public static void DeleteOneMetaPartnerEmail(MetaPartnerEmail item, bool performCascadeOperation, MOD.Data.DatabaseOptions dbOptions, int debugLevel)
		{
			Utility.SqlManager dbManager = null;
			MOD.Data.SqlProcAdapter dbAdapter = null;
			try
			{
				...
				dbAdapter.Transaction = dbAdapter.Connection.BeginTransaction();
				// perform main method tasks
				DeleteOneMetaPartnerEmail(item, performCascadeOperation, dbAdapter);
				// commit the transaction
				dbAdapter.Transaction.Commit();
			}
			catch (System.Exception ex)
			{
				...
				throw Utility.CustomAppException.WrapException(ex, "DAL.Customers.DeleteOneMetaPartnerEmail");
			}
			finally
			{
				dbManager.ClearAdapter();
		...
		/// <exception cref="System.Exception">Thrown when prior exceptions are thrown</exception>
		// ------------------------------------------------------------------
		public static void DeleteOneMetaPartnerEmail(MetaPartnerEmail item, bool performCascadeOperation, MOD.Data.SqlProcAdapter dbAdapter)
		{
			try
			{
				// perform main method tasks
				...
				MOD.Data.NamedObjectCollection spParameters = new MOD.Data.NamedObjectCollection();
				dbAdapter.ExecuteProcNQ("spCustomers_DeleteOneMetaPartnerEmail", item, spParameters);
				// perform sql output error handling and get output parameters
				Globals.CheckThrowSqlError(spParameters);
				#region Cascade Operations
				if (performCascadeOperation == true)
		...
		/// <exception cref="System.Exception">Thrown when prior exceptions are thrown</exception>
		// ------------------------------------------------------------------
		public static MOD.Data.SortableObjectCollection GetAllMetaPartnerEmailData(MOD.Data.DatabaseOptions dbOptions, MOD.Data.DataOptions dataOptions, int debugLevel)
		{
			Utility.SqlManager dbManager = null;
			MOD.Data.SqlProcAdapter dbAdapter = null;
			try
			{
				...
				DataTable dt = dbAdapter.ExecuteProc("spCustomers_GetAllMetaPartnerEmailData", null, spParameters);
				// perform sql output error handling and get output parameters
				Globals.CheckThrowSqlError(spParameters);
				...
				{
					// get item
					MetaPartnerEmail item = (MetaPartnerEmail) DataTransformAttribute.Transform(row, new MetaPartnerEmail(), false, filterFields);
					try
					{
			...
			{
				throw Utility.CustomAppException.WrapException(ex, "DAL.Customers.GetAllMetaPartnerEmailData");
			}
			finally
			{
				dbManager.ClearAdapter();
		...
		/// <exception cref="System.Exception">Thrown when prior exceptions are thrown</exception>
		// ------------------------------------------------------------------
		public static MOD.Data.SortableObjectCollection GetAllMetaPartnerEmailDataByCriteria(DateTime? lastModifiedDateStart, DateTime? lastModifiedDateEnd, MOD.Data.DatabaseOptions dbOptions, MOD.Data.DataOptions dataOptions, int debugLevel)
		{
			Utility.SqlManager dbManager = null;
			MOD.Data.SqlProcAdapter dbAdapter = null;
			try
			{
				...
				DataTable dt = dbAdapter.ExecuteProc("spCustomers_GetAllMetaPartnerEmailDataByCriteria", null, spParameters);
				// perform sql output error handling and get output parameters
				Globals.CheckThrowSqlError(spParameters);
				// get output collection
				foreach(DataRow row in dt.Rows)
			...
			{
				throw Utility.CustomAppException.WrapException(ex, "DAL.Customers.GetAllMetaPartnerEmailDataByCriteria");
			}
			finally
			{
				dbManager.ClearAdapter();
		...
		/// <exception cref="System.Exception">Thrown when prior exceptions are thrown</exception>
		// ------------------------------------------------------------------
		public static MOD.Data.SortableObjectCollection GetAllMetaPartnerEmailDataByMetaPartnerID(Guid metaPartnerID, MOD.Data.DatabaseOptions dbOptions, MOD.Data.DataOptions dataOptions, int debugLevel)
		{
			Utility.SqlManager dbManager = null;
			MOD.Data.SqlProcAdapter dbAdapter = null;
			try
			{
				...
				DataTable dt = dbAdapter.ExecuteProc("spCustomers_GetAllMetaPartnerEmailDataByMetaPartnerID", null, spParameters);
				// perform sql output error handling and get output parameters
				Globals.CheckThrowSqlError(spParameters);
				// get output collection
				foreach(DataRow row in dt.Rows)
			...
			{
				throw Utility.CustomAppException.WrapException(ex, "DAL.Customers.GetAllMetaPartnerEmailDataByMetaPartnerID");
			}
			finally
			{
				dbManager.ClearAdapter();
		...
		/// <exception cref="System.Exception">Thrown when prior exceptions are thrown</exception>
		// ------------------------------------------------------------------
		public static MOD.Data.SortableObjectCollection GetAllMetaPartnerEmailDataByMetaPartnerID(Guid metaPartnerID, MOD.Data.SqlProcAdapter dbAdapter)
		{
			try
			{
				// perform main method tasks
				...
				{
					// get item
					MetaPartnerEmail item = (MetaPartnerEmail) DataTransformAttribute.Transform(row, new MetaPartnerEmail(), false);
					try
					{
						item.Password = MOD.Data.Encryption.DecryptString(item.Password);
					}
		...
		// ------------------------------------------------------------------
		/// <summary>This method gets many MetaPartnerEmail data by criteria.</summary>
		///
		/// <param name="lastModifiedDateStart">A key for MetaPartnerEmail items to be fetched</param>
		/// <param name="lastModifiedDateEnd">A key for MetaPartnerEmail items to be fetched</param>
		...
		/// <exception cref="System.Exception">Thrown when prior exceptions are thrown</exception>
		// ------------------------------------------------------------------
		public static MOD.Data.SortableObjectCollection GetManyMetaPartnerEmailDataByCriteria(DateTime? lastModifiedDateStart, DateTime? lastModifiedDateEnd, out int totalRecords, out bool maximumListSizeExceeded, MOD.Data.DatabaseOptions dbOptions, MOD.Data.DataOptions dataOptions, int debugLevel)
		{
			Utility.SqlManager dbManager = null;
			MOD.Data.SqlProcAdapter dbAdapter = null;
			try
			{
				...
				DataTable dt = dbAdapter.ExecuteProc("spCustomers_GetManyMetaPartnerEmailDataByCriteria", null, spParameters);
				// perform sql output error handling and get output parameters
				Globals.CheckThrowSqlError(spParameters);
			...
			{
				throw Utility.CustomAppException.WrapException(ex, "DAL.Customers.GetManyMetaPartnerEmailDataByCriteria");
			}
			finally
			{
				dbManager.ClearAdapter();
		...
		///
		/// <param name="metaPartnerEmailID">A key for MetaPartnerEmail items to be fetched</param>
		/// <param name="dbOptions">Database connection information</param>
		/// <param name="dataOptions">Data retrieval options</param>
		/// <param name="debugLevel">Debug level on error</param>
		/// <exception cref="CustomAppException">Thrown when an error is encountered in SQL</exception>
		...
		/// <exception cref="System.Exception">Thrown when prior exceptions are thrown</exception>
		// ------------------------------------------------------------------
		public static MetaPartnerEmail GetOneMetaPartnerEmail(Guid metaPartnerEmailID, MOD.Data.DatabaseOptions dbOptions, MOD.Data.DataOptions dataOptions, int debugLevel)
		{
			Utility.SqlManager dbManager = null;
			MOD.Data.SqlProcAdapter dbAdapter = null;
			try
			{
				...
				MOD.Data.NamedObjectCollection spParameters = new MOD.Data.NamedObjectCollection();
				MOD.Data.NamedObjectCollection filterFields = new MOD.Data.NamedObjectCollection();
				MetaPartnerEmail item = new MetaPartnerEmail();
				spParameters["MetaPartnerEmailID"] = metaPartnerEmailID;
				if(dataOptions != null)
				{
					dataOptions.PopulateNamedObjectCollection( spParameters );
					filterFields = dataOptions.FilterFields;
				}
				DataTable dt = dbAdapter.ExecuteProc("spCustomers_GetOneMetaPartnerEmail", null, spParameters);
				// perform sql output error handling and get output parameters
				Globals.CheckThrowSqlError(spParameters);
				item = null;
				// get output item
				...
				{
					// get item
					item = (MetaPartnerEmail) DataTransformAttribute.Transform(row, new MetaPartnerEmail(), false, filterFields);
					try
					{
						item.Password = MOD.Data.Encryption.DecryptString(item.Password);
					}
			...
			{
				throw Utility.CustomAppException.WrapException(ex, "DAL.Customers.GetOneMetaPartnerEmail");
			}
			finally
			{
				dbManager.ClearAdapter();
		...
		/// <summary>This method gets a single MetaPartnerEmail by an index.</summary>
		///
		/// <param name="emailAddress">A key for MetaPartnerEmail items to be fetched</param>
		/// <param name="dbOptions">Database connection information</param>
		/// <param name="dataOptions">Data retrieval options</param>
		/// <param name="debugLevel">Debug level on error</param>
		/// <exception cref="CustomAppException">Thrown when an error is encountered in SQL</exception>
		...
		/// <exception cref="System.Exception">Thrown when prior exceptions are thrown</exception>
		// ------------------------------------------------------------------
		public static MetaPartnerEmail GetOneMetaPartnerEmailByEmailAddress(string emailAddress, MOD.Data.DatabaseOptions dbOptions, MOD.Data.DataOptions dataOptions, int debugLevel)
		{
			Utility.SqlManager dbManager = null;
			MOD.Data.SqlProcAdapter dbAdapter = null;
			try
			{
				...
				MOD.Data.NamedObjectCollection filterFields = new MOD.Data.NamedObjectCollection();
				MetaPartnerEmail item = new MetaPartnerEmail();
				spParameters["EmailAddress"] = emailAddress;
				if(dataOptions != null)
				{
					dataOptions.PopulateNamedObjectCollection( spParameters );
					filterFields = dataOptions.FilterFields;
				}
				DataTable dt = dbAdapter.ExecuteProc("spCustomers_GetOneMetaPartnerEmailByEmailAddress", null, spParameters);
				// perform sql output error handling and get output parameters
				Globals.CheckThrowSqlError(spParameters);
				item = null;
				// get output item
			...
			{
				throw Utility.CustomAppException.WrapException(ex, "DAL.Customers.GetOneMetaPartnerEmailByEmailAddress");
			}
			finally
			{
				dbManager.ClearAdapter();
		...
		/// <exception cref="System.Exception">Thrown when prior exceptions are thrown</exception>
		// ------------------------------------------------------------------
		public static void UpsertOneMetaPartnerEmail(MetaPartnerEmail item, bool performCascadeOperation, MOD.Data.DatabaseOptions dbOptions, int debugLevel)
		{
			Utility.SqlManager dbManager = null;
			MOD.Data.SqlProcAdapter dbAdapter = null;
			try
			{
				...
				dbAdapter.Transaction = dbAdapter.Connection.BeginTransaction();
				// perform main method tasks
				UpsertOneMetaPartnerEmail(item, performCascadeOperation, dbAdapter);
				// commit the transaction
				dbAdapter.Transaction.Commit();
			}
			catch (System.Exception ex)
			{
				...
				throw Utility.CustomAppException.WrapException(ex, "DAL.Customers.UpsertOneMetaPartnerEmail");
			}
			finally
			{
				dbManager.ClearAdapter();
		...
		/// <exception cref="System.Exception">Thrown when prior exceptions are thrown</exception>
		// ------------------------------------------------------------------
		public static void UpsertOneMetaPartnerEmail(MetaPartnerEmail item, bool performCascadeOperation, MOD.Data.SqlProcAdapter dbAdapter)
		{
			try
			{
				// perform main method tasks
				...
				dbAdapter.ExecuteProcNQ("spCustomers_UpsertOneMetaPartnerEmail", item, spParameters);
				// perform sql output error handling and get output parameters
				Globals.CheckThrowSqlError(spParameters);
				item.MetaPartnerEmailID = MOD.Data.DataHelper.GetGuid(spParameters["MetaPartnerEmailID"], MOD.Data.DefaultValue.Guid);
