...
namespace MW.MComm.CarrierSim.WebService.Core
{
	...
	/// <remarks></remarks>
	// ------------------------------------------------------------------------------
	[WebService(Namespace = "http://modsystems.com/MW.MComm.CarrierSim.WebService/Core/EventTypeManager")]
	...
	public class EventTypeManager : System.Web.Services.WebService
	{
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Core.EventTypeResults AddOneEventType(BLL.Core.EventType item, bool performCascadeOperation)
		{
			...
			try
			{
				...
				BLL.Core.EventTypeManager.AddOneEventType(item, performCascadeOperation);
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Core.EventTypeResults UpdateOneEventType(BLL.Core.EventType item, bool performCascadeOperation)
		{
			Components.Core.EventTypeResults results = new Components.Core.EventTypeResults();
			results.StatusDescription = "Results OK";
			try
			{
				// perform main method tasks
				BLL.Core.EventTypeManager.UpdateOneEventType(item, performCascadeOperation);
				results.Results.Add(item);
			}
			catch (System.Exception ex)
			{
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Core.EventTypeResults DeleteOneEventType(BLL.Core.EventType item, bool performCascadeOperation)
		{
			Components.Core.EventTypeResults results = new Components.Core.EventTypeResults();
			results.StatusDescription = "Results OK";
			try
			{
				// perform main method tasks
				BLL.Core.EventTypeManager.DeleteOneEventType(item, performCascadeOperation);
			}
			catch (System.Exception ex)
			{
				results.StatusCode = -1;
