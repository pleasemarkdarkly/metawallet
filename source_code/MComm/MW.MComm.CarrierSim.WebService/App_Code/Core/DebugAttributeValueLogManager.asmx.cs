...
namespace MW.MComm.CarrierSim.WebService.Core
{
	...
	/// <remarks></remarks>
	// ------------------------------------------------------------------------------
	[WebService(Namespace = "http://modsystems.com/MW.MComm.CarrierSim.WebService/Core/DebugAttributeValueLogManager")]
	...
	public class DebugAttributeValueLogManager : System.Web.Services.WebService
	{
		...
		///
		/// <param name="item">The DebugAttributeValueLog to be managed.</param>
		/// <param name="performCascadeOperation">Flag, indicating if a cascade operation should be performed on the DebugAttributeValueLog item.</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Core.DebugAttributeValueLogResults LogOneDebugAttributeValueLog(BLL.Core.DebugAttributeValueLog item, bool performCascadeOperation)
		{
			...
			try
			{
				...
				BLL.Core.DebugAttributeValueLogManager.LogOneDebugAttributeValueLog(item, performCascadeOperation);
