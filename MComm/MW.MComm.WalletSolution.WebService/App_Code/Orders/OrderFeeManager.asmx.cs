...
namespace MW.MComm.WalletSolution.WebService.Orders
{
	...
	public class OrderFeeManager : System.Web.Services.WebService
	{
		...
		///
		/// <param name="item">The OrderFee to be managed.</param>
		/// <param name="performCascadeOperation">Flag, indicating if a cascade operation should be performed on the OrderFee item.</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Orders.OrderFeeResults AddOneOrderFee(BLL.Orders.OrderFee item, bool performCascadeOperation)
		{
			...
			try
			{
				...
				BLL.Orders.OrderFeeManager.AddOneOrderFee(item, performCascadeOperation);
		...
		/// <param name="performCascadeOperation">Flag, indicating if a cascade delete should be performed on the OrderFee item.</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Orders.OrderFeeResults DeleteOneOrderFee(BLL.Orders.OrderFee item, bool performCascadeOperation)
		{
			Components.Orders.OrderFeeResults results = new Components.Orders.OrderFeeResults();
			results.StatusDescription = "Results OK";
			try
			{
				// perform main method tasks
				BLL.Orders.OrderFeeManager.DeleteOneOrderFee(item, performCascadeOperation);
			}
			catch (System.Exception ex)
			{
				results.StatusCode = -1;
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Orders.OrderFeeResults UpdateOneOrderFee(BLL.Orders.OrderFee item, bool performCascadeOperation)
		{
			Components.Orders.OrderFeeResults results = new Components.Orders.OrderFeeResults();
			results.StatusDescription = "Results OK";
			try
			{
				// perform main method tasks
				BLL.Orders.OrderFeeManager.UpdateOneOrderFee(item, performCascadeOperation);
				results.Results.Add(item);
			}
			catch (System.Exception ex)
			{
