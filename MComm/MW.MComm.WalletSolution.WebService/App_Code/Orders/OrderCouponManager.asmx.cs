...
namespace MW.MComm.WalletSolution.WebService.Orders
{
	...
	public class OrderCouponManager : System.Web.Services.WebService
	{
		...
		///
		/// <param name="item">The OrderCoupon to be managed.</param>
		/// <param name="performCascadeOperation">Flag, indicating if a cascade operation should be performed on the OrderCoupon item.</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Orders.OrderCouponResults AddOneOrderCoupon(BLL.Orders.OrderCoupon item, bool performCascadeOperation)
		{
			...
			try
			{
				...
				BLL.Orders.OrderCouponManager.AddOneOrderCoupon(item, performCascadeOperation);
		...
		/// <param name="performCascadeOperation">Flag, indicating if a cascade delete should be performed on the OrderCoupon item.</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Orders.OrderCouponResults DeleteOneOrderCoupon(BLL.Orders.OrderCoupon item, bool performCascadeOperation)
		{
			Components.Orders.OrderCouponResults results = new Components.Orders.OrderCouponResults();
			results.StatusDescription = "Results OK";
			try
			{
				// perform main method tasks
				BLL.Orders.OrderCouponManager.DeleteOneOrderCoupon(item, performCascadeOperation);
			}
			catch (System.Exception ex)
			{
				results.StatusCode = -1;
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Orders.OrderCouponResults UpdateOneOrderCoupon(BLL.Orders.OrderCoupon item, bool performCascadeOperation)
		{
			Components.Orders.OrderCouponResults results = new Components.Orders.OrderCouponResults();
			results.StatusDescription = "Results OK";
			try
			{
				// perform main method tasks
				BLL.Orders.OrderCouponManager.UpdateOneOrderCoupon(item, performCascadeOperation);
				results.Results.Add(item);
			}
			catch (System.Exception ex)
			{
