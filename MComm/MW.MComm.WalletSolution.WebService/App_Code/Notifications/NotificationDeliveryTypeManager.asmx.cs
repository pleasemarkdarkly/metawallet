...
namespace MW.MComm.WalletSolution.WebService.Notifications
{
	...
	public class NotificationDeliveryTypeManager : System.Web.Services.WebService
	{
		...
		///
		/// <param name="item">The NotificationDeliveryType to be managed.</param>
		/// <param name="performCascadeOperation">Flag, indicating if a cascade operation should be performed on the NotificationDeliveryType item.</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Notifications.NotificationDeliveryTypeResults AddOneNotificationDeliveryType(BLL.Notifications.NotificationDeliveryType item, bool performCascadeOperation)
		{
			...
			try
			{
				...
				BLL.Notifications.NotificationDeliveryTypeManager.AddOneNotificationDeliveryType(item, performCascadeOperation);
		...
		/// <param name="performCascadeOperation">Flag, indicating if a cascade delete should be performed on the NotificationDeliveryType item.</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Notifications.NotificationDeliveryTypeResults DeleteOneNotificationDeliveryType(BLL.Notifications.NotificationDeliveryType item, bool performCascadeOperation)
		{
			Components.Notifications.NotificationDeliveryTypeResults results = new Components.Notifications.NotificationDeliveryTypeResults();
			results.StatusDescription = "Results OK";
			try
			{
				// perform main method tasks
				BLL.Notifications.NotificationDeliveryTypeManager.DeleteOneNotificationDeliveryType(item, performCascadeOperation);
			}
			catch (System.Exception ex)
			{
				results.StatusCode = -1;
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Notifications.NotificationDeliveryTypeResults UpdateOneNotificationDeliveryType(BLL.Notifications.NotificationDeliveryType item, bool performCascadeOperation)
		{
			Components.Notifications.NotificationDeliveryTypeResults results = new Components.Notifications.NotificationDeliveryTypeResults();
			results.StatusDescription = "Results OK";
			try
			{
				// perform main method tasks
				BLL.Notifications.NotificationDeliveryTypeManager.UpdateOneNotificationDeliveryType(item, performCascadeOperation);
				results.Results.Add(item);
			}
			catch (System.Exception ex)
			{
