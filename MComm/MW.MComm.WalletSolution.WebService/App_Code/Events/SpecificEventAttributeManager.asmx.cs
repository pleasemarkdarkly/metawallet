...
namespace MW.MComm.WalletSolution.WebService.Events
{
	...
	public class SpecificEventAttributeManager : System.Web.Services.WebService
	{
		...
		///
		/// <param name="item">The SpecificEventAttribute to be managed.</param>
		/// <param name="performCascadeOperation">Flag, indicating if a cascade operation should be performed on the SpecificEventAttribute item.</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Events.SpecificEventAttributeResults AddOneSpecificEventAttribute(BLL.Events.SpecificEventAttribute item, bool performCascadeOperation)
		{
			...
			try
			{
				...
				BLL.Events.SpecificEventAttributeManager.AddOneSpecificEventAttribute(item, performCascadeOperation);
		...
		/// <param name="performCascadeOperation">Flag, indicating if a cascade delete should be performed on the SpecificEventAttribute item.</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Events.SpecificEventAttributeResults DeleteOneSpecificEventAttribute(BLL.Events.SpecificEventAttribute item, bool performCascadeOperation)
		{
			Components.Events.SpecificEventAttributeResults results = new Components.Events.SpecificEventAttributeResults();
			results.StatusDescription = "Results OK";
			try
			{
				// perform main method tasks
				BLL.Events.SpecificEventAttributeManager.DeleteOneSpecificEventAttribute(item, performCascadeOperation);
			}
			catch (System.Exception ex)
			{
				results.StatusCode = -1;
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Events.SpecificEventAttributeResults UpdateOneSpecificEventAttribute(BLL.Events.SpecificEventAttribute item, bool performCascadeOperation)
		{
			Components.Events.SpecificEventAttributeResults results = new Components.Events.SpecificEventAttributeResults();
			results.StatusDescription = "Results OK";
			try
			{
				// perform main method tasks
				BLL.Events.SpecificEventAttributeManager.UpdateOneSpecificEventAttribute(item, performCascadeOperation);
				results.Results.Add(item);
			}
			catch (System.Exception ex)
			{
