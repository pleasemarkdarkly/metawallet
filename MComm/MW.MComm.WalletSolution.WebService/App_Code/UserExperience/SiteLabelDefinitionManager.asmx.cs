...
namespace MW.MComm.WalletSolution.WebService.UserExperience
{
	...
	public class SiteLabelDefinitionManager : System.Web.Services.WebService
	{
		...
		///
		/// <param name="item">The SiteLabelDefinition to be managed.</param>
		/// <param name="performCascadeOperation">Flag, indicating if a cascade operation should be performed on the SiteLabelDefinition item.</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.UserExperience.SiteLabelDefinitionResults AddOneSiteLabelDefinition(BLL.UserExperience.SiteLabelDefinition item, bool performCascadeOperation)
		{
			...
			try
			{
				...
				BLL.UserExperience.SiteLabelDefinitionManager.AddOneSiteLabelDefinition(item, performCascadeOperation);
		...
		/// <param name="performCascadeOperation">Flag, indicating if a cascade delete should be performed on the SiteLabelDefinition item.</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.UserExperience.SiteLabelDefinitionResults DeleteOneSiteLabelDefinition(BLL.UserExperience.SiteLabelDefinition item, bool performCascadeOperation)
		{
			Components.UserExperience.SiteLabelDefinitionResults results = new Components.UserExperience.SiteLabelDefinitionResults();
			results.StatusDescription = "Results OK";
			try
			{
				// perform main method tasks
				BLL.UserExperience.SiteLabelDefinitionManager.DeleteOneSiteLabelDefinition(item, performCascadeOperation);
			}
			catch (System.Exception ex)
			{
				results.StatusCode = -1;
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.UserExperience.SiteLabelDefinitionResults UpdateOneSiteLabelDefinition(BLL.UserExperience.SiteLabelDefinition item, bool performCascadeOperation)
		{
			Components.UserExperience.SiteLabelDefinitionResults results = new Components.UserExperience.SiteLabelDefinitionResults();
			results.StatusDescription = "Results OK";
			try
			{
				// perform main method tasks
				BLL.UserExperience.SiteLabelDefinitionManager.UpdateOneSiteLabelDefinition(item, performCascadeOperation);
				results.Results.Add(item);
			}
			catch (System.Exception ex)
			{
