...
namespace MW.MComm.WalletSolution.WebService.Payments
{
	...
	public class PaymentTransactionAttributeValueLogManager : System.Web.Services.WebService
	{
		...
		///
		/// <param name="item">The PaymentTransactionAttributeValueLog to be managed.</param>
		/// <param name="performCascadeOperation">Flag, indicating if a cascade operation should be performed on the PaymentTransactionAttributeValueLog item.</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Payments.PaymentTransactionAttributeValueLogResults LogOnePaymentTransactionAttributeValueLog(BLL.Payments.PaymentTransactionAttributeValueLog item, bool performCascadeOperation)
		{
			Components.Payments.PaymentTransactionAttributeValueLogResults results = new Components.Payments.PaymentTransactionAttributeValueLogResults();
			results.StatusDescription = "Results OK";
			try
			{
				// perform main method tasks
				BLL.Payments.PaymentTransactionAttributeValueLogManager.LogOnePaymentTransactionAttributeValueLog(item, performCascadeOperation);
				results.Results.Add(item);
			}
			catch (System.Exception ex)
			{
