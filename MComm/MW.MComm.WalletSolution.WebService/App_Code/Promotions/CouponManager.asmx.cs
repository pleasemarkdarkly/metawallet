...
namespace MW.MComm.WalletSolution.WebService.Promotions
{
	...
	public class CouponManager : System.Web.Services.WebService
	{
		...
		///
		/// <param name="item">The Coupon to be managed.</param>
		/// <param name="performCascadeOperation">Flag, indicating if a cascade operation should be performed on the Coupon item.</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Promotions.CouponResults AddOneCoupon(BLL.Promotions.Coupon item, bool performCascadeOperation)
		{
			...
			try
			{
				...
				BLL.Promotions.CouponManager.AddOneCoupon(item, performCascadeOperation);
		...
		/// <param name="performCascadeOperation">Flag, indicating if a cascade delete should be performed on the Coupon item.</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Promotions.CouponResults DeleteOneCoupon(BLL.Promotions.Coupon item, bool performCascadeOperation)
		{
			Components.Promotions.CouponResults results = new Components.Promotions.CouponResults();
			results.StatusDescription = "Results OK";
			try
			{
				// perform main method tasks
				BLL.Promotions.CouponManager.DeleteOneCoupon(item, performCascadeOperation);
			}
			catch (System.Exception ex)
			{
				results.StatusCode = -1;
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Promotions.CouponResults UpdateOneCoupon(BLL.Promotions.Coupon item, bool performCascadeOperation)
		{
			Components.Promotions.CouponResults results = new Components.Promotions.CouponResults();
			results.StatusDescription = "Results OK";
			try
			{
				// perform main method tasks
				BLL.Promotions.CouponManager.UpdateOneCoupon(item, performCascadeOperation);
				results.Results.Add(item);
			}
			catch (System.Exception ex)
			{
