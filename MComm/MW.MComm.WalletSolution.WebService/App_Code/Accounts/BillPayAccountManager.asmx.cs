...
namespace MW.MComm.WalletSolution.WebService.Accounts
{
	...
	public class BillPayAccountManager : System.Web.Services.WebService
	{
		...
		///
		/// <param name="item">The BillPayAccount to be managed.</param>
		/// <param name="performCascadeOperation">Flag, indicating if a cascade operation should be performed on the BillPayAccount item.</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Accounts.BillPayAccountResults AddOneBillPayAccount(BLL.Accounts.BillPayAccount item, bool performCascadeOperation)
		{
			...
			try
			{
				...
				BLL.Accounts.BillPayAccountManager.AddOneBillPayAccount(item, performCascadeOperation);
		...
		/// <param name="performCascadeOperation">Flag, indicating if a cascade delete should be performed on the BillPayAccount item.</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Accounts.BillPayAccountResults DeleteOneBillPayAccount(BLL.Accounts.BillPayAccount item, bool performCascadeOperation)
		{
			Components.Accounts.BillPayAccountResults results = new Components.Accounts.BillPayAccountResults();
			results.StatusDescription = "Results OK";
			try
			{
				// perform main method tasks
				BLL.Accounts.BillPayAccountManager.DeleteOneBillPayAccount(item, performCascadeOperation);
			}
			catch (System.Exception ex)
			{
				results.StatusCode = -1;
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Accounts.BillPayAccountResults UpdateOneBillPayAccount(BLL.Accounts.BillPayAccount item, bool performCascadeOperation)
		{
			Components.Accounts.BillPayAccountResults results = new Components.Accounts.BillPayAccountResults();
			results.StatusDescription = "Results OK";
			try
			{
				// perform main method tasks
				BLL.Accounts.BillPayAccountManager.UpdateOneBillPayAccount(item, performCascadeOperation);
				results.Results.Add(item);
			}
			catch (System.Exception ex)
			{
