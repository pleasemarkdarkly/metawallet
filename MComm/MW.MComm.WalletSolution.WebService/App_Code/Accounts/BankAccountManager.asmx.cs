...
namespace MW.MComm.WalletSolution.WebService.Accounts
{
	...
	public class BankAccountManager : System.Web.Services.WebService
	{
		...
		///
		/// <param name="item">The BankAccount to be managed.</param>
		/// <param name="performCascadeOperation">Flag, indicating if a cascade operation should be performed on the BankAccount item.</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Accounts.BankAccountResults AddOneBankAccount(BLL.Accounts.BankAccount item, bool performCascadeOperation)
		{
			...
			try
			{
				...
				BLL.Accounts.BankAccountManager.AddOneBankAccount(item, performCascadeOperation);
		...
		/// <param name="performCascadeOperation">Flag, indicating if a cascade delete should be performed on the BankAccount item.</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Accounts.BankAccountResults DeleteOneBankAccount(BLL.Accounts.BankAccount item, bool performCascadeOperation)
		{
			Components.Accounts.BankAccountResults results = new Components.Accounts.BankAccountResults();
			results.StatusDescription = "Results OK";
			try
			{
				// perform main method tasks
				BLL.Accounts.BankAccountManager.DeleteOneBankAccount(item, performCascadeOperation);
			}
			catch (System.Exception ex)
			{
				results.StatusCode = -1;
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Accounts.BankAccountResults UpdateOneBankAccount(BLL.Accounts.BankAccount item, bool performCascadeOperation)
		{
			Components.Accounts.BankAccountResults results = new Components.Accounts.BankAccountResults();
			results.StatusDescription = "Results OK";
			try
			{
				// perform main method tasks
				BLL.Accounts.BankAccountManager.UpdateOneBankAccount(item, performCascadeOperation);
				results.Results.Add(item);
			}
			catch (System.Exception ex)
			{
