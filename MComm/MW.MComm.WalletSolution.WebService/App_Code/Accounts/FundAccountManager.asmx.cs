...
namespace MW.MComm.WalletSolution.WebService.Accounts
{
	...
	public class FundAccountManager : System.Web.Services.WebService
	{
		...
		///
		/// <param name="item">The FundAccount to be managed.</param>
		/// <param name="performCascadeOperation">Flag, indicating if a cascade operation should be performed on the FundAccount item.</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Accounts.FundAccountResults AddOneFundAccount(BLL.Accounts.FundAccount item, bool performCascadeOperation)
		{
			...
			try
			{
				...
				BLL.Accounts.FundAccountManager.AddOneFundAccount(item, performCascadeOperation);
		...
		/// <param name="performCascadeOperation">Flag, indicating if a cascade delete should be performed on the FundAccount item.</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Accounts.FundAccountResults DeleteOneFundAccount(BLL.Accounts.FundAccount item, bool performCascadeOperation)
		{
			Components.Accounts.FundAccountResults results = new Components.Accounts.FundAccountResults();
			results.StatusDescription = "Results OK";
			try
			{
				// perform main method tasks
				BLL.Accounts.FundAccountManager.DeleteOneFundAccount(item, performCascadeOperation);
			}
			catch (System.Exception ex)
			{
				results.StatusCode = -1;
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Accounts.FundAccountResults UpdateOneFundAccount(BLL.Accounts.FundAccount item, bool performCascadeOperation)
		{
			Components.Accounts.FundAccountResults results = new Components.Accounts.FundAccountResults();
			results.StatusDescription = "Results OK";
			try
			{
				// perform main method tasks
				BLL.Accounts.FundAccountManager.UpdateOneFundAccount(item, performCascadeOperation);
				results.Results.Add(item);
			}
			catch (System.Exception ex)
			{
