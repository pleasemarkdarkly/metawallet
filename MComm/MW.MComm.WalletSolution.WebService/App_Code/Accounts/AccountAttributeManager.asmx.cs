...
namespace MW.MComm.WalletSolution.WebService.Accounts
{
	...
	public class AccountAttributeManager : System.Web.Services.WebService
	{
		...
		///
		/// <param name="item">The AccountAttribute to be managed.</param>
		/// <param name="performCascadeOperation">Flag, indicating if a cascade operation should be performed on the AccountAttribute item.</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Accounts.AccountAttributeResults AddOneAccountAttribute(BLL.Accounts.AccountAttribute item, bool performCascadeOperation)
		{
			...
			try
			{
				...
				BLL.Accounts.AccountAttributeManager.AddOneAccountAttribute(item, performCascadeOperation);
		...
		/// <param name="performCascadeOperation">Flag, indicating if a cascade delete should be performed on the AccountAttribute item.</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Accounts.AccountAttributeResults DeleteOneAccountAttribute(BLL.Accounts.AccountAttribute item, bool performCascadeOperation)
		{
			Components.Accounts.AccountAttributeResults results = new Components.Accounts.AccountAttributeResults();
			results.StatusDescription = "Results OK";
			try
			{
				// perform main method tasks
				BLL.Accounts.AccountAttributeManager.DeleteOneAccountAttribute(item, performCascadeOperation);
			}
			catch (System.Exception ex)
			{
				results.StatusCode = -1;
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Accounts.AccountAttributeResults UpdateOneAccountAttribute(BLL.Accounts.AccountAttribute item, bool performCascadeOperation)
		{
			Components.Accounts.AccountAttributeResults results = new Components.Accounts.AccountAttributeResults();
			results.StatusDescription = "Results OK";
			try
			{
				// perform main method tasks
				BLL.Accounts.AccountAttributeManager.UpdateOneAccountAttribute(item, performCascadeOperation);
				results.Results.Add(item);
			}
			catch (System.Exception ex)
			{
