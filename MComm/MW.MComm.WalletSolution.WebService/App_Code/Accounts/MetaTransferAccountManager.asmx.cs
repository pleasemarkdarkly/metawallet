...
namespace MW.MComm.WalletSolution.WebService.Accounts
{
	...
	public class MetaTransferAccountManager : System.Web.Services.WebService
	{
		...
		///
		/// <param name="item">The MetaTransferAccount to be managed.</param>
		/// <param name="performCascadeOperation">Flag, indicating if a cascade operation should be performed on the MetaTransferAccount item.</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Accounts.MetaTransferAccountResults AddOneMetaTransferAccount(BLL.Accounts.MetaTransferAccount item, bool performCascadeOperation)
		{
			...
			try
			{
				...
				BLL.Accounts.MetaTransferAccountManager.AddOneMetaTransferAccount(item, performCascadeOperation);
		...
		/// <param name="performCascadeOperation">Flag, indicating if a cascade delete should be performed on the MetaTransferAccount item.</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Accounts.MetaTransferAccountResults DeleteOneMetaTransferAccount(BLL.Accounts.MetaTransferAccount item, bool performCascadeOperation)
		{
			Components.Accounts.MetaTransferAccountResults results = new Components.Accounts.MetaTransferAccountResults();
			results.StatusDescription = "Results OK";
			try
			{
				// perform main method tasks
				BLL.Accounts.MetaTransferAccountManager.DeleteOneMetaTransferAccount(item, performCascadeOperation);
			}
			catch (System.Exception ex)
			{
				results.StatusCode = -1;
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Accounts.MetaTransferAccountResults UpdateOneMetaTransferAccount(BLL.Accounts.MetaTransferAccount item, bool performCascadeOperation)
		{
			Components.Accounts.MetaTransferAccountResults results = new Components.Accounts.MetaTransferAccountResults();
			results.StatusDescription = "Results OK";
			try
			{
				// perform main method tasks
				BLL.Accounts.MetaTransferAccountManager.UpdateOneMetaTransferAccount(item, performCascadeOperation);
				results.Results.Add(item);
			}
			catch (System.Exception ex)
			{
