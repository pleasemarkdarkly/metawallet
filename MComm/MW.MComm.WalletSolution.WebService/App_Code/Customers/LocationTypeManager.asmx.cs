...
namespace MW.MComm.WalletSolution.WebService.Customers
{
	...
	public class LocationTypeManager : System.Web.Services.WebService
	{
		...
		///
		/// <param name="item">The LocationType to be managed.</param>
		/// <param name="performCascadeOperation">Flag, indicating if a cascade operation should be performed on the LocationType item.</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Customers.LocationTypeResults AddOneLocationType(BLL.Customers.LocationType item, bool performCascadeOperation)
		{
			...
			try
			{
				...
				BLL.Customers.LocationTypeManager.AddOneLocationType(item, performCascadeOperation);
		...
		/// <param name="performCascadeOperation">Flag, indicating if a cascade delete should be performed on the LocationType item.</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Customers.LocationTypeResults DeleteOneLocationType(BLL.Customers.LocationType item, bool performCascadeOperation)
		{
			Components.Customers.LocationTypeResults results = new Components.Customers.LocationTypeResults();
			results.StatusDescription = "Results OK";
			try
			{
				// perform main method tasks
				BLL.Customers.LocationTypeManager.DeleteOneLocationType(item, performCascadeOperation);
			}
			catch (System.Exception ex)
			{
				results.StatusCode = -1;
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Customers.LocationTypeResults UpdateOneLocationType(BLL.Customers.LocationType item, bool performCascadeOperation)
		{
			Components.Customers.LocationTypeResults results = new Components.Customers.LocationTypeResults();
			results.StatusDescription = "Results OK";
			try
			{
				// perform main method tasks
				BLL.Customers.LocationTypeManager.UpdateOneLocationType(item, performCascadeOperation);
				results.Results.Add(item);
			}
			catch (System.Exception ex)
			{
