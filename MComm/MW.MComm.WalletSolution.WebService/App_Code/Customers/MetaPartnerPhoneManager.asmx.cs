...
namespace MW.MComm.WalletSolution.WebService.Customers
{
	...
	public class MetaPartnerPhoneManager : System.Web.Services.WebService
	{
		...
		/// <param name="performCascadeOperation">Flag, indicating if a cascade delete should be performed on the MetaPartnerPhone item.</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Customers.MetaPartnerPhoneResults DeleteOneMetaPartnerPhone(BLL.Customers.MetaPartnerPhone item, bool performCascadeOperation)
		{
			Components.Customers.MetaPartnerPhoneResults results = new Components.Customers.MetaPartnerPhoneResults();
			results.StatusDescription = "Results OK";
			try
			{
				// perform main method tasks
				BLL.Customers.MetaPartnerPhoneManager.DeleteOneMetaPartnerPhone(item, performCascadeOperation);
			}
			catch (System.Exception ex)
			{
				results.StatusCode = -1;
		...
		///
		/// <param name="item">The MetaPartnerPhone to be managed.</param>
		/// <param name="performCascadeOperation">Flag, indicating if a cascade operation should be performed on the MetaPartnerPhone item.</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Customers.MetaPartnerPhoneResults UpsertOneMetaPartnerPhone(BLL.Customers.MetaPartnerPhone item, bool performCascadeOperation)
		{
			Components.Customers.MetaPartnerPhoneResults results = new Components.Customers.MetaPartnerPhoneResults();
			results.StatusDescription = "Results OK";
			try
			{
				// perform main method tasks
				BLL.Customers.MetaPartnerPhoneManager.UpsertOneMetaPartnerPhone(item, performCascadeOperation);
				results.Results.Add(item);
			}
			catch (System.Exception ex)
			{
