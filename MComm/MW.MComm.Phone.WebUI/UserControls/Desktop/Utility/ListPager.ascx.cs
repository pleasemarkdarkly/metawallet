...
namespace MW.MComm.Phone.WebUI.UserControls.Desktop.Utility
{
	...
	public partial class ListPager : Components.Desktop.BaseUserControl
	{
        ...
        {
            get { return (string)Session["listID"]; }
            set { Session["listID"] = value; }
        }
		...
		private void lnkGotoPage_Click(object sender, EventArgs e)
		{
			...
			{
				MW.MComm.Phone.WebUI.Globals.AddErrorMessage(Page,"Page Number between 1 and {0} Required.", PageCount);
				return;
			}
