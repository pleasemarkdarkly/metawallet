...
<%@ Control Language="c#" EnableViewState="false" AutoEventWireup="false" CodeFile ="Copyright.ascx.cs" Inherits="MW.MComm.Phone.WebUI.UserControls.Desktop.Utility.Copyright" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
	<wilson:contentregion id="Title" runat="server"><div class="subtitle">Copyright Information</div></wilson:contentregion>
	<table cellpadding="10">
		<tr>
			<td><h3>ACCEPTANCE OF TERMS.</h3>
			The services that Meta Wallet provides to you are subject to the following 
			Terms of Use. Meta Wallet reserves the right to update the Terms of Use at any time 
			without notice to you. 
			</td>
		</tr>
		<tr>
			<td><h3>DESCRIPTION OF SERVICES.</h3>
			Through its network of Web properties, Meta Wallet provides you with access to 
			...
			new Web properties, are subject to the Terms of Use.
			</td>
		</tr>
		<tr>
			<td><div class="subtitle">NO UNLAWFUL OR PROHIBITED USE.</div>
			...
			overburden, or impair any Meta Wallet server, or the network(s) connected to any 
			Meta Wallet server, or interfere with any other party's use and enjoyment of any 
			Services. You may not attempt to gain unauthorized access to any Services, other 
			accounts, computer systems or networks connected to any Meta Wallet server or to 
...
<ul><li>
<p>Use the Communication Services in connection with surveys, contests, pyramid 
schemes, chain letters, junk email, spamming or any duplicative or unsolicited 
messages (commercial or otherwise).</p></li>
<li>
<p>Defame, abuse, harass, stalk, threaten or otherwise violate the legal rights 
(such as rights of privacy and publicity) of others.</p></li>
<li>
<p>Publish, post, upload, distribute or disseminate any inappropriate, profane, 
defamatory, obscene, indecent or unlawful topic, name, material or 
information.</p></li>
<li>
<p>Upload, or otherwise make available, files that contain images, photographs, 
...
have received all necessary consent to do the same.</p></li>
<li>
<p>Use any material or information, including images or photographs, which are 
...
party.</p></li>
<li>
<p>Upload files that contain viruses, Trojan horses, worms, time bombs, 
cancelbots, corrupted files, or any other similar software or programs that may 
damage the operation of another's computer or property of another.</p></li>
<li>
<p>Advertise or offer to sell or buy any goods or services for any business 
purpose, unless such Communication Services specifically allows such 
messages.</p></li>
<li>
<p>Download any file posted by another user of a Communication Service that you 
know, or reasonably should know, cannot be legally reproduced, displayed, 
performed, and/or distributed in such manner.</p></li>
<li>
<p>Falsify or delete any copyright management information, such as author 
...
that is uploaded.</p></li>
<li>
<p>Restrict or inhibit any other user from using and enjoying the Communication 
Services.</p></li>
<li>
<p>Violate any code of conduct or other guidelines which may be applicable for 
any particular Communication Service.</p></li>
<li>
<p>Harvest or otherwise collect information about others, including e-mail 
addresses.</p></li>
<li>
<p>Violate any applicable laws or regulations.</p></li>
<li>
<p>Create a false identity for the purpose of misleading others.</p></li>
</ul>

<p>Use, download or otherwise copy, or provide (whether or not for a fee) to a 
person or entity any directory of users of the Services or other user or usage 
information or any portion thereof.</p>
<p>Meta Wallet has no obligation to monitor the Communication Services. However, 
Meta Wallet reserves the right to review materials posted to the Communication 
Services and to remove any materials in its sole discretion. Meta Wallet reserves 
...
<p>Meta Wallet reserves the right at all times to disclose any information as 
Meta Wallet deems necessary to satisfy any applicable law, regulation, legal 
process or governmental request, or to edit, refuse to post or to remove any 
information or materials, in whole or in part, in Meta Wallet's sole 
discretion.</p>
<p>Always use caution when giving out any personally identifiable information 
about yourself or your children in any Communication Services. Meta Wallet does 
not control or endorse the content, messages or information found in any 
Communication Services and, therefore, Meta Wallet specifically disclaims any 
...
not authorized Meta Wallet spokespersons, and their views do not necessarily 
reflect those of Meta Wallet.</p>
...
adhering to such limitations if you download the materials.</p>
		...
		<tr>
			<td><h3>MATERIALS PROVIDED TO Meta Wallet OR POSTED AT ANY Meta Wallet WEB SITE.</h3>
			Meta Wallet does not claim ownership of the materials you provide to Meta Wallet 
			...
			providing or submitting ("Posting") your Submission you are granting Meta Wallet, 
			...
			(including, without limitation, all Meta Wallet Services), including, without 
			...
			provided herein. Meta Wallet is under no obligation to post or use any Submission 
			you may provide and Meta Wallet may remove any Submission at any time in its sole 
			discretion.</p>
		...
		<tr>
			<td><h3>NOTICES AND PROCEDURE FOR MAKING CLAIMS OF COPYRIGHT INFRINGEMENT.</h3>
		...
		<tr>
			<td><h3>UNSOLICITED IDEA SUBMISSION POLICY.</h3>
			Meta Wallet OR ANY OF ITS EMPLOYEES DO NOT ACCEPT OR CONSIDER UNSOLICITED 
			IDEAS, INCLUDING IDEAS FOR NEW ADVERTISING CAMPAIGNS, NEW PROMOTIONS, NEW 
			PRODUCTS OR TECHNOLOGIES, PROCESSES, MATERIALS, MARKETING PLANS OR NEW PRODUCT 
			NAMES. PLEASE DO NOT SEND ANY ORIGINAL CREATIVE ARTWORK, SAMPLES, DEMOS, OR 
			OTHER WORKS. THE SOLE PURPOSE OF THIS POLICY IS TO AVOID POTENTIAL 
			MISUNDERSTANDINGS OR DISPUTES WHEN Meta Wallet' PRODUCTS OR MARKETING STRATEGIES 
			MIGHT SEEM SIMILAR TO IDEAS SUBMITTED TO Meta Wallet. SO, PLEASE DO NOT SEND YOUR 
			UNSOLICITED IDEAS TO Meta Wallet OR ANYONE AT Meta Wallet. IF, DESPITE OUR REQUEST 
			THAT YOU NOT SEND US YOUR IDEAS AND MATERIALS, YOU STILL SEND THEM, PLEASE 
			UNDERSTAND THAT Meta Wallet MAKES NO ASSURANCES THAT YOUR IDEAS AND MATERIALS WILL 
			BE TREATED AS CONFIDENTIAL OR PROPRIETARY.</td>
		</tr>
	</table>