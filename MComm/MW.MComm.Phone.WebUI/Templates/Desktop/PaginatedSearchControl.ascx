<%@ Control Language="c#" EnableViewState="false" Inherits="MW.MComm.Phone.WebUI.Templates.Desktop.PaginatedSearchControl" CodeFile="PaginatedSearchControl.ascx.cs" %>
