...
namespace MW.MComm.WalletSolution.BLL.Users
{
	...
	// ------------------------------------------------------------------------------
	[Serializable()]
	[DataTransform(Name = "MW.MComm.WalletSolution.DAL.Users.UserRoleUser")]
	public partial class UserRoleUser : PersistedBusinessObject
	{
		#region Constants
		#endregion Constants
		#region Fields
		...
		protected BLL.Users.UserRole _userRoleItem = null;
		// for User property
		...
		public virtual int UserRoleCode
		{
			...
			set
			{
				if (_userRoleCode != value)
				{
					...
					_userRoleItem = null;
					// reset UserRoleItem
					BLL.PersistedBusinessObject vUserRoleItem = (BLL.PersistedBusinessObject) UserRoleItem;
					vUserRoleItem = null;
					_userRole = null;
					// reset UserRole
		...
		public virtual Guid UserID
		{
			...
			set
			{
				if (_userID != value)
				{
					...
					_user = null;
					// reset User
					BLL.PersistedBusinessObject vUser = (BLL.PersistedBusinessObject) User;
					vUser = null;
					_isDirty = true;
				}
			}
		...
		[XmlIgnore]
		[DataTransform]
		public virtual BLL.Users.UserRole UserRoleItem
		{
			get
			{
				if (_userRoleItem == null  && IsLazyLoadable == true)
				{
					_userRoleItem = BLL.Users.UserRoleManager.GetOneUserRole((int)UserRoleCode);
					// refresh derived properties
					if (_userRoleItem != null)
					{
						_userRoleName = _userRoleItem.UserRoleName;
					}
					else
					{
		...
		public virtual BLL.Users.User User
		{
			get
			{
				if (_user == null  && IsLazyLoadable == true)
				{
					...
					{
						_userName = MOD.Data.DefaultValue.String;
		...
		{
			BLL.Users.UserRoleUser businessObject = null;
		...
		public override void ClearDirtyState(bool clearCollectionDirtyState)
		{
			...
			if (this._userRoleItem != null)
			{
				this.UserRoleItem.ClearDirtyState(clearCollectionDirtyState);
			}
			if (this._user != null)
			{
