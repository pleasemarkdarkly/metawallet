...
namespace MW.MComm.WalletSolution.BLL.Core
{
	...
	// ------------------------------------------------------------------------------
	[Serializable()]
	[DataTransform(Name = "MW.MComm.WalletSolution.DAL.Core.SeverityLevel")]
	public partial class SeverityLevel : PersistedBusinessObject
	{
		#region Constants
		#endregion Constants
		#region Fields
		...
		{
			BLL.Core.SeverityLevel businessObject = null;
