...
namespace MW.MComm.WalletSolution.DAL.Events
{
	...
	public partial class EventFee : Utility.BaseDataAccessObject
	{
		...
		// ------------------------------------------------------------------
		public static void AddOneEventFee(EventFee item, bool performCascadeOperation, MOD.Data.DatabaseOptions dbOptions, int debugLevel)
		{
			...
			try
			{
				...
				AddOneEventFee(item, performCascadeOperation, dbAdapter);
			...
			catch (System.Exception ex)
			{
				...
				throw Utility.CustomAppException.WrapException(ex, "DAL.Events.AddOneEventFee");
			}
			finally
			{
		...
		/// <exception cref="System.Exception">Thrown when prior exceptions are thrown</exception>
		// ------------------------------------------------------------------
		public static void AddOneEventFee(EventFee item, bool performCascadeOperation, MOD.Data.SqlProcAdapter dbAdapter)
		{
			try
			{
				// perform main method tasks
				MOD.Data.NamedObjectCollection spParameters = new MOD.Data.NamedObjectCollection();
				dbAdapter.ExecuteProcNQ("spEvents_AddOneEventFee", item, spParameters);
		...
		/// <exception cref="System.Exception">Thrown when prior exceptions are thrown</exception>
		// ------------------------------------------------------------------
		public static void DeleteAllEventFeeDataByEventCode(int eventCode, MOD.Data.DatabaseOptions dbOptions, int debugLevel)
		{
			Utility.SqlManager dbManager = null;
			MOD.Data.SqlProcAdapter dbAdapter = null;
			try
			{
				...
				dbAdapter.Transaction = dbAdapter.Connection.BeginTransaction();
				// perform main method tasks
				DeleteAllEventFeeDataByEventCode(eventCode, dbAdapter);
				// commit the transaction
				dbAdapter.Transaction.Commit();
			}
			catch (System.Exception ex)
			{
				...
				throw Utility.CustomAppException.WrapException(ex, "DAL.Events.DeleteAllEventFeeDataByEventCode");
			}
			finally
			{
				dbManager.ClearAdapter();
		...
		/// <exception cref="System.Exception">Thrown when prior exceptions are thrown</exception>
		// ------------------------------------------------------------------
		public static void DeleteAllEventFeeDataByEventCode(int eventCode, MOD.Data.SqlProcAdapter dbAdapter)
		{
			try
			{
				// perform main method tasks
				...
				dbAdapter.ExecuteProcNQ("spEvents_DeleteAllEventFeeDataByEventCode", null, spParameters);
				// perform sql output error handling and get output parameters
				Globals.CheckThrowSqlError(spParameters);
			}
			catch (System.Exception ex)
		...
		/// <exception cref="System.Exception">Thrown when prior exceptions are thrown</exception>
		// ------------------------------------------------------------------
		public static void DeleteAllEventFeeDataByFeeCode(int feeCode, MOD.Data.DatabaseOptions dbOptions, int debugLevel)
		{
			Utility.SqlManager dbManager = null;
			MOD.Data.SqlProcAdapter dbAdapter = null;
			try
			{
				...
				dbAdapter.Transaction = dbAdapter.Connection.BeginTransaction();
				// perform main method tasks
				DeleteAllEventFeeDataByFeeCode(feeCode, dbAdapter);
				// commit the transaction
				dbAdapter.Transaction.Commit();
			}
			catch (System.Exception ex)
			{
				...
				throw Utility.CustomAppException.WrapException(ex, "DAL.Events.DeleteAllEventFeeDataByFeeCode");
			}
			finally
			{
				dbManager.ClearAdapter();
		...
		/// <exception cref="System.Exception">Thrown when prior exceptions are thrown</exception>
		// ------------------------------------------------------------------
		public static void DeleteAllEventFeeDataByFeeCode(int feeCode, MOD.Data.SqlProcAdapter dbAdapter)
		{
			try
			{
				// perform main method tasks
				...
				dbAdapter.ExecuteProcNQ("spEvents_DeleteAllEventFeeDataByFeeCode", null, spParameters);
				// perform sql output error handling and get output parameters
				Globals.CheckThrowSqlError(spParameters);
			}
			catch (System.Exception ex)
		...
		/// <exception cref="System.Exception">Thrown when prior exceptions are thrown</exception>
		// ------------------------------------------------------------------
		public static void DeleteOneEventFee(EventFee item, bool performCascadeOperation, MOD.Data.DatabaseOptions dbOptions, int debugLevel)
		{
			Utility.SqlManager dbManager = null;
			MOD.Data.SqlProcAdapter dbAdapter = null;
			try
			{
				...
				dbAdapter.Transaction = dbAdapter.Connection.BeginTransaction();
				// perform main method tasks
				DeleteOneEventFee(item, performCascadeOperation, dbAdapter);
				// commit the transaction
				dbAdapter.Transaction.Commit();
			}
			catch (System.Exception ex)
			{
				...
				throw Utility.CustomAppException.WrapException(ex, "DAL.Events.DeleteOneEventFee");
			}
			finally
			{
				dbManager.ClearAdapter();
		...
		/// <exception cref="System.Exception">Thrown when prior exceptions are thrown</exception>
		// ------------------------------------------------------------------
		public static void DeleteOneEventFee(EventFee item, bool performCascadeOperation, MOD.Data.SqlProcAdapter dbAdapter)
		{
			try
			{
				// perform main method tasks
				...
				#endregion Cascade Operations
				MOD.Data.NamedObjectCollection spParameters = new MOD.Data.NamedObjectCollection();
				dbAdapter.ExecuteProcNQ("spEvents_DeleteOneEventFee", item, spParameters);
				// perform sql output error handling and get output parameters
				Globals.CheckThrowSqlError(spParameters);
				#region Cascade Operations
				if (performCascadeOperation == true)
		...
		/// <exception cref="System.Exception">Thrown when prior exceptions are thrown</exception>
		// ------------------------------------------------------------------
		public static MOD.Data.SortableObjectCollection GetAllEventFeeData(MOD.Data.DatabaseOptions dbOptions, MOD.Data.DataOptions dataOptions, int debugLevel)
		{
			Utility.SqlManager dbManager = null;
			MOD.Data.SqlProcAdapter dbAdapter = null;
			try
			{
				...
				DataTable dt = dbAdapter.ExecuteProc("spEvents_GetAllEventFeeData", null, spParameters);
				// perform sql output error handling and get output parameters
				Globals.CheckThrowSqlError(spParameters);
				...
				{
					// get item
					EventFee item = (EventFee) DataTransformAttribute.Transform(row, new EventFee(), false, filterFields);
					items.Add(item);
				}
				return items;
			}
			...
			{
				throw Utility.CustomAppException.WrapException(ex, "DAL.Events.GetAllEventFeeData");
			}
			finally
			{
				dbManager.ClearAdapter();
		...
		/// <exception cref="System.Exception">Thrown when prior exceptions are thrown</exception>
		// ------------------------------------------------------------------
		public static MOD.Data.SortableObjectCollection GetAllEventFeeDataByEventCode(int eventCode, MOD.Data.DatabaseOptions dbOptions, MOD.Data.DataOptions dataOptions, int debugLevel)
		{
			Utility.SqlManager dbManager = null;
			MOD.Data.SqlProcAdapter dbAdapter = null;
			try
			{
				...
				DataTable dt = dbAdapter.ExecuteProc("spEvents_GetAllEventFeeDataByEventCode", null, spParameters);
				// perform sql output error handling and get output parameters
				Globals.CheckThrowSqlError(spParameters);
				// get output collection
				foreach(DataRow row in dt.Rows)
			...
			{
				throw Utility.CustomAppException.WrapException(ex, "DAL.Events.GetAllEventFeeDataByEventCode");
			}
			finally
			{
				dbManager.ClearAdapter();
		...
		/// <exception cref="System.Exception">Thrown when prior exceptions are thrown</exception>
		// ------------------------------------------------------------------
		public static MOD.Data.SortableObjectCollection GetAllEventFeeDataByEventCode(int eventCode, MOD.Data.SqlProcAdapter dbAdapter)
		{
			try
			{
				// perform main method tasks
				...
				{
					// get item
					EventFee item = (EventFee) DataTransformAttribute.Transform(row, new EventFee(), false);
					items.Add(item);
				}
				return items;
			}
		...
		/// <exception cref="System.Exception">Thrown when prior exceptions are thrown</exception>
		// ------------------------------------------------------------------
		public static MOD.Data.SortableObjectCollection GetAllEventFeeDataByFeeCode(int feeCode, MOD.Data.DatabaseOptions dbOptions, MOD.Data.DataOptions dataOptions, int debugLevel)
		{
			Utility.SqlManager dbManager = null;
			MOD.Data.SqlProcAdapter dbAdapter = null;
			try
			{
				...
				DataTable dt = dbAdapter.ExecuteProc("spEvents_GetAllEventFeeDataByFeeCode", null, spParameters);
				// perform sql output error handling and get output parameters
				Globals.CheckThrowSqlError(spParameters);
				// get output collection
				foreach(DataRow row in dt.Rows)
			...
			{
				throw Utility.CustomAppException.WrapException(ex, "DAL.Events.GetAllEventFeeDataByFeeCode");
			}
			finally
			{
				dbManager.ClearAdapter();
		...
		/// <exception cref="System.Exception">Thrown when prior exceptions are thrown</exception>
		// ------------------------------------------------------------------
		public static MOD.Data.SortableObjectCollection GetAllEventFeeDataByFeeCode(int feeCode, MOD.Data.SqlProcAdapter dbAdapter)
		{
			try
			{
				// perform main method tasks
		...
		/// <exception cref="System.Exception">Thrown when prior exceptions are thrown</exception>
		// ------------------------------------------------------------------
		public static EventFee GetOneEventFee(int eventCode, int feeCode, MOD.Data.DatabaseOptions dbOptions, MOD.Data.DataOptions dataOptions, int debugLevel)
		{
			Utility.SqlManager dbManager = null;
			MOD.Data.SqlProcAdapter dbAdapter = null;
			try
			{
				...
				DataTable dt = dbAdapter.ExecuteProc("spEvents_GetOneEventFee", null, spParameters);
				// perform sql output error handling and get output parameters
				Globals.CheckThrowSqlError(spParameters);
				item = null;
				// get output item
				...
				{
					// get item
					item = (EventFee) DataTransformAttribute.Transform(row, new EventFee(), false, filterFields);
					break;
				}
				return item;
			}
			...
			{
				throw Utility.CustomAppException.WrapException(ex, "DAL.Events.GetOneEventFee");
			}
			finally
			{
				dbManager.ClearAdapter();
		...
		/// <exception cref="System.Exception">Thrown when prior exceptions are thrown</exception>
		// ------------------------------------------------------------------
		public static void UpdateOneEventFee(EventFee item, bool performCascadeOperation, MOD.Data.DatabaseOptions dbOptions, int debugLevel)
		{
			Utility.SqlManager dbManager = null;
			MOD.Data.SqlProcAdapter dbAdapter = null;
			try
			{
				...
				dbAdapter.Transaction = dbAdapter.Connection.BeginTransaction();
				// perform main method tasks
				UpdateOneEventFee(item, performCascadeOperation, dbAdapter);
				// commit the transaction
				dbAdapter.Transaction.Commit();
			}
			catch (System.Exception ex)
			{
				...
				throw Utility.CustomAppException.WrapException(ex, "DAL.Events.UpdateOneEventFee");
			}
			finally
			{
				dbManager.ClearAdapter();
		...
		/// <exception cref="System.Exception">Thrown when prior exceptions are thrown</exception>
		// ------------------------------------------------------------------
		public static void UpdateOneEventFee(EventFee item, bool performCascadeOperation, MOD.Data.SqlProcAdapter dbAdapter)
		{
			try
			{
				// perform main method tasks
				MOD.Data.NamedObjectCollection spParameters = new MOD.Data.NamedObjectCollection();
				dbAdapter.ExecuteProcNQ("spEvents_UpdateOneEventFee", item, spParameters);
				// perform sql output error handling and get output parameters
				Globals.CheckThrowSqlError(spParameters);
				item.Timestamp = ((System.Byte[])(spParameters["Timestamp"]));
				#region Cascade Operations
