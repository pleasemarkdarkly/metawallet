...
namespace MW.MComm.WalletSolution.DAL.Notifications
{
	...
	public partial class NotificationAttributeValueLog : Utility.BaseDataAccessObject
	{
		...
		// ------------------------------------------------------------------
		public static MOD.Data.SortableObjectCollection GetAllNotificationAttributeValueLogData(MOD.Data.DatabaseOptions dbOptions, MOD.Data.DataOptions dataOptions, int debugLevel)
		{
			...
			try
			{
				...
				DataTable dt = dbAdapter.ExecuteProc("spNotifications_GetAllNotificationAttributeValueLogData", null, spParameters);
				...
				{
					// get item
					NotificationAttributeValueLog item = (NotificationAttributeValueLog) DataTransformAttribute.Transform(row, new NotificationAttributeValueLog(), false, filterFields);
					items.Add(item);
				}
				return items;
			}
			...
			{
				throw Utility.CustomAppException.WrapException(ex, "DAL.Notifications.GetAllNotificationAttributeValueLogData");
			}
			finally
			{
		...
		/// <exception cref="System.Exception">Thrown when prior exceptions are thrown</exception>
		// ------------------------------------------------------------------
		public static MOD.Data.SortableObjectCollection GetAllNotificationAttributeValueLogDataByBaseAttributeValueID(Guid baseAttributeValueID, MOD.Data.DatabaseOptions dbOptions, MOD.Data.DataOptions dataOptions, int debugLevel)
		{
			Utility.SqlManager dbManager = null;
			MOD.Data.SqlProcAdapter dbAdapter = null;
			try
			{
				...
				MOD.Data.NamedObjectCollection filterFields = new MOD.Data.NamedObjectCollection();
				MOD.Data.SortableObjectCollection items = new MOD.Data.SortableObjectCollection();
				spParameters["BaseAttributeValueID"] = baseAttributeValueID;
				if(dataOptions != null)
				{
					spParameters["IncludeInactive"] = dataOptions.IncludeInactive;
					spParameters["IncludeDateInactive"] = dataOptions.IncludeDateInactive;
				...
				DataTable dt = dbAdapter.ExecuteProc("spNotifications_GetAllNotificationAttributeValueLogDataByBaseAttributeValueID", null, spParameters);
				// perform sql output error handling and get output parameters
				Globals.CheckThrowSqlError(spParameters);
				// get output collection
				foreach(DataRow row in dt.Rows)
			...
			{
				throw Utility.CustomAppException.WrapException(ex, "DAL.Notifications.GetAllNotificationAttributeValueLogDataByBaseAttributeValueID");
			}
			finally
			{
				dbManager.ClearAdapter();
		...
		/// <exception cref="System.Exception">Thrown when prior exceptions are thrown</exception>
		// ------------------------------------------------------------------
		public static MOD.Data.SortableObjectCollection GetAllNotificationAttributeValueLogDataByBaseAttributeValueID(Guid baseAttributeValueID, MOD.Data.SqlProcAdapter dbAdapter)
		{
			try
			{
				// perform main method tasks
				...
				{
					// get item
					NotificationAttributeValueLog item = (NotificationAttributeValueLog) DataTransformAttribute.Transform(row, new NotificationAttributeValueLog(), false);
					items.Add(item);
				}
				return items;
			}
		...
		/// <exception cref="System.Exception">Thrown when prior exceptions are thrown</exception>
		// ------------------------------------------------------------------
		public static MOD.Data.SortableObjectCollection GetAllNotificationAttributeValueLogDataByCriteria(string attributeValue, DateTime? lastModifiedDateStart, DateTime? lastModifiedDateEnd, MOD.Data.DatabaseOptions dbOptions, MOD.Data.DataOptions dataOptions, int debugLevel)
		{
			Utility.SqlManager dbManager = null;
			MOD.Data.SqlProcAdapter dbAdapter = null;
			try
			{
				...
				DataTable dt = dbAdapter.ExecuteProc("spNotifications_GetAllNotificationAttributeValueLogDataByCriteria", null, spParameters);
				// perform sql output error handling and get output parameters
				Globals.CheckThrowSqlError(spParameters);
				// get output collection
				foreach(DataRow row in dt.Rows)
			...
			{
				throw Utility.CustomAppException.WrapException(ex, "DAL.Notifications.GetAllNotificationAttributeValueLogDataByCriteria");
			}
			finally
			{
				dbManager.ClearAdapter();
		...
		/// <exception cref="System.Exception">Thrown when prior exceptions are thrown</exception>
		// ------------------------------------------------------------------
		public static MOD.Data.SortableObjectCollection GetAllNotificationAttributeValueLogDataByNotificationLogID(Guid notificationLogID, MOD.Data.DatabaseOptions dbOptions, MOD.Data.DataOptions dataOptions, int debugLevel)
		{
			Utility.SqlManager dbManager = null;
			MOD.Data.SqlProcAdapter dbAdapter = null;
			try
			{
				...
				DataTable dt = dbAdapter.ExecuteProc("spNotifications_GetAllNotificationAttributeValueLogDataByNotificationLogID", null, spParameters);
				// perform sql output error handling and get output parameters
				Globals.CheckThrowSqlError(spParameters);
				// get output collection
				foreach(DataRow row in dt.Rows)
			...
			{
				throw Utility.CustomAppException.WrapException(ex, "DAL.Notifications.GetAllNotificationAttributeValueLogDataByNotificationLogID");
			}
			finally
			{
				dbManager.ClearAdapter();
		...
		/// <exception cref="System.Exception">Thrown when prior exceptions are thrown</exception>
		// ------------------------------------------------------------------
		public static MOD.Data.SortableObjectCollection GetAllNotificationAttributeValueLogDataByNotificationLogID(Guid notificationLogID, MOD.Data.SqlProcAdapter dbAdapter)
		{
			try
			{
				// perform main method tasks
		...
		// ------------------------------------------------------------------
		/// <summary>This method gets many NotificationAttributeValueLog data by criteria.</summary>
		///
		/// <param name="attributeValue">A key for NotificationAttributeValueLog items to be fetched</param>
		/// <param name="lastModifiedDateStart">A key for NotificationAttributeValueLog items to be fetched</param>
		/// <param name="lastModifiedDateEnd">A key for NotificationAttributeValueLog items to be fetched</param>
		...
		public static MOD.Data.SortableObjectCollection GetManyNotificationAttributeValueLogDataByCriteria(string attributeValue, DateTime? lastModifiedDateStart, DateTime? lastModifiedDateEnd, out int totalRecords, out bool maximumListSizeExceeded, MOD.Data.DatabaseOptions dbOptions, MOD.Data.DataOptions dataOptions, int debugLevel)
		{
			...
			try
			{
				...
				DataTable dt = dbAdapter.ExecuteProc("spNotifications_GetManyNotificationAttributeValueLogDataByCriteria", null, spParameters);
				// perform sql output error handling and get output parameters
				Globals.CheckThrowSqlError(spParameters);
			...
			{
				throw Utility.CustomAppException.WrapException(ex, "DAL.Notifications.GetManyNotificationAttributeValueLogDataByCriteria");
			}
			finally
			{
				dbManager.ClearAdapter();
		...
		///
		/// <param name="notificationAttributeValueLogID">A key for NotificationAttributeValueLog items to be fetched</param>
		/// <param name="dbOptions">Database connection information</param>
		/// <param name="dataOptions">Data retrieval options</param>
		/// <param name="debugLevel">Debug level on error</param>
		/// <exception cref="CustomAppException">Thrown when an error is encountered in SQL</exception>
		...
		/// <exception cref="System.Exception">Thrown when prior exceptions are thrown</exception>
		// ------------------------------------------------------------------
		public static NotificationAttributeValueLog GetOneNotificationAttributeValueLog(Guid notificationAttributeValueLogID, MOD.Data.DatabaseOptions dbOptions, MOD.Data.DataOptions dataOptions, int debugLevel)
		{
			Utility.SqlManager dbManager = null;
			MOD.Data.SqlProcAdapter dbAdapter = null;
			try
			{
				...
				MOD.Data.NamedObjectCollection spParameters = new MOD.Data.NamedObjectCollection();
				MOD.Data.NamedObjectCollection filterFields = new MOD.Data.NamedObjectCollection();
				NotificationAttributeValueLog item = new NotificationAttributeValueLog();
				spParameters["NotificationAttributeValueLogID"] = notificationAttributeValueLogID;
				if(dataOptions != null)
				{
					dataOptions.PopulateNamedObjectCollection( spParameters );
					filterFields = dataOptions.FilterFields;
				}
				DataTable dt = dbAdapter.ExecuteProc("spNotifications_GetOneNotificationAttributeValueLog", null, spParameters);
				// perform sql output error handling and get output parameters
				Globals.CheckThrowSqlError(spParameters);
				item = null;
				// get output item
				...
				{
					// get item
					item = (NotificationAttributeValueLog) DataTransformAttribute.Transform(row, new NotificationAttributeValueLog(), false, filterFields);
					break;
				}
				return item;
			}
			...
			{
				throw Utility.CustomAppException.WrapException(ex, "DAL.Notifications.GetOneNotificationAttributeValueLog");
			}
			finally
			{
				dbManager.ClearAdapter();
		...
		/// <exception cref="System.Exception">Thrown when prior exceptions are thrown</exception>
		// ------------------------------------------------------------------
		public static void LogOneNotificationAttributeValueLog(NotificationAttributeValueLog item, bool performCascadeOperation, MOD.Data.DatabaseOptions dbOptions, int debugLevel)
		{
			Utility.SqlManager dbManager = null;
			MOD.Data.SqlProcAdapter dbAdapter = null;
			try
			{
				...
				// perform main method tasks
				LogOneNotificationAttributeValueLog(item, performCascadeOperation, dbAdapter);
			...
			catch (System.Exception ex)
			{
				...
				throw Utility.CustomAppException.WrapException(ex, "DAL.Notifications.LogOneNotificationAttributeValueLog");
			}
			finally
			{
				dbManager.ClearAdapter();
		...
		/// <exception cref="System.Exception">Thrown when prior exceptions are thrown</exception>
		// ------------------------------------------------------------------
		public static void LogOneNotificationAttributeValueLog(NotificationAttributeValueLog item, bool performCascadeOperation, MOD.Data.SqlProcAdapter dbAdapter)
		{
			try
			{
				// perform main method tasks
				MOD.Data.NamedObjectCollection spParameters = new MOD.Data.NamedObjectCollection();
				dbAdapter.ExecuteProcNQ("spNotifications_LogOneNotificationAttributeValueLog", item, spParameters);
				// perform sql output error handling and get output parameters
				Globals.CheckThrowSqlError(spParameters);
				item.NotificationAttributeValueLogID = MOD.Data.DataHelper.GetGuid(spParameters["NotificationAttributeValueLogID"], MOD.Data.DefaultValue.Guid);
