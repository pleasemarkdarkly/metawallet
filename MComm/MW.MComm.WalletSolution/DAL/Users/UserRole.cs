...
namespace MW.MComm.WalletSolution.DAL.Users
{
	...
	public partial class UserRole : Utility.BaseDataAccessObject
	{
		...
		protected MOD.Data.SortableObjectCollection _userRoleActivityList = null;
		#endregion Fields
		#region Properties
		// ------------------------------------------------------------------------------
		...
		// ------------------------------------------------------------------------------
		[XmlArrayItem(typeof(DAL.Users.UserRoleActivity), ElementName="UserRoleActivity")]
		[DataTransform]
		public virtual MOD.Data.SortableObjectCollection UserRoleActivityList
		{
			get
			{
		...
		public static void AddOneUserRole(UserRole item, bool performCascadeOperation, MOD.Data.SqlProcAdapter dbAdapter)
		{
			try
			{
				...
				{
					// cascade operations
					#region UserRoleActivityList
					if (item.UserRoleActivityList != null)
					{
						foreach(DAL.Users.UserRoleActivity loopUserRoleActivity in item.UserRoleActivityList)
						{
							loopUserRoleActivity.UserRoleCode = item.UserRoleCode;
							// add new item
							DAL.Users.UserRoleActivity.AddOneUserRoleActivity(loopUserRoleActivity, performCascadeOperation, dbAdapter);
						}
					}
					#endregion UserRoleActivityList
				}
		...
		public static void DeleteOneUserRole(UserRole item, bool performCascadeOperation, MOD.Data.SqlProcAdapter dbAdapter)
		{
			try
			{
				...
				if (performCascadeOperation == true)
				{
					...
					if (item.UserRoleActivityList != null)
					{
						DAL.Users.UserRoleActivity.DeleteAllUserRoleActivityDataByUserRoleCode(item.UserRoleCode, dbAdapter);
					}
				}
				#endregion Cascade Operations
				MOD.Data.NamedObjectCollection spParameters = new MOD.Data.NamedObjectCollection();
		...
		public static void UpdateOneUserRole(UserRole item, bool performCascadeOperation, MOD.Data.SqlProcAdapter dbAdapter)
		{
			try
			{
				...
				if (performCascadeOperation == true)
				{
					...
					if (item.UserRoleActivityList != null)
					{
						MOD.Data.SortableObjectCollection userRoleActivityList = DAL.Users.UserRoleActivity.GetAllUserRoleActivityDataByUserRoleCode(item.UserRoleCode, dbAdapter);
						// process updates and adds
						foreach(DAL.Users.UserRoleActivity loopUserRoleActivity in item.UserRoleActivityList)
						{
							if (userRoleActivityList.Contains(loopUserRoleActivity))
							{
								// update item
								loopUserRoleActivity.LastModifiedByUserID = item.LastModifiedByUserID;
								DAL.Users.UserRoleActivity.UpdateOneUserRoleActivity(loopUserRoleActivity, false, dbAdapter);
							}
							else
							{
								// add item
								loopUserRoleActivity.CreatedByUserID = item.CreatedByUserID;
								loopUserRoleActivity.LastModifiedByUserID = item.LastModifiedByUserID;
								loopUserRoleActivity.UserRoleCode = item.UserRoleCode;
								DAL.Users.UserRoleActivity.AddOneUserRoleActivity(loopUserRoleActivity, false, dbAdapter);
							}
						}
						// process deletions
						foreach(DAL.Users.UserRoleActivity loopUserRoleActivity in userRoleActivityList)
						{
							if (!item.UserRoleActivityList.Contains(loopUserRoleActivity))
							{
								DAL.Users.UserRoleActivity.DeleteOneUserRoleActivity(loopUserRoleActivity, false, dbAdapter);
							}
						}
					}
					#endregion UserRoleActivityList
