...
namespace MW.MComm.WalletSolution.DAL.Payments
{
	...
	public partial class PaymentTransactionAttributeValueLog : Utility.BaseDataAccessObject
	{
		...
		protected DAL.Payments.PaymentTransactionLog _paymentTransactionLog = null;
		#endregion Fields
		#region Properties
		// ------------------------------------------------------------------------------
		...
		[XmlIgnore]
		[DataTransform]
		public virtual DAL.Payments.PaymentTransactionLog PaymentTransactionLog
		{
			get
			{
		...
		// ------------------------------------------------------------------
		public static MOD.Data.SortableObjectCollection GetAllPaymentTransactionAttributeValueLogData(MOD.Data.DatabaseOptions dbOptions, MOD.Data.DataOptions dataOptions, int debugLevel)
		{
			...
			try
			{
				...
				DataTable dt = dbAdapter.ExecuteProc("spPayments_GetAllPaymentTransactionAttributeValueLogData", null, spParameters);
				...
				{
					// get item
					PaymentTransactionAttributeValueLog item = (PaymentTransactionAttributeValueLog) DataTransformAttribute.Transform(row, new PaymentTransactionAttributeValueLog(), false, filterFields);
					items.Add(item);
				}
				return items;
			}
			...
			{
				throw Utility.CustomAppException.WrapException(ex, "DAL.Payments.GetAllPaymentTransactionAttributeValueLogData");
			}
			finally
			{
		...
		/// <exception cref="System.Exception">Thrown when prior exceptions are thrown</exception>
		// ------------------------------------------------------------------
		public static MOD.Data.SortableObjectCollection GetAllPaymentTransactionAttributeValueLogDataByBaseAttributeID(Guid baseAttributeID, MOD.Data.DatabaseOptions dbOptions, MOD.Data.DataOptions dataOptions, int debugLevel)
		{
			Utility.SqlManager dbManager = null;
			MOD.Data.SqlProcAdapter dbAdapter = null;
			try
			{
				...
				DataTable dt = dbAdapter.ExecuteProc("spPayments_GetAllPaymentTransactionAttributeValueLogDataByBaseAttributeID", null, spParameters);
				// perform sql output error handling and get output parameters
				Globals.CheckThrowSqlError(spParameters);
				// get output collection
				foreach(DataRow row in dt.Rows)
			...
			{
				throw Utility.CustomAppException.WrapException(ex, "DAL.Payments.GetAllPaymentTransactionAttributeValueLogDataByBaseAttributeID");
			}
			finally
			{
				dbManager.ClearAdapter();
		...
		/// <exception cref="System.Exception">Thrown when prior exceptions are thrown</exception>
		// ------------------------------------------------------------------
		public static MOD.Data.SortableObjectCollection GetAllPaymentTransactionAttributeValueLogDataByBaseAttributeID(Guid baseAttributeID, MOD.Data.SqlProcAdapter dbAdapter)
		{
			try
			{
				// perform main method tasks
				...
				{
					// get item
					PaymentTransactionAttributeValueLog item = (PaymentTransactionAttributeValueLog) DataTransformAttribute.Transform(row, new PaymentTransactionAttributeValueLog(), false);
					items.Add(item);
				}
				return items;
			}
		...
		/// <exception cref="System.Exception">Thrown when prior exceptions are thrown</exception>
		// ------------------------------------------------------------------
		public static MOD.Data.SortableObjectCollection GetAllPaymentTransactionAttributeValueLogDataByCriteria(string attributeValue, DateTime? lastModifiedDateStart, DateTime? lastModifiedDateEnd, MOD.Data.DatabaseOptions dbOptions, MOD.Data.DataOptions dataOptions, int debugLevel)
		{
			Utility.SqlManager dbManager = null;
			MOD.Data.SqlProcAdapter dbAdapter = null;
			try
			{
				...
				DataTable dt = dbAdapter.ExecuteProc("spPayments_GetAllPaymentTransactionAttributeValueLogDataByCriteria", null, spParameters);
				// perform sql output error handling and get output parameters
				Globals.CheckThrowSqlError(spParameters);
				// get output collection
				foreach(DataRow row in dt.Rows)
			...
			{
				throw Utility.CustomAppException.WrapException(ex, "DAL.Payments.GetAllPaymentTransactionAttributeValueLogDataByCriteria");
			}
			finally
			{
				dbManager.ClearAdapter();
		...
		/// <exception cref="System.Exception">Thrown when prior exceptions are thrown</exception>
		// ------------------------------------------------------------------
		public static MOD.Data.SortableObjectCollection GetAllPaymentTransactionAttributeValueLogDataByPaymentTransactionLogID(Guid paymentTransactionLogID, MOD.Data.DatabaseOptions dbOptions, MOD.Data.DataOptions dataOptions, int debugLevel)
		{
			Utility.SqlManager dbManager = null;
			MOD.Data.SqlProcAdapter dbAdapter = null;
			try
			{
				...
				DataTable dt = dbAdapter.ExecuteProc("spPayments_GetAllPaymentTransactionAttributeValueLogDataByPaymentTransactionLogID", null, spParameters);
				// perform sql output error handling and get output parameters
				Globals.CheckThrowSqlError(spParameters);
				// get output collection
				foreach(DataRow row in dt.Rows)
			...
			{
				throw Utility.CustomAppException.WrapException(ex, "DAL.Payments.GetAllPaymentTransactionAttributeValueLogDataByPaymentTransactionLogID");
			}
			finally
			{
				dbManager.ClearAdapter();
		...
		/// <exception cref="System.Exception">Thrown when prior exceptions are thrown</exception>
		// ------------------------------------------------------------------
		public static MOD.Data.SortableObjectCollection GetAllPaymentTransactionAttributeValueLogDataByPaymentTransactionLogID(Guid paymentTransactionLogID, MOD.Data.SqlProcAdapter dbAdapter)
		{
			try
			{
				// perform main method tasks
		...
		// ------------------------------------------------------------------
		/// <summary>This method gets many PaymentTransactionAttributeValueLog data by criteria.</summary>
		///
		/// <param name="attributeValue">A key for PaymentTransactionAttributeValueLog items to be fetched</param>
		/// <param name="lastModifiedDateStart">A key for PaymentTransactionAttributeValueLog items to be fetched</param>
		/// <param name="lastModifiedDateEnd">A key for PaymentTransactionAttributeValueLog items to be fetched</param>
		...
		public static MOD.Data.SortableObjectCollection GetManyPaymentTransactionAttributeValueLogDataByCriteria(string attributeValue, DateTime? lastModifiedDateStart, DateTime? lastModifiedDateEnd, out int totalRecords, out bool maximumListSizeExceeded, MOD.Data.DatabaseOptions dbOptions, MOD.Data.DataOptions dataOptions, int debugLevel)
		{
			...
			try
			{
				...
				DataTable dt = dbAdapter.ExecuteProc("spPayments_GetManyPaymentTransactionAttributeValueLogDataByCriteria", null, spParameters);
				// perform sql output error handling and get output parameters
				Globals.CheckThrowSqlError(spParameters);
			...
			{
				throw Utility.CustomAppException.WrapException(ex, "DAL.Payments.GetManyPaymentTransactionAttributeValueLogDataByCriteria");
			}
			finally
			{
				dbManager.ClearAdapter();
		...
		///
		/// <param name="paymentTransactionAttributeValueLogID">A key for PaymentTransactionAttributeValueLog items to be fetched</param>
		/// <param name="dbOptions">Database connection information</param>
		/// <param name="dataOptions">Data retrieval options</param>
		/// <param name="debugLevel">Debug level on error</param>
		/// <exception cref="CustomAppException">Thrown when an error is encountered in SQL</exception>
		...
		/// <exception cref="System.Exception">Thrown when prior exceptions are thrown</exception>
		// ------------------------------------------------------------------
		public static PaymentTransactionAttributeValueLog GetOnePaymentTransactionAttributeValueLog(Guid paymentTransactionAttributeValueLogID, MOD.Data.DatabaseOptions dbOptions, MOD.Data.DataOptions dataOptions, int debugLevel)
		{
			Utility.SqlManager dbManager = null;
			MOD.Data.SqlProcAdapter dbAdapter = null;
			try
			{
				...
				MOD.Data.NamedObjectCollection spParameters = new MOD.Data.NamedObjectCollection();
				MOD.Data.NamedObjectCollection filterFields = new MOD.Data.NamedObjectCollection();
				PaymentTransactionAttributeValueLog item = new PaymentTransactionAttributeValueLog();
				spParameters["PaymentTransactionAttributeValueLogID"] = paymentTransactionAttributeValueLogID;
				if(dataOptions != null)
				{
					dataOptions.PopulateNamedObjectCollection( spParameters );
					filterFields = dataOptions.FilterFields;
				}
				DataTable dt = dbAdapter.ExecuteProc("spPayments_GetOnePaymentTransactionAttributeValueLog", null, spParameters);
				// perform sql output error handling and get output parameters
				Globals.CheckThrowSqlError(spParameters);
				item = null;
				// get output item
				...
				{
					// get item
					item = (PaymentTransactionAttributeValueLog) DataTransformAttribute.Transform(row, new PaymentTransactionAttributeValueLog(), false, filterFields);
					break;
				}
				return item;
			}
			...
			{
				throw Utility.CustomAppException.WrapException(ex, "DAL.Payments.GetOnePaymentTransactionAttributeValueLog");
			}
			finally
			{
				dbManager.ClearAdapter();
		...
		/// <exception cref="System.Exception">Thrown when prior exceptions are thrown</exception>
		// ------------------------------------------------------------------
		public static void LogOnePaymentTransactionAttributeValueLog(PaymentTransactionAttributeValueLog item, bool performCascadeOperation, MOD.Data.DatabaseOptions dbOptions, int debugLevel)
		{
			Utility.SqlManager dbManager = null;
			MOD.Data.SqlProcAdapter dbAdapter = null;
			try
			{
				...
				// perform main method tasks
				LogOnePaymentTransactionAttributeValueLog(item, performCascadeOperation, dbAdapter);
			...
			catch (System.Exception ex)
			{
				...
				throw Utility.CustomAppException.WrapException(ex, "DAL.Payments.LogOnePaymentTransactionAttributeValueLog");
			}
			finally
			{
				dbManager.ClearAdapter();
		...
		/// <exception cref="System.Exception">Thrown when prior exceptions are thrown</exception>
		// ------------------------------------------------------------------
		public static void LogOnePaymentTransactionAttributeValueLog(PaymentTransactionAttributeValueLog item, bool performCascadeOperation, MOD.Data.SqlProcAdapter dbAdapter)
		{
			try
			{
				// perform main method tasks
				MOD.Data.NamedObjectCollection spParameters = new MOD.Data.NamedObjectCollection();
				dbAdapter.ExecuteProcNQ("spPayments_LogOnePaymentTransactionAttributeValueLog", item, spParameters);
				// perform sql output error handling and get output parameters
				Globals.CheckThrowSqlError(spParameters);
				item.PaymentTransactionAttributeValueLogID = MOD.Data.DataHelper.GetGuid(spParameters["PaymentTransactionAttributeValueLogID"], MOD.Data.DefaultValue.Guid);
