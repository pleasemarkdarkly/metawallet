...
namespace MW.MComm.CarrierSim.WebService.Core
{
	...
	/// <remarks></remarks>
	// ------------------------------------------------------------------------------
	[WebService(Namespace = "http://modsystems.com/MW.MComm.CarrierSim.WebService/Core/SeverityLevelManager")]
	...
	public class SeverityLevelManager : System.Web.Services.WebService
	{
		...
		///
		/// <param name="item">The SeverityLevel to be managed.</param>
		/// <param name="performCascadeOperation">Flag, indicating if a cascade operation should be performed on the SeverityLevel item.</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Core.SeverityLevelResults AddOneSeverityLevel(BLL.Core.SeverityLevel item, bool performCascadeOperation)
		{
			...
			try
			{
				...
				BLL.Core.SeverityLevelManager.AddOneSeverityLevel(item, performCascadeOperation);
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Core.SeverityLevelResults UpdateOneSeverityLevel(BLL.Core.SeverityLevel item, bool performCascadeOperation)
		{
			Components.Core.SeverityLevelResults results = new Components.Core.SeverityLevelResults();
			results.StatusDescription = "Results OK";
			try
			{
				// perform main method tasks
				BLL.Core.SeverityLevelManager.UpdateOneSeverityLevel(item, performCascadeOperation);
				results.Results.Add(item);
			}
			catch (System.Exception ex)
			{
		...
		/// <param name="performCascadeOperation">Flag, indicating if a cascade delete should be performed on the SeverityLevel item.</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Core.SeverityLevelResults DeleteOneSeverityLevel(BLL.Core.SeverityLevel item, bool performCascadeOperation)
		{
			Components.Core.SeverityLevelResults results = new Components.Core.SeverityLevelResults();
			results.StatusDescription = "Results OK";
			try
			{
				// perform main method tasks
				BLL.Core.SeverityLevelManager.DeleteOneSeverityLevel(item, performCascadeOperation);
			}
			catch (System.Exception ex)
			{
				results.StatusCode = -1;
