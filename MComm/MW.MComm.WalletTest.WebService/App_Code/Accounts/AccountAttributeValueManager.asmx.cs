...
namespace MW.MComm.WalletTest.WebService.Accounts
{
	...
	public class AccountAttributeValueManager : System.Web.Services.WebService
	{
		...
		///
		/// <param name="accountAttributeValueID">A property of AccountAttributeValue item to be managed</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Accounts.AccountAttributeValueResults DeleteOneAccountAttributeValue(string accountAttributeValueID)
		{
			Components.Accounts.AccountAttributeValueResults results = new Components.Accounts.AccountAttributeValueResults();
			results.StatusDescription = "Results OK";
			try
			{
				...
				item.AccountAttributeValueID = MOD.Data.DataHelper.GetGuid(accountAttributeValueID, MOD.Data.DefaultValue.Guid);
				BLL.Accounts.AccountAttributeValueManager.DeleteOneAccountAttributeValue(item, false);
			}
			catch (System.Exception ex)
			{
				results.StatusCode = -1;
		...
		///
		/// <param name="accountAttributeValueID">A property of AccountAttributeValue item to be managed</param>
		/// <param name="accountID">A property of AccountAttributeValue item to be managed</param>
		/// <param name="baseAttributeID">A property of AccountAttributeValue item to be managed</param>
		/// <param name="parameterValue">A property of AccountAttributeValue item to be managed</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Accounts.AccountAttributeValueResults UpsertOneAccountAttributeValue(string accountAttributeValueID, string accountID, string baseAttributeID, string parameterValue)
		{
			Components.Accounts.AccountAttributeValueResults results = new Components.Accounts.AccountAttributeValueResults();
			results.StatusDescription = "Results OK";
			try
			{
				...
				BLL.Accounts.AccountAttributeValueManager.UpsertOneAccountAttributeValue(item, false);
				results.Results.Add(item);
			}
			catch (System.Exception ex)
			{
