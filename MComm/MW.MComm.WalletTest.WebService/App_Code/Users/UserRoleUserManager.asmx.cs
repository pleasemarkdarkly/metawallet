...
namespace MW.MComm.WalletTest.WebService.Users
{
	...
	public class UserRoleUserManager : System.Web.Services.WebService
	{
		...
		///
		/// <param name="userRoleCode">A property of UserRoleUser item to be managed</param>
		/// <param name="userID">A property of UserRoleUser item to be managed</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Users.UserRoleUserResults AddOneUserRoleUser(int userRoleCode, string userID)
		{
			...
			try
			{
				...
				BLL.Users.UserRoleUser item = new BLL.Users.UserRoleUser();
				item.UserRoleCode = userRoleCode;
				item.UserID = MOD.Data.DataHelper.GetGuid(userID, MOD.Data.DefaultValue.Guid);
				BLL.Users.UserRoleUserManager.AddOneUserRoleUser(item, false);
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Users.UserRoleUserResults DeleteOneUserRoleUser(int userRoleCode, string userID)
		{
			Components.Users.UserRoleUserResults results = new Components.Users.UserRoleUserResults();
			results.StatusDescription = "Results OK";
			try
			{
				...
				item.UserRoleCode = userRoleCode;
				item.UserID = MOD.Data.DataHelper.GetGuid(userID, MOD.Data.DefaultValue.Guid);
				BLL.Users.UserRoleUserManager.DeleteOneUserRoleUser(item, false);
			}
			catch (System.Exception ex)
			{
				results.StatusCode = -1;
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Users.UserRoleUserResults UpdateOneUserRoleUser(int userRoleCode, string userID)
		{
			Components.Users.UserRoleUserResults results = new Components.Users.UserRoleUserResults();
			results.StatusDescription = "Results OK";
			try
			{
				...
				item.UserRoleCode = userRoleCode;
				item.UserID = MOD.Data.DataHelper.GetGuid(userID, MOD.Data.DefaultValue.Guid);
				BLL.Users.UserRoleUserManager.UpdateOneUserRoleUser(item, false);
				results.Results.Add(item);
			}
			catch (System.Exception ex)
			{
