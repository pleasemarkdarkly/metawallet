...
namespace MW.MComm.WalletTest.WebService.Users
{
	...
	public class UserRoleManager : System.Web.Services.WebService
	{
		...
		///
		/// <param name="userRoleCode">A property of UserRole item to be managed</param>
		/// <param name="userRoleName">A property of UserRole item to be managed</param>
		/// <param name="description">A property of UserRole item to be managed</param>
		/// <param name="isActive">A property of UserRole item to be managed</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Users.UserRoleResults AddOneUserRole(int userRoleCode, string userRoleName, string description, bool isActive)
		{
			...
			try
			{
				...
				BLL.Users.UserRoleManager.AddOneUserRole(item, false);
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Users.UserRoleResults DeleteOneUserRole(int userRoleCode)
		{
			Components.Users.UserRoleResults results = new Components.Users.UserRoleResults();
			results.StatusDescription = "Results OK";
			try
			{
				...
				BLL.Users.UserRole item = new BLL.Users.UserRole();
				item.UserRoleCode = userRoleCode;
				BLL.Users.UserRoleManager.DeleteOneUserRole(item, false);
			}
			catch (System.Exception ex)
			{
				results.StatusCode = -1;
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Users.UserRoleResults UpdateOneUserRole(int userRoleCode, string userRoleName, string description, bool isActive)
		{
			Components.Users.UserRoleResults results = new Components.Users.UserRoleResults();
			results.StatusDescription = "Results OK";
			try
			{
				...
				item.Description = description;
				item.IsActive = isActive;
				BLL.Users.UserRoleManager.UpdateOneUserRole(item, false);
				results.Results.Add(item);
			}
			catch (System.Exception ex)
			{
