...
namespace MW.MComm.WalletTest.WebService.Users
{
	...
	public class ActivityManager : System.Web.Services.WebService
	{
		...
		///
		/// <param name="activityCode">A property of Activity item to be managed</param>
		/// <param name="activityName">A property of Activity item to be managed</param>
		/// <param name="description">A property of Activity item to be managed</param>
		/// <param name="isActive">A property of Activity item to be managed</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Users.ActivityResults AddOneActivity(int activityCode, string activityName, string description, bool isActive)
		{
			...
			try
			{
				...
				BLL.Users.Activity item = new BLL.Users.Activity();
				item.ActivityCode = activityCode;
				item.ActivityName = activityName;
				item.Description = description;
				item.IsActive = isActive;
				BLL.Users.ActivityManager.AddOneActivity(item, false);
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Users.ActivityResults DeleteOneActivity(int activityCode)
		{
			Components.Users.ActivityResults results = new Components.Users.ActivityResults();
			results.StatusDescription = "Results OK";
			try
			{
				...
				BLL.Users.Activity item = new BLL.Users.Activity();
				item.ActivityCode = activityCode;
				BLL.Users.ActivityManager.DeleteOneActivity(item, false);
			}
			catch (System.Exception ex)
			{
				results.StatusCode = -1;
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Users.ActivityResults UpdateOneActivity(int activityCode, string activityName, string description, bool isActive)
		{
			Components.Users.ActivityResults results = new Components.Users.ActivityResults();
			results.StatusDescription = "Results OK";
			try
			{
				...
				item.Description = description;
				item.IsActive = isActive;
				BLL.Users.ActivityManager.UpdateOneActivity(item, false);
				results.Results.Add(item);
			}
			catch (System.Exception ex)
			{
