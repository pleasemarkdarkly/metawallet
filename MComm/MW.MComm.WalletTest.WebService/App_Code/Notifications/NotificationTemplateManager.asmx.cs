...
namespace MW.MComm.WalletTest.WebService.Notifications
{
	...
	public class NotificationTemplateManager : System.Web.Services.WebService
	{
		...
		///
		/// <param name="notificationTemplateID">A property of NotificationTemplate item to be managed</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Notifications.NotificationTemplateResults DeleteOneNotificationTemplate(string notificationTemplateID)
		{
			Components.Notifications.NotificationTemplateResults results = new Components.Notifications.NotificationTemplateResults();
			results.StatusDescription = "Results OK";
			try
			{
				...
				item.NotificationTemplateID = MOD.Data.DataHelper.GetGuid(notificationTemplateID, MOD.Data.DefaultValue.Guid);
				BLL.Notifications.NotificationTemplateManager.DeleteOneNotificationTemplate(item, false);
			}
			catch (System.Exception ex)
			{
				results.StatusCode = -1;
		...
		///
		/// <param name="notificationTemplateID">A property of NotificationTemplate item to be managed</param>
		/// <param name="notificationCode">A property of NotificationTemplate item to be managed</param>
		/// <param name="notificationSubjectTemplate">A property of NotificationTemplate item to be managed</param>
		/// <param name="notificationMessageTemplate">A property of NotificationTemplate item to be managed</param>
		/// <param name="localeCode">A property of NotificationTemplate item to be managed</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Notifications.NotificationTemplateResults UpsertOneNotificationTemplate(string notificationTemplateID, int notificationCode, string notificationSubjectTemplate, string notificationMessageTemplate, int localeCode)
		{
			Components.Notifications.NotificationTemplateResults results = new Components.Notifications.NotificationTemplateResults();
			results.StatusDescription = "Results OK";
			try
			{
				...
				item.NotificationSubjectTemplate = notificationSubjectTemplate;
				item.NotificationMessageTemplate = notificationMessageTemplate;
				item.LocaleCode = localeCode;
				BLL.Notifications.NotificationTemplateManager.UpsertOneNotificationTemplate(item, false);
				results.Results.Add(item);
			}
			catch (System.Exception ex)
			{
