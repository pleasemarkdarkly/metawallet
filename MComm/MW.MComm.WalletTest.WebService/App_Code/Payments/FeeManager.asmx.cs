...
namespace MW.MComm.WalletTest.WebService.Payments
{
	...
	public class FeeManager : System.Web.Services.WebService
	{
		...
		///
		/// <param name="feeCode">A property of Fee item to be managed</param>
		/// <param name="feeName">A property of Fee item to be managed</param>
		/// <param name="feeText">A property of Fee item to be managed</param>
		/// <param name="feeTypeCode">A property of Fee item to be managed</param>
		/// <param name="currencyCode">A property of Fee item to be managed</param>
		/// <param name="description">A property of Fee item to be managed</param>
		/// <param name="isActive">A property of Fee item to be managed</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Payments.FeeResults AddOneFee(int feeCode, string feeName, string feeText, int feeTypeCode, int currencyCode, string description, bool isActive)
		{
			...
			try
			{
				...
				item.FeeText = feeText;
				item.FeeTypeCode = feeTypeCode;
				item.CurrencyCode = currencyCode;
				item.Description = description;
				item.IsActive = isActive;
				BLL.Payments.FeeManager.AddOneFee(item, false);
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Payments.FeeResults DeleteOneFee(int feeCode)
		{
			Components.Payments.FeeResults results = new Components.Payments.FeeResults();
			results.StatusDescription = "Results OK";
			try
			{
				...
				BLL.Payments.Fee item = new BLL.Payments.Fee();
				item.FeeCode = feeCode;
				BLL.Payments.FeeManager.DeleteOneFee(item, false);
			}
			catch (System.Exception ex)
			{
				results.StatusCode = -1;
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Payments.FeeResults UpdateOneFee(int feeCode, string feeName, string feeText, int feeTypeCode, int currencyCode, string description, bool isActive)
		{
			Components.Payments.FeeResults results = new Components.Payments.FeeResults();
			results.StatusDescription = "Results OK";
			try
			{
				...
				item.Description = description;
				item.IsActive = isActive;
				BLL.Payments.FeeManager.UpdateOneFee(item, false);
				results.Results.Add(item);
			}
			catch (System.Exception ex)
			{
