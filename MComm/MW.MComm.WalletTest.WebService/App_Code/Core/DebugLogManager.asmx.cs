...
namespace MW.MComm.WalletTest.WebService.Core
{
	...
	public class DebugLogManager : System.Web.Services.WebService
	{
		...
		///
		/// <param name="debugLogID">A property of DebugLog item to be managed</param>
		/// <param name="eventName">A property of DebugLog item to be managed</param>
		/// <param name="message">A property of DebugLog item to be managed</param>
		/// <param name="errorNumber">A property of DebugLog item to be managed</param>
		/// <param name="eventTypeCode">A property of DebugLog item to be managed</param>
		/// <param name="severityLevelCode">A property of DebugLog item to be managed</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Core.DebugLogResults LogOneDebugLog(string debugLogID, string eventName, string message, int errorNumber, int eventTypeCode, int severityLevelCode)
		{
			Components.Core.DebugLogResults results = new Components.Core.DebugLogResults();
			results.StatusDescription = "Results OK";
			try
			{
				...
				BLL.Core.DebugLogManager.LogOneDebugLog(item, false);
				results.Results.Add(item);
			}
			catch (System.Exception ex)
			{
