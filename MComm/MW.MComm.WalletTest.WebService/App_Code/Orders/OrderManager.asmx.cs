...
namespace MW.MComm.WalletTest.WebService.Orders
{
	...
	public class OrderManager : System.Web.Services.WebService
	{
		...
		///
		/// <param name="orderID">A property of Order item to be managed</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Orders.OrderResults DeleteOneOrder(string orderID)
		{
			Components.Orders.OrderResults results = new Components.Orders.OrderResults();
			results.StatusDescription = "Results OK";
			try
			{
				...
				BLL.Orders.OrderManager.DeleteOneOrder(item, false);
			}
			catch (System.Exception ex)
			{
				results.StatusCode = -1;
		...
		///
		/// <param name="orderID">A property of Order item to be managed</param>
		/// <param name="debitMetaPartnerID">A property of Order item to be managed</param>
		/// <param name="creditMetaPartnerID">A property of Order item to be managed</param>
		/// <param name="logToAccountID">A property of Order item to be managed</param>
		/// <param name="orderDescription">A property of Order item to be managed</param>
		/// <param name="orderAmount">A property of Order item to be managed</param>
		/// <param name="orderSubtotal">A property of Order item to be managed</param>
		/// <param name="orderTax">A property of Order item to be managed</param>
		/// <param name="orderServiceCharge">A property of Order item to be managed</param>
		/// <param name="currencyCode">A property of Order item to be managed</param>
		/// <param name="orderStatusCode">A property of Order item to be managed</param>
		/// <param name="orderStatusMessage">A property of Order item to be managed</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Orders.OrderResults UpsertOneOrder(string orderID, string debitMetaPartnerID, string creditMetaPartnerID, string logToAccountID, string orderDescription, decimal orderAmount, decimal orderSubtotal, decimal orderTax, decimal orderServiceCharge, int currencyCode, int orderStatusCode, string orderStatusMessage)
		{
			Components.Orders.OrderResults results = new Components.Orders.OrderResults();
			results.StatusDescription = "Results OK";
			try
			{
				...
				item.LogToAccountID = MOD.Data.DataHelper.GetGuid(logToAccountID, MOD.Data.DefaultValue.Guid);
				item.OrderDescription = orderDescription;
				item.OrderAmount = orderAmount;
				item.OrderSubtotal = orderSubtotal;
				item.OrderTax = orderTax;
				item.OrderServiceCharge = orderServiceCharge;
				item.CurrencyCode = currencyCode;
				item.OrderStatusCode = orderStatusCode;
				item.OrderStatusMessage = orderStatusMessage;
				BLL.Orders.OrderManager.UpsertOneOrder(item, false);
				results.Results.Add(item);
			}
			catch (System.Exception ex)
			{
