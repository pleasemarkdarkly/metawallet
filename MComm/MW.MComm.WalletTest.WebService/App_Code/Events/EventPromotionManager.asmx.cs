...
namespace MW.MComm.WalletTest.WebService.Events
{
	...
	public class EventPromotionManager : System.Web.Services.WebService
	{
		...
		///
		/// <param name="eventCode">A property of EventPromotion item to be managed</param>
		/// <param name="promotionCode">A property of EventPromotion item to be managed</param>
		/// <param name="rank">A property of EventPromotion item to be managed</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Events.EventPromotionResults AddOneEventPromotion(int eventCode, int promotionCode, int rank)
		{
			...
			try
			{
				...
				BLL.Events.EventPromotion item = new BLL.Events.EventPromotion();
				item.EventCode = eventCode;
				item.PromotionCode = promotionCode;
				item.Rank = rank;
				BLL.Events.EventPromotionManager.AddOneEventPromotion(item, false);
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Events.EventPromotionResults DeleteOneEventPromotion(int eventCode, int promotionCode)
		{
			Components.Events.EventPromotionResults results = new Components.Events.EventPromotionResults();
			results.StatusDescription = "Results OK";
			try
			{
				...
				item.EventCode = eventCode;
				item.PromotionCode = promotionCode;
				BLL.Events.EventPromotionManager.DeleteOneEventPromotion(item, false);
			}
			catch (System.Exception ex)
			{
				results.StatusCode = -1;
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Events.EventPromotionResults UpdateOneEventPromotion(int eventCode, int promotionCode, int rank)
		{
			Components.Events.EventPromotionResults results = new Components.Events.EventPromotionResults();
			results.StatusDescription = "Results OK";
			try
			{
				...
				item.PromotionCode = promotionCode;
				item.Rank = rank;
				BLL.Events.EventPromotionManager.UpdateOneEventPromotion(item, false);
				results.Results.Add(item);
			}
			catch (System.Exception ex)
			{
