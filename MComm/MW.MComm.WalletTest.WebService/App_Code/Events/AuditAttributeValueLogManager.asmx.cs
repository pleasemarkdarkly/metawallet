...
namespace MW.MComm.WalletTest.WebService.Events
{
	...
	public class AuditAttributeValueLogManager : System.Web.Services.WebService
	{
		...
		///
		/// <param name="auditAttributeValueLogID">A property of AuditAttributeValueLog item to be managed</param>
		/// <param name="auditLogID">A property of AuditAttributeValueLog item to be managed</param>
		/// <param name="baseAttributeID">A property of AuditAttributeValueLog item to be managed</param>
		/// <param name="attributeValue">A property of AuditAttributeValueLog item to be managed</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Events.AuditAttributeValueLogResults LogOneAuditAttributeValueLog(string auditAttributeValueLogID, string auditLogID, string baseAttributeID, string attributeValue)
		{
			...
			try
			{
				...
				item.AuditAttributeValueLogID = MOD.Data.DataHelper.GetGuid(auditAttributeValueLogID, MOD.Data.DefaultValue.Guid);
				...
				BLL.Events.AuditAttributeValueLogManager.LogOneAuditAttributeValueLog(item, false);
