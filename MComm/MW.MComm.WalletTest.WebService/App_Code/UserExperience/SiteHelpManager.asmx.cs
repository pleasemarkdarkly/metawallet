...
namespace MW.MComm.WalletTest.WebService.UserExperience
{
	...
	public class SiteHelpManager : System.Web.Services.WebService
	{
		...
		///
		/// <param name="localeCode">A property of SiteHelp item to be managed</param>
		/// <param name="siteHelpName">A property of SiteHelp item to be managed</param>
		/// <param name="siteHelpText">A property of SiteHelp item to be managed</param>
		/// <param name="siteHelpImageURL">A property of SiteHelp item to be managed</param>
		/// <param name="siteHelpGroupCode">A property of SiteHelp item to be managed</param>
		/// <param name="siteHelpDefinitionCode">A property of SiteHelp item to be managed</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.UserExperience.SiteHelpResults AddOneSiteHelp(int localeCode, string siteHelpName, string siteHelpText, string siteHelpImageURL, int siteHelpGroupCode, int siteHelpDefinitionCode)
		{
			...
			try
			{
				...
				item.SiteHelpName = siteHelpName;
				item.SiteHelpText = siteHelpText;
				item.SiteHelpImageURL = siteHelpImageURL;
				item.SiteHelpGroupCode = siteHelpGroupCode;
				item.SiteHelpDefinitionCode = siteHelpDefinitionCode;
				BLL.UserExperience.SiteHelpManager.AddOneSiteHelp(item, false);
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.UserExperience.SiteHelpResults DeleteOneSiteHelp(int localeCode, int siteHelpDefinitionCode)
		{
			Components.UserExperience.SiteHelpResults results = new Components.UserExperience.SiteHelpResults();
			results.StatusDescription = "Results OK";
			try
			{
				...
				item.LocaleCode = localeCode;
				item.SiteHelpDefinitionCode = siteHelpDefinitionCode;
				BLL.UserExperience.SiteHelpManager.DeleteOneSiteHelp(item, false);
			}
			catch (System.Exception ex)
			{
				results.StatusCode = -1;
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.UserExperience.SiteHelpResults UpdateOneSiteHelp(int localeCode, string siteHelpName, string siteHelpText, string siteHelpImageURL, int siteHelpGroupCode, int siteHelpDefinitionCode)
		{
			Components.UserExperience.SiteHelpResults results = new Components.UserExperience.SiteHelpResults();
			results.StatusDescription = "Results OK";
			try
			{
				...
				item.SiteHelpGroupCode = siteHelpGroupCode;
				item.SiteHelpDefinitionCode = siteHelpDefinitionCode;
				BLL.UserExperience.SiteHelpManager.UpdateOneSiteHelp(item, false);
				results.Results.Add(item);
			}
			catch (System.Exception ex)
			{
