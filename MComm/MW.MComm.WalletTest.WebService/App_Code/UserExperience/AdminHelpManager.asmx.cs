...
namespace MW.MComm.WalletTest.WebService.UserExperience
{
	...
	public class AdminHelpManager : System.Web.Services.WebService
	{
		...
		///
		/// <param name="activityCode">A property of AdminHelp item to be managed</param>
		/// <param name="localeCode">A property of AdminHelp item to be managed</param>
		/// <param name="adminHelpTitle">A property of AdminHelp item to be managed</param>
		/// <param name="adminHelpText">A property of AdminHelp item to be managed</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.UserExperience.AdminHelpResults AddOneAdminHelp(int activityCode, int localeCode, string adminHelpTitle, string adminHelpText)
		{
			...
			try
			{
				...
				item.AdminHelpTitle = adminHelpTitle;
				item.AdminHelpText = adminHelpText;
				BLL.UserExperience.AdminHelpManager.AddOneAdminHelp(item, false);
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.UserExperience.AdminHelpResults DeleteOneAdminHelp(int activityCode, int localeCode)
		{
			Components.UserExperience.AdminHelpResults results = new Components.UserExperience.AdminHelpResults();
			results.StatusDescription = "Results OK";
			try
			{
				...
				item.ActivityCode = activityCode;
				item.LocaleCode = localeCode;
				BLL.UserExperience.AdminHelpManager.DeleteOneAdminHelp(item, false);
			}
			catch (System.Exception ex)
			{
				results.StatusCode = -1;
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.UserExperience.AdminHelpResults UpdateOneAdminHelp(int activityCode, int localeCode, string adminHelpTitle, string adminHelpText)
		{
			Components.UserExperience.AdminHelpResults results = new Components.UserExperience.AdminHelpResults();
			results.StatusDescription = "Results OK";
			try
			{
				...
				item.AdminHelpTitle = adminHelpTitle;
				item.AdminHelpText = adminHelpText;
				BLL.UserExperience.AdminHelpManager.UpdateOneAdminHelp(item, false);
				results.Results.Add(item);
			}
			catch (System.Exception ex)
			{
