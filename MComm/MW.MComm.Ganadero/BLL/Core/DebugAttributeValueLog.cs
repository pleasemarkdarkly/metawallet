...
namespace MW.MComm.Ganadero.BLL.Core
{
	...
	// ------------------------------------------------------------------------------
	[Serializable()]
	[DataTransform(Name = "MW.MComm.Ganadero.DAL.Core.DebugAttributeValueLog")]
	public partial class DebugAttributeValueLog : BusinessObject
	{
		...
		public virtual Guid DebugLogID
		{
			...
			set
			{
				if (_debugLogID != value)
				{
					...
					// reset DebugLog
					BLL.BusinessObject vDebugLog = (BLL.BusinessObject) DebugLog;
					vDebugLog = null;
					_isDirty = true;
				}
			}
		...
		public virtual Guid BaseAttributeID
		{
			...
			set
			{
				if (_baseAttributeID != value)
				{
					...
					BLL.BusinessObject vDebugAttribute = (BLL.BusinessObject) DebugAttribute;
		...
		public virtual BLL.Core.DebugAttribute DebugAttribute
		{
			get
			{
				if (_debugAttribute == null  && IsLoaded == true)
				{
		...
		public virtual BLL.Core.DebugLog DebugLog
		{
			get
			{
				if (_debugLog == null  && IsLoaded == true)
				{
		...
		{
			BLL.Core.DebugAttributeValueLog businessObject = BLL.Core.DebugAttributeValueLogManager.Load(debugAttributeValueLogID);
		...
		public void Save(bool performCascade)
		{
			...
			string key = BLL.Core.DebugAttributeValueLog.GetCacheKey(typeof(BLL.Core.DebugAttributeValueLog), "PrimaryKey", PrimaryKey);
