...
namespace MW.MComm.Ganadero.BLL.Core
{
	...
	public partial class EventType : BusinessObject
	{
		...
		{
			BLL.Core.EventType businessObject = BLL.Core.EventTypeManager.Load(eventTypeCode);
		...
		public void Save(bool performCascade)
		{
			...
			string key = BLL.Core.EventType.GetCacheKey(typeof(BLL.Core.EventType), "PrimaryKey", PrimaryKey);
