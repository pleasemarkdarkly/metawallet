...
namespace MW.MComm.Ganadero.BLL.Events
{
	...
	// ------------------------------------------------------------------------------
	[Serializable()]
	[DataTransform(Name = "MW.MComm.Ganadero.DAL.Events.AuditLog")]
	public partial class AuditLog : BusinessObject
	{
		...
		[XmlArray(ElementName="AuditAttributeValueLogList")]
		[XmlArrayItem(typeof(BLL.Events.AuditAttributeValueLog), ElementName="AuditAttributeValueLog")]
		public BLL.SortableList<BLL.Events.AuditAttributeValueLog> _auditAttributeValueLogList = null;
		...
		public virtual int EventCode
		{
			...
			set
			{
				if (_eventCode != value)
				{
					...
					// reset Event
					BLL.BusinessObject vEvent = (BLL.BusinessObject) Event;
					vEvent = null;
					_isDirty = true;
				}
			}
		...
		public virtual BLL.SortableList<BLL.Events.AuditAttributeValueLog> AuditAttributeValueLogList
		{
			get
			{
				if (_auditAttributeValueLogList == null  && IsLoaded == true)
				{
		...
		{
			BLL.Events.AuditLog businessObject = BLL.Events.AuditLogManager.Load(auditLogID);
		...
		public void Save(bool performCascade)
		{
			...
			string key = BLL.Events.AuditLog.GetCacheKey(typeof(BLL.Events.AuditLog), "PrimaryKey", PrimaryKey);
