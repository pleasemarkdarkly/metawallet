...
namespace MW.MComm.Ganadero.BLL.Events
{
	...
	// ------------------------------------------------------------------------------
	[Serializable()]
	[DataTransform(Name = "MW.MComm.Ganadero.DAL.Events.EventType")]
	public partial class EventType : BusinessObject
	{
		...
		// ------------------------------------------------------------------------------
		public EventType(DAL.Events.EventType businessObject) : base(businessObject)
		{
		}
		...
		{
			BLL.Events.EventType businessObject = BLL.Events.EventTypeManager.Load(eventTypeCode);
		...
		public void Save(bool performCascade)
		{
			if (IsLoaded == false)
			{
				BLL.Events.EventTypeManager.AddOneEventType(this, performCascade);
			}
			else
			{
				BLL.Events.EventTypeManager.UpdateOneEventType(this, performCascade);
			}
			string key = BLL.Events.EventType.GetCacheKey(typeof(BLL.Events.EventType), "PrimaryKey", PrimaryKey);
