...
namespace MW.MComm.Ganadero.BLL.Users
{
	...
	// ------------------------------------------------------------------------------
	[Serializable()]
	[DataTransform(Name = "MW.MComm.Ganadero.DAL.Users.UserRole")]
	public partial class UserRole : BusinessObject
	{
		...
		{
			BLL.Users.UserRole businessObject = BLL.Users.UserRoleManager.Load(userRoleCode);
		...
		public void Save(bool performCascade)
		{
			...
			string key = BLL.Users.UserRole.GetCacheKey(typeof(BLL.Users.UserRole), "PrimaryKey", PrimaryKey);
