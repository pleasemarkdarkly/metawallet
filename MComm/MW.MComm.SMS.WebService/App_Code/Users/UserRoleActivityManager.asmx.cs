...
namespace MW.MComm.SMS.WebService.Users
{
	...
	public class UserRoleActivityManager : System.Web.Services.WebService
	{
		...
		///
		/// <param name="item">The UserRoleActivity to be managed.</param>
		/// <param name="performCascadeOperation">Flag, indicating if a cascade operation should be performed on the UserRoleActivity item.</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Users.UserRoleActivityResults AddOneUserRoleActivity(BLL.Users.UserRoleActivity item, bool performCascadeOperation)
		{
			...
			try
			{
				...
				BLL.Users.UserRoleActivityManager.AddOneUserRoleActivity(item, performCascadeOperation);
		...
		/// <param name="performCascadeOperation">Flag, indicating if a cascade delete should be performed on the UserRoleActivity item.</param>
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Users.UserRoleActivityResults DeleteOneUserRoleActivity(BLL.Users.UserRoleActivity item, bool performCascadeOperation)
		{
			Components.Users.UserRoleActivityResults results = new Components.Users.UserRoleActivityResults();
			results.StatusDescription = "Results OK";
			try
			{
				// perform main method tasks
				BLL.Users.UserRoleActivityManager.DeleteOneUserRoleActivity(item, performCascadeOperation);
			}
			catch (System.Exception ex)
			{
				results.StatusCode = -1;
		...
		// ------------------------------------------------------------------
		[WebMethod]
		public Components.Users.UserRoleActivityResults UpdateOneUserRoleActivity(BLL.Users.UserRoleActivity item, bool performCascadeOperation)
		{
			Components.Users.UserRoleActivityResults results = new Components.Users.UserRoleActivityResults();
			results.StatusDescription = "Results OK";
			try
			{
				// perform main method tasks
				BLL.Users.UserRoleActivityManager.UpdateOneUserRoleActivity(item, performCascadeOperation);
				results.Results.Add(item);
			}
			catch (System.Exception ex)
			{
