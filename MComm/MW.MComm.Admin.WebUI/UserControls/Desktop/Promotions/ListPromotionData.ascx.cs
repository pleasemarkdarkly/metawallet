...
{
	// ------------------------------------------------------------------------------
	/// <summary>List Promotion Data is used to help manage Promotion information.</summary>
	///
	/// File History:
	...
	/// <remarks></remarks>
	// ------------------------------------------------------------------------------
	public partial class ListPromotionData  : Components.Desktop.BaseListUserControl
	{
		#region Fields
		#endregion Fields
		#region Properties
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "ListPromotionData.Page_Load"));
			}
			finally
			{
			}
		...
		private void editPromotion_PromotionAdded(BaseFormlUserControl sender, EntityEditEventArgs e)
		{
			...
			{
				Globals.AddErrorMessage(Page, "Collection already contains this Promotion");
			}
			else
			{
		...
		private void editPromotion_PromotionRemoved(BaseFormlUserControl sender, EntityEditEventArgs e)
		{
			...
			Globals.AddStatusMessage("Promotion removed.");
		}
		// ------------------------------------------------------------------------------
		...
		private void dgPrimaryList_ItemDataBound(object sender, DataGridItemEventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "ListPromotionData.dgPrimaryList_ItemDataBound"));
			}
			finally
			{
			}
		...
		{
			_collection = BLL.Promotions.PromotionManager.GetAllPromotionData(Globals.DBOptions, DataOptions, Globals.DebugLevel, Globals.CurrentUserID);
		}
		// ------------------------------------------------------------------------------
		...
		public void dgPrimaryList_ItemCommand(object sender, EventArgs e)
		{
			...
			if (args.CommandName == "Edit" || args.CommandName == "Delete")
			{
				...
				if (args.CommandName == "Edit")
				{
					...
					this.editPromotion.AccessMode = MOD.Data.AccessMode.Edit;
				}
				else if (args.CommandName == "Delete")
				{
					Globals.ClearMessages();
					_collection.Remove(item);
					if (this.editPromotion.PromotionItem == item)
					{
						this.editPromotion.AccessMode = MOD.Data.AccessMode.Add;
					}
					Globals.AddStatusMessage("Promotion removed.");
				}
			}
		...
		private void Page_PreRender(object sender, EventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "ListPromotionData.Page_PreRender"));
			}
			finally
			{
			}
