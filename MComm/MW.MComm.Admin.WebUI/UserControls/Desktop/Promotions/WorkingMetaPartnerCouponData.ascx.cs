...
{
	// ------------------------------------------------------------------------------
	/// <summary>Working Meta Partner Coupon Data is used to help manage MetaPartnerCoupon information.</summary>
	///
	/// File History:
	...
	/// <remarks></remarks>
	// ------------------------------------------------------------------------------
	public partial class WorkingMetaPartnerCouponData  : Components.Desktop.BaseListUserControl
	{
		#region Fields
		#endregion Fields
		#region Properties
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "WorkingMetaPartnerCouponData.Page_Load"));
			}
			finally
			{
			}
		...
		private void dgPrimaryList_ItemDataBound(object sender, DataGridItemEventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "WorkingMetaPartnerCouponData.dgPrimaryList_ItemDataBound"));
			}
			finally
			{
			}
		...
		{
			_collection = (BLL.SortableList<BLL.Promotions.MetaPartnerCoupon>) Session["Promotions/MetaPartnerCouponWorkingSet"];
			if (_collection != null)
			{
				((BLL.SortableList<BLL.Promotions.MetaPartnerCoupon>)_collection).Sort(SortColumn, SortDirection);
		...
		public void dgPrimaryList_ItemCommand(object sender, EventArgs e)
		{
			...
			if (_collection != null)
			{
				...
				else if (args.CommandName == "Select")
				{
					int hashCode = int.Parse(args.CommandArgument.ToString());
					BLL.Promotions.MetaPartnerCoupon item = ((BLL.SortableList<BLL.Promotions.MetaPartnerCoupon>)_collection).Find(hashCode);
					Session["Promotions/MetaPartnerCouponWorkingSetItem"] = item.PrimaryIndex;
				}
			}
		}
		// ------------------------------------------------------------------------------
		...
		///
		// ------------------------------------------------------------------------------
		public void AddItem(BLL.Promotions.MetaPartnerCoupon item)
		{
			_collection = (BLL.SortableList<BLL.Promotions.MetaPartnerCoupon>) Session["Promotions/MetaPartnerCouponWorkingSet"];
			if (_collection == null)
			{
				_collection = new BLL.SortableList<BLL.Promotions.MetaPartnerCoupon>();
			}
			...
			else
			{
				...
				TotalRecords = _collection.Count;
				Session["Promotions/MetaPartnerCouponWorkingSetItem"] = item.PrimaryIndex;
				Globals.AddStatusMessage("Meta Partner Coupon working set item added.");
			}
			Session["Promotions/MetaPartnerCouponWorkingSet"] = _collection;
		}
		// ------------------------------------------------------------------------------
		/// <summary>Item command event handler for Meta Partner Coupon list.</summary>
		///
		// ------------------------------------------------------------------------------
		public void RemoveItem(BLL.Promotions.MetaPartnerCoupon item)
		{
			Globals.ClearMessages();
			_collection = (BLL.SortableList<BLL.Promotions.MetaPartnerCoupon>) Session["Promotions/MetaPartnerCouponWorkingSet"];
			if (_collection != null)
			{
				...
				Globals.AddStatusMessage("Meta Partner Coupon working set item removed.");
			}
			Session["Promotions/MetaPartnerCouponWorkingSet"] = _collection;
		}
		// ------------------------------------------------------------------------------
		...
		private void Page_PreRender(object sender, EventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "WorkingMetaPartnerCouponData.Page_PreRender"));
			}
			finally
			{
			}
