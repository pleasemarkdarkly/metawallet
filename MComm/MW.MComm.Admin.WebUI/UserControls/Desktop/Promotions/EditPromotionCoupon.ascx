...
<%@ Control Language="c#" AutoEventWireup="false" CodeFile ="EditPromotionCoupon.ascx.cs" Inherits="MW.MComm.Admin.WebUI.UserControls.Desktop.Promotions.EditPromotionCoupon" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
...
<wilson:masterpage id="Masterpage" runat="server" templatefile="~/Templates/Desktop/DetailControl.ascx">
	<wilson:contentregion id="Title" runat="server">
		<asp:Label id="lblTitle" CssClass="subtitle" Runat="server">Edit Promotion&nbsp;Coupon</asp:Label>&nbsp;<asp:Label id="lblTitleMessage" CssClass="subtitle" Runat="server"></asp:Label>
	...
	<wilson:contentregion id="ItemInfo" runat="server">
		...
		<table>
			<tr>
				...
				<td>
					<span class="ID">
					<MODC:PropVal id="propPromotionCode" runat="server" prop="PromotionCouponItem.PromotionCode" cssclass="ID"></MODC:PropVal>
					</span>
				</td>
			</tr>
			<tr>
				...
				<td>
					<span class="ID">
					<MODC:PropVal id="propCouponCode" runat="server" prop="PromotionCouponItem.CouponCode" cssclass="ID"></MODC:PropVal>
					</span>
				</td>
			</tr>
		</table>
	...
	<MODC:PageSection id="Section_Basics" visible="false" runat="server">
		<table>
			<tr>
				...
				<td valign="top">
					<asp:DropDownList id="ddlPromotionCode" tabIndex="1" runat="server" CssClass="FormNormal"></asp:DropDownList>
			...
			<tr>
				...
				<td valign="top">
					<asp:DropDownList id="ddlCouponCode" tabIndex="2" runat="server" CssClass="FormNormal"></asp:DropDownList>
