...
{
	// ------------------------------------------------------------------------------
	/// <summary>Working Payment Transaction Attribute Value Log Data is used to help manage PaymentTransactionAttributeValueLog information.</summary>
	///
	/// File History:
	...
	/// <remarks></remarks>
	// ------------------------------------------------------------------------------
	public partial class WorkingPaymentTransactionAttributeValueLogData  : Components.Desktop.BaseListUserControl
	{
		#region Fields
		#endregion Fields
		#region Properties
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "WorkingPaymentTransactionAttributeValueLogData.Page_Load"));
			}
			finally
			{
			}
		...
		private void dgPrimaryList_ItemDataBound(object sender, DataGridItemEventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "WorkingPaymentTransactionAttributeValueLogData.dgPrimaryList_ItemDataBound"));
			}
			finally
			{
			}
		...
		{
			_collection = (BLL.SortableList<BLL.Payments.PaymentTransactionAttributeValueLog>) Session["Payments/PaymentTransactionAttributeValueLogWorkingSet"];
			if (_collection != null)
			{
				((BLL.SortableList<BLL.Payments.PaymentTransactionAttributeValueLog>)_collection).Sort(SortColumn, SortDirection);
		...
		public void dgPrimaryList_ItemCommand(object sender, EventArgs e)
		{
			...
			if (_collection != null)
			{
				...
				else if (args.CommandName == "Select")
				{
					int hashCode = int.Parse(args.CommandArgument.ToString());
					BLL.Payments.PaymentTransactionAttributeValueLog item = ((BLL.SortableList<BLL.Payments.PaymentTransactionAttributeValueLog>)_collection).Find(hashCode);
					Session["Payments/PaymentTransactionAttributeValueLogWorkingSetItem"] = item.PrimaryIndex;
				}
			}
		}
		// ------------------------------------------------------------------------------
		...
		///
		// ------------------------------------------------------------------------------
		public void AddItem(BLL.Payments.PaymentTransactionAttributeValueLog item)
		{
			_collection = (BLL.SortableList<BLL.Payments.PaymentTransactionAttributeValueLog>) Session["Payments/PaymentTransactionAttributeValueLogWorkingSet"];
			if (_collection == null)
			{
				_collection = new BLL.SortableList<BLL.Payments.PaymentTransactionAttributeValueLog>();
			}
			...
			else
			{
				...
				TotalRecords = _collection.Count;
				Session["Payments/PaymentTransactionAttributeValueLogWorkingSetItem"] = item.PrimaryIndex;
				Globals.AddStatusMessage("Payment Transaction Attribute Value Log working set item added.");
			}
			Session["Payments/PaymentTransactionAttributeValueLogWorkingSet"] = _collection;
		}
		// ------------------------------------------------------------------------------
		/// <summary>Item command event handler for Payment Transaction Attribute Value Log list.</summary>
		///
		// ------------------------------------------------------------------------------
		public void RemoveItem(BLL.Payments.PaymentTransactionAttributeValueLog item)
		{
			Globals.ClearMessages();
			_collection = (BLL.SortableList<BLL.Payments.PaymentTransactionAttributeValueLog>) Session["Payments/PaymentTransactionAttributeValueLogWorkingSet"];
			if (_collection != null)
			{
				...
				Globals.AddStatusMessage("Payment Transaction Attribute Value Log working set item removed.");
			}
			Session["Payments/PaymentTransactionAttributeValueLogWorkingSet"] = _collection;
		}
		// ------------------------------------------------------------------------------
		...
		private void Page_PreRender(object sender, EventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "WorkingPaymentTransactionAttributeValueLogData.Page_PreRender"));
			}
			finally
			{
			}
