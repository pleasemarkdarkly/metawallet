...
{
	// ------------------------------------------------------------------------------
	/// <summary>List Fee Data is used to help manage Fee information.</summary>
	///
	/// File History:
	...
	/// <remarks></remarks>
	// ------------------------------------------------------------------------------
	public partial class ListFeeData  : Components.Desktop.BaseListUserControl
	{
		#region Fields
		#endregion Fields
		#region Properties
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "ListFeeData.Page_Load"));
			}
			finally
			{
			}
		...
		private void editFee_FeeAdded(BaseFormlUserControl sender, EntityEditEventArgs e)
		{
			...
			{
				Globals.AddErrorMessage(Page, "Collection already contains this Fee");
			}
			else
			{
		...
		private void editFee_FeeRemoved(BaseFormlUserControl sender, EntityEditEventArgs e)
		{
			...
			Globals.AddStatusMessage("Fee removed.");
		}
		// ------------------------------------------------------------------------------
		...
		private void dgPrimaryList_ItemDataBound(object sender, DataGridItemEventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "ListFeeData.dgPrimaryList_ItemDataBound"));
			}
			finally
			{
			}
		...
		{
			_collection = BLL.Payments.FeeManager.GetAllFeeData(Globals.DBOptions, DataOptions, Globals.DebugLevel, Globals.CurrentUserID);
		}
		// ------------------------------------------------------------------------------
		...
		public void dgPrimaryList_ItemCommand(object sender, EventArgs e)
		{
			...
			if (args.CommandName == "Edit" || args.CommandName == "Delete")
			{
				...
				if (args.CommandName == "Edit")
				{
					...
					this.editFee.AccessMode = MOD.Data.AccessMode.Edit;
				}
				else if (args.CommandName == "Delete")
				{
					Globals.ClearMessages();
					_collection.Remove(item);
					if (this.editFee.FeeItem == item)
					{
						this.editFee.AccessMode = MOD.Data.AccessMode.Add;
					}
					Globals.AddStatusMessage("Fee removed.");
				}
			}
		...
		private void Page_PreRender(object sender, EventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "ListFeeData.Page_PreRender"));
			}
			finally
			{
			}
