...
{
	// ------------------------------------------------------------------------------
	/// <summary>Search Merchant Data is used to help manage Merchant information.</summary>
	///
	/// File History:
	...
	/// <remarks></remarks>
	// ------------------------------------------------------------------------------
	public partial class SearchMerchantData  : Components.Desktop.BaseSearchUserControl
	{
		#region Fields
		#endregion Fields
		#region Properties
		...
		public bool UseValidation
		{
			...
			set
			{
				...
				editMerchant.UseValidation = value;
			}
		}
		...
		// ------------------------------------------------------------------------------
		/// <summary>Load page for Merchant search.</summary>
		///
		// ------------------------------------------------------------------------------
		private void Page_Load(object sender, System.EventArgs e)
		{
			try
			{
				workingMerchantData.Visible = ProvideWorkingSet;
				base.OnLoad(); // base list control manages loading data
				if (WorkflowMode != WorkflowMode.Internal)
				{
					if (Session["SearchCustomers/MerchantData"] != null)
					{
						_collection = (BLL.SortableList<BLL.Customers.Merchant>)Session["SearchCustomers/MerchantData"];
					}
				}
				// Set current item into child control
				if (_selectedIndex > -1)
				{
					this.editMerchant.MerchantItem = (BLL.Customers.Merchant) Collection[_selectedIndex];
				}
				this.editMerchant.MerchantAdded += new EntityEditEventHandler(editMerchant_MerchantAdded);
				this.editMerchant.MerchantRemoved += new EntityEditEventHandler(editMerchant_MerchantRemoved);
			}
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "SearchMerchantData.Page_Load"));
			}
			finally
			{
			}
		...
		// ------------------------------------------------------------------------------
		/// <summary>Item added event handler for Merchant.</summary>
		///
		// ------------------------------------------------------------------------------
		private void editMerchant_MerchantAdded(BaseFormlUserControl sender, EntityEditEventArgs e)
		{
			if (_collection.Contains(e.Entity))
			{
				Globals.AddErrorMessage(this.Page, "Collection already contains this Merchant", new object[0]);
			}
			else
			{
		...
		// ------------------------------------------------------------------------------
		/// <summary>Item removed event handler for Merchant.</summary>
		///
		// ------------------------------------------------------------------------------
		private void editMerchant_MerchantRemoved(BaseFormlUserControl sender, EntityEditEventArgs e)
		{
			_collection.Add(e.Entity);
		}
		// ------------------------------------------------------------------------------
		...
		private void dgPrimaryList_ItemDataBound(object sender, DataGridItemEventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "SearchMerchantData.dgPrimaryList_ItemDataBound"));
			}
			finally
			{
			}
		...
		// ------------------------------------------------------------------------------
		/// <summary>Set Merchant information from the ui.</summary>
		///
		// ------------------------------------------------------------------------------
		...
		protected override void LoadCollectionFromDatabase()
		{
			try
			{
				...
				{
					_collection = BLL.Customers.MerchantManager.GetManyMerchantDataByCriteria(localeCode, currencyCode, dateFormatCode, lastModifiedDateStart, lastModifiedDateEnd, metaPartnerName, out totalRecords, out maximumListSizeExceeded, this.DataOptions);
					Session["SearchCustomers/MerchantData"] = _collection;
		...
		public void dgPrimaryList_ItemCommand(object sender, EventArgs e)
		{
			...
			if (args.CommandName == "Add" || args.CommandName == "Edit" || args.CommandName == "Delete")
			{
				...
				{
					workingMerchantData.AddItem(item);
				}
				else if (args.CommandName == "Edit")
				{
					this.editMerchant.MerchantItem = item;
				}
		...
		private void Page_PreRender(object sender, EventArgs e)
		{
			try
			{
				...
				if (this.WorkflowMode == MOD.Data.WorkflowMode.Internal)
				{
					editMerchant.Visible = true;
					btnNew.Visible = false;
				}
				else
				{
					editMerchant.Visible = false;
					btnNew.Visible = true;
				}
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "SearchMerchantData.Page_PreRender"));
			}
			finally
			{
			}
		...
		private void btnNew_Click(object sender, EventArgs e)
		{
			...
			Response.Redirect(Page.ResolveUrl(string.Format("EditMerchant.aspx?mode=" + MOD.Data.AccessMode.Add.ToString() + "&MetaPartnerID=" + MOD.Data.DataHelper.GetString(MOD.Data.DefaultValue.Guid, "") + "&MerchantMetaPartnerID=" + MOD.Data.DataHelper.GetString(MOD.Data.DefaultValue.Guid, "") + "")));
		}
		
		// ------------------------------------------------------------------------------
		/// <summary>Clear search form for Merchant.</summary>
		///
		// ------------------------------------------------------------------------------
		...
		// ------------------------------------------------------------------------------
		/// <summary>Perform search for Merchant items.</summary>
		///
		// ------------------------------------------------------------------------------
		private void btnSearch_Click(object sender, EventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "SearchMerchantData.btnSearch_Click"));
			}
			finally
			{
			}
