...
<%@ Control Language="c#" AutoEventWireup="false" CodeFile ="ListMetaPartnerEmailData.ascx.cs" Inherits="MW.MComm.Admin.WebUI.UserControls.Desktop.Customers.ListMetaPartnerEmailData" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
...
<wilson:masterpage id="Masterpage" runat="server" templatefile="~/Templates/Desktop/ListControl.ascx">
	<wilson:contentregion id="Title" runat="server">
		<asp:Label id="lblTitle" CssClass="subtitle" Runat="server">Meta&nbsp;Partner&nbsp;Email List</asp:Label>
