...
<%@ Control Language="c#" AutoEventWireup="false" CodeFile ="EditMetaPartnerSubType.ascx.cs" Inherits="MW.MComm.Admin.WebUI.UserControls.Desktop.Customers.EditMetaPartnerSubType" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
...
<wilson:masterpage id="Masterpage" runat="server" templatefile="~/Templates/Desktop/DetailControl.ascx">
	<wilson:contentregion id="Title" runat="server">
		<asp:Label id="lblTitle" CssClass="subtitle" Runat="server">Edit Meta&nbsp;Partner&nbsp;Sub&nbsp;Type</asp:Label>&nbsp;<asp:Label id="lblTitleMessage" CssClass="subtitle" Runat="server"></asp:Label>
	</wilson:contentregion>
	<wilson:contentregion id="ItemInfo" runat="server">
		<div class="IDSection" id="ItemInfoContent" runat="server">
		<table>
			<tr>
				<td>Meta&nbsp;Partner&nbsp;Sub&nbsp;Type&nbsp;Code:</td>
				<td>
					<span class="ID">
					<MODC:PropVal id="propMetaPartnerSubTypeCode" runat="server" prop="MetaPartnerSubTypeItem.MetaPartnerSubTypeCode" cssclass="ID"></MODC:PropVal>
					</span>
				</td>
			</tr>
			<tr>
				<td>Meta&nbsp;Partner&nbsp;Sub&nbsp;Type&nbsp;Name:</td>
				<td>
					<span class="ID">
					<MODC:PropVal id="propMetaPartnerSubTypeName" runat="server" prop="MetaPartnerSubTypeItem.MetaPartnerSubTypeName" cssclass="ID"></MODC:PropVal>
					</span>
				</td>
			</tr>
		</table>
	...
	<MODC:PageSection id="Section_Basics" visible="false" runat="server">
		<table>
			<tr>
				<td valign="top"><span class="FormLabelRequired"><asp:Label ID="lblMetaPartnerSubTypeCodeDisplay" runat="server">Meta&nbsp;Partner&nbsp;Sub&nbsp;Type&nbsp;Code:</asp:Label></span></td>
				<td valign="top">
					<asp:TextBox id="txtMetaPartnerSubTypeCode" tabIndex="1" runat="server" maxLength="5" Width="100" CssClass="FormNormal"></asp:TextBox>
					<asp:RangeValidator id="valMetaPartnerSubTypeCode" ControlToValidate="txtMetaPartnerSubTypeCode" EnableClientScript="False" Display="Dynamic" Runat="server" Type="Integer" MinimumValue="-2147483648" MaximumValue="2147483647" ErrorMessage="Must be a valid int from -2147483648 to 2147483647." ></asp:RangeValidator>
					<asp:RequiredFieldValidator id="valMetaPartnerSubTypeCodeRequired" ControlToValidate="txtMetaPartnerSubTypeCode" EnableClientScript="False" Display="Dynamic" Runat="server" ErrorMessage="Please enter a valid int from 1 to 2147483647." ></asp:RequiredFieldValidator>
				</td>
			</tr>
			<tr>
				<td valign="top"><span class="FormLabelRequired"><asp:Label ID="lblMetaPartnerSubTypeNameDisplay" runat="server">Meta&nbsp;Partner&nbsp;Sub&nbsp;Type&nbsp;Name:</asp:Label></span></td>
				<td valign="top">
					<asp:TextBox id="txtMetaPartnerSubTypeName" tabIndex="2" runat="server" maxLength="255" Width="300" CssClass="FormNormal"></asp:TextBox>
					<asp:RequiredFieldValidator id="valMetaPartnerSubTypeNameRequired" ControlToValidate="txtMetaPartnerSubTypeName" EnableClientScript="False" Display="Dynamic" Runat="server" ErrorMessage="Please enter some text." ></asp:RequiredFieldValidator>
				</td>
			</tr>
			<tr>
