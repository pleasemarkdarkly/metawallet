...
<%@ Control Language="c#" AutoEventWireup="false" CodeFile ="EditBusiness.ascx.cs" Inherits="MW.MComm.Admin.WebUI.UserControls.Desktop.Customers.EditBusiness" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
...
<wilson:masterpage id="Masterpage" runat="server" templatefile="~/Templates/Desktop/DetailControl.ascx">
	<wilson:contentregion id="Title" runat="server">
		<asp:Label id="lblTitle" CssClass="subtitle" Runat="server">Edit Business</asp:Label>&nbsp;<asp:Label id="lblTitleMessage" CssClass="subtitle" Runat="server"></asp:Label>
	...
	<wilson:contentregion id="ItemInfo" runat="server">
		...
		<table>
			<tr>
				...
				<td>
					<span class="ID">
					<MODC:PropVal id="propMetaPartnerID" runat="server" prop="BusinessItem.MetaPartnerID" cssclass="ID"></MODC:PropVal>
					</span>
				</td>
			</tr>
			<tr>
				...
				<td>
					<span class="ID">
					<MODC:PropVal id="propMetaPartnerName" runat="server" prop="BusinessItem.MetaPartnerName" cssclass="ID"></MODC:PropVal>
					</span>
				</td>
			</tr>
		</table>
	...
	<MODC:PageSection id="Section_Basics" visible="false" runat="server">
		<table>
			...
			<tr>
				...
				<td valign="top">
					<asp:DropDownList id="ddlMetaPartnerSubTypeCode" tabIndex="2" runat="server" CssClass="FormNormal"></asp:DropDownList>
			...
			<tr>
				...
				<td valign="top">
					<asp:TextBox id="txtMetaPartnerName" tabIndex="6" runat="server" maxLength="255" Width="300" CssClass="FormNormal"></asp:TextBox>
	...
	<MODC:PageSection id="Section_Additional_Info" visible="false" runat="server">
		<table>
			<tr>
				...
				<td valign="top">
					<asp:TextBox id="txtServiceCharges" tabIndex="7" runat="server" maxLength="255" Width="300" CssClass="FormNormal"></asp:TextBox>
				</td>
			</tr>
			<tr>
				<td valign="top"><span class="FormLabelOptional"><asp:Label ID="lblTaxCodeDisplay" runat="server">Tax&nbsp;Code:</asp:Label></span></td>
				<td valign="top">
					<asp:TextBox id="txtTaxCode" tabIndex="8" runat="server" maxLength="100" Width="150" CssClass="FormNormal"></asp:TextBox>
				</td>
			</tr>
			<tr>
