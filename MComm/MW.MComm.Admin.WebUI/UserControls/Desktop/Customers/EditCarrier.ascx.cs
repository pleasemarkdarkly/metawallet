...
{
	// ------------------------------------------------------------------------------
	/// <summary>Edit Carrier is used to help manage Carrier information.</summary>
	///
	/// File History:
	...
	/// <remarks></remarks>
	// ------------------------------------------------------------------------------
	public partial class EditCarrier  : Components.Desktop.BaseFormlUserControl, Controls.IHaveUploadableFiles
	{
		#region IHaveUploadableFiles
		public string GetFileRelativePath(Controls.FileUploader ctl)
		{
			if (ctl == txtPictureImageURL)
				return CarrierItem.PictureImageURL;
			else
				return null;
		}
		...
		/// </summary>
		public event EntityEditEventHandler CarrierAdded;
		/// <summary>
		/// Raised when "Remove" button is clicked in internal mode.
		/// Container handles this event and removes entity from collection.
		/// </summary>
		public event EntityEditEventHandler CarrierRemoved;
		#endregion Events
		#region Declarations
		#endregion Declarations
		#region Properties
		/// <summary>
		/// The Carrier currently being edited by this control.
		/// Get accessor casts base._entity to Carrier
		/// Set accessor used by parent control to set the item currently being edited
		/// </summary>
		public BLL.Customers.Carrier CarrierItem
		{
			get
			{
				return (BLL.Customers.Carrier) _entity;
			}
			set
			{
				_entity = value; // only set by container
				Session["CarrierItem"] = _entity;
			}
		}
		#endregion Properties
		#region Event Handlers
		// ------------------------------------------------------------------------------
		/// <summary>Load page for editing Carrier, getting mode and parameters.</summary>
		///
		// ------------------------------------------------------------------------------
		private void Page_Load(object sender, System.EventArgs e)
		{
			try
			{
				...
				if (IsPostBack == true)
				{
					...
					if (_entity == null)
					{
						_entity = (BLL.Customers.Carrier)Session["CarrierItem"];
					}
				...
				listMetaPartnerPhoneData.Collection = CarrierItem.PhoneList;
				listMetaPartnerEmailData.Collection = CarrierItem.EmailList;
				listLocationData.Collection = CarrierItem.LocationList;
				listBankAccountData.Collection = CarrierItem.BankAccountList;
				listStoredValueAccountData.Collection = CarrierItem.StoredValueAccountList;
				listCreditAccountData.Collection = CarrierItem.CreditAccountList;
				listFundAccountData.Collection = CarrierItem.FundAccountList;
				listBillPayAccountData.Collection = CarrierItem.BillPayAccountList;
				listMetaTransferAccountData.Collection = CarrierItem.MetaTransferAccountList;
				listLoanAccountData.Collection = CarrierItem.LoanAccountList;
				listMetaPartnerCouponData.Collection = CarrierItem.MetaPartnerCouponList;
			}
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "EditCarrier.Page_Load"));
			}
			finally
			{
			}
		...
		// ------------------------------------------------------------------------------
		/// <summary>Delete Carrier.</summary>
		///
		// ------------------------------------------------------------------------------
		private void btnDelete_Click(object sender, EventArgs e)
		{
			...
			try
			{
				...
				if (WorkflowMode == WorkflowMode.External)
				{
					...
					BLL.Customers.CarrierManager.DeleteOneCarrier(CarrierItem, performCascade);
					Globals.AddStatusMessage("Carrier deleted.");
				}
				else
				{
					...
					{
						CarrierRemoved(this, new EntityEditEventArgs(_entity));
					}
				}
			...
			{
				doRedirect = false;
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "EditCarrier.btnDelete_Click"));
			}
			finally
			{
			}
			if (doRedirect == true && WorkflowMode == MOD.Data.WorkflowMode.External)
			{
				...
				queryString.Add("CarrierMetaPartnerID", MOD.Data.DataHelper.GetString(MOD.Data.DefaultValue.Guid, ""));
		...
		private void btnNew_Click(object sender, EventArgs e)
		{
			...
			try
			{
				...
				SetAccessModeAndDisplay(MOD.Data.AccessMode.Add);
				Globals.AddStatusMessage("Add new Carrier.");
			}
			catch (CoreUtility.CustomAppException ex)
			{
				doRedirect = false;
			...
			{
				doRedirect = false;
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "EditCarrier.btnNew_Click"));
			}
			finally
			{
			}
		...
		// ------------------------------------------------------------------------------
		/// <summary>Reset form for Carrier.</summary>
		///
		// ------------------------------------------------------------------------------
		private void btnReset_Click(object sender, EventArgs e)
		{
			try
			{
				...
				Globals.AddStatusMessage("Carrier reset.");
			}
			catch (CoreUtility.CustomAppException ex)
			{
				base.HandleError(ex);
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "EditCarrier.btnReset_Click"));
			}
			finally
			{
			}
		...
		private void btnSave_Click(object sender, EventArgs e)
		{
			...
			try
			{
				...
				if (isValid == true)
				{
					if (WorkflowMode == WorkflowMode.Internal)
					{
						...
						{
							if (CarrierAdded != null && (CarrierItem.MetaPartnerID != MOD.Data.DefaultValue.Guid || CarrierItem.CarrierCode != MOD.Data.DefaultValue.Int || CarrierItem.CreatedByUserID != MOD.Data.DefaultValue.Guid || CarrierItem.CreatedDate != MOD.Data.DefaultValue.DateTime || CarrierItem.LastModifiedByUserID != MOD.Data.DefaultValue.Guid || CarrierItem.LastModifiedDate != MOD.Data.DefaultValue.DateTime || CarrierItem.Timestamp != null))
							{
								CarrierAdded(this, new EntityEditEventArgs(_entity));
								// create new object and store it in _entity
								CreateNewEntity();
								Session["CarrierItem"] = _entity;
								this.sectionLinks.OnSection("Basics");
						...
						{
							Globals.AddStatusMessage("Carrier updated.");
						}
					}
					else
					{
				...
				{
					Globals.AddErrorMessage(Page, "Carrier validation failed.");
				}
			}
			catch (CoreUtility.CustomAppException ex)
			{
			...
			{
				doRedirect = false;
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "EditCarrier.btnSave_Click"));
			}
			finally
			{
			}
			...
			{
				NameValueCollection queryString = new NameValueCollection();
				queryString.Add("MetaPartnerID", CarrierItem.MetaPartnerID.ToString());
				queryString.Add("CarrierMetaPartnerID", CarrierItem.MetaPartnerID.ToString());
		...
		private void btnBasics_Click(object sender, EventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "EditCarrier.btnBasics_Click"));
			}
			finally
			{
			}
		...
		private void Page_PreRender(object sender, EventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "EditCarrier.Page_PreRender"));
			}
			finally
			{
			}
		...
		// ------------------------------------------------------------------------------
		/// <summary>
		/// Create a new Carrier object reference
		/// </summary>
		/// <returns></returns>
		// ------------------------------------------------------------------------------
		protected void CreateNewEntity()
		{
			BLL.Customers.Carrier vCarrier = new BLL.Customers.Carrier();
			_entity = vCarrier;
		}
		// ------------------------------------------------------------------------------
		/// <summary>Update form from Carrier information.</summary>
		///
		// ------------------------------------------------------------------------------
		private void CopyEntityToForm()
		{
			BLL.Customers.Carrier vCarrier = CarrierItem;
			lblMetaPartnerID.Text = MOD.Data.DataHelper.GetString(vCarrier.MetaPartnerID, "");
			txtCarrierCode.Text = MOD.Data.EditHelper.GetInt(vCarrier.CarrierCode);
			txtServiceCharges.Text = MOD.Data.EditHelper.GetString(vCarrier.ServiceCharges);
			...
			try
			{
				if (AccessMode == MOD.Data.AccessMode.Add)
				{
					ddlMetaPartnerSubTypeCode.SelectedValue = ddlMetaPartnerSubTypeCode.Items.FindByText("Carrier").Value;
				}
				else
				{
					ddlMetaPartnerSubTypeCode.SelectedValue = MOD.Data.DataHelper.GetString(vCarrier.MetaPartnerSubTypeCode, "");
				}
			}
			catch {}
			...
			try
			{
				...
				sLocale.LocaleCode = MOD.Data.DataHelper.GetInt(vCarrier.LocaleCode, MOD.Data.DefaultValue.Int);
			...
			try
			{
				...
				sCurrency.CurrencyCode = MOD.Data.DataHelper.GetInt(vCarrier.CurrencyCode, MOD.Data.DefaultValue.Int);
			...
			try
			{
				...
				sDateFormat.DateFormatCode = MOD.Data.DataHelper.GetInt(vCarrier.DateFormatCode, MOD.Data.DefaultValue.Int);
			...
			txtTaxCode.Text = MOD.Data.EditHelper.GetString(vCarrier.TaxCode);
			chkIsActive.Checked = MOD.Data.DataHelper.GetBool(vCarrier.IsActive, MOD.Data.DefaultValue.Bool);
			txtMetaPartnerName.Text = MOD.Data.EditHelper.GetString(vCarrier.MetaPartnerName);
		...
		// ------------------------------------------------------------------------------
		/// <summary>Set Carrier information from the form.</summary>
		///
		// ------------------------------------------------------------------------------
		private void CopyFormToEntity()
		{
			...
			if (vCarrier == null)
			{
				throw CoreUtility.CustomAppException.WrapException(new Exception("Carrier not found"), "EditCarrier.CopyFormToEntity()");
			}
			try
			{
				vCarrier.CarrierCode = MOD.Data.DataHelper.GetInt(txtCarrierCode.Text, MOD.Data.DefaultValue.Int);
			}
			catch {}
			vCarrier.ServiceCharges = EditHelper.EncodeStringForDB(MOD.Data.DataHelper.GetString(txtServiceCharges.Text, null));
			if (ddlMetaPartnerSubTypeCode.SelectedValue != ((int)MOD.Data.Lists.ListDefaultSelection.None).ToString())
			{
				...
				vCarrier.MetaPartnerSubTypeCode = MOD.Data.DataHelper.GetInt(sMetaPartnerSubType.MetaPartnerSubTypeCode, MOD.Data.DefaultValue.Int);
				sMetaPartnerSubType = null;
			}
			if (ddlLocaleCode.SelectedValue != ((int)MOD.Data.Lists.ListDefaultSelection.None).ToString())
			{
				BLL.Environments.Locale sLocale = new BLL.Environments.Locale(ddlLocaleCode.SelectedValue, false);
				vCarrier.LocaleCode = MOD.Data.DataHelper.GetInt(sLocale.LocaleCode, MOD.Data.DefaultValue.Int);
				sLocale = null;
			}
			if (ddlCurrencyCode.SelectedValue != ((int)MOD.Data.Lists.ListDefaultSelection.None).ToString())
			{
				BLL.Accounts.Currency sCurrency = new BLL.Accounts.Currency(ddlCurrencyCode.SelectedValue, false);
				vCarrier.CurrencyCode = MOD.Data.DataHelper.GetInt(sCurrency.CurrencyCode, MOD.Data.DefaultValue.Int);
				sCurrency = null;
			}
			if (ddlDateFormatCode.SelectedValue != ((int)MOD.Data.Lists.ListDefaultSelection.None).ToString())
			{
				BLL.Environments.DateFormat sDateFormat = new BLL.Environments.DateFormat(ddlDateFormatCode.SelectedValue, false);
				vCarrier.DateFormatCode = MOD.Data.DataHelper.GetInt(sDateFormat.DateFormatCode, MOD.Data.DefaultValue.Int);
				sDateFormat = null;
			}
			vCarrier.TaxCode = EditHelper.EncodeStringForDB(MOD.Data.DataHelper.GetString(txtTaxCode.Text, null));
			vCarrier.IsActive = chkIsActive.Checked;
			vCarrier.MetaPartnerName = EditHelper.EncodeStringForDB(MOD.Data.DataHelper.GetString(txtMetaPartnerName.Text, null));
			vCarrier.PictureImageURL = txtPictureImageURL.SaveFile();
		}
		// ------------------------------------------------------------------------------
		/// <summary>
		/// Load entity from database, store in _entity and Session["CarrierItem"]
		/// </summary>
		/// <returns></returns>
		// ------------------------------------------------------------------------------
		protected void LoadEntity()
		{
			...
			{
				_entity = BLL.Customers.CarrierManager.GetOneCarrier(metaPartnerID, Globals.getDataOptions("", "", true, true));
			}
		}
		// ------------------------------------------------------------------------------
		/// <summary>Update Carrier information in the database.</summary>
		///
		// ------------------------------------------------------------------------------
		private void UpsertToDatabase(bool performCascade)
		{
			...
			if (AccessMode == MOD.Data.AccessMode.Add)
			{
				BLL.Customers.CarrierManager.AddOneCarrier(vCarrier, performCascade);
			}
			else if (AccessMode == MOD.Data.AccessMode.Edit)
			{
				BLL.Customers.CarrierManager.UpdateOneCarrier(vCarrier, performCascade);
			}
			CarrierItem.MetaPartnerID = vCarrier.MetaPartnerID;
		}
		// ------------------------------------------------------------------------------
		...
		private void SetAccessModeAndDisplay(MOD.Data.AccessMode accessMode)
		{
			...
			switch (AccessMode)
			{
				...
				case MOD.Data.AccessMode.Edit:
					lblTitle.Text = "Edit Carrier";
					btnSave.Text = "Save";
					break;
				case MOD.Data.AccessMode.View:
					lblTitle.Text = "View Carrier";
					break;
				default:
					lblTitle.Text = "View Carrier";
					break;
