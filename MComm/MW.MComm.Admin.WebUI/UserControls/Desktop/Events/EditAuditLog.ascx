...
<%@ Control Language="c#" AutoEventWireup="false" CodeFile ="EditAuditLog.ascx.cs" Inherits="MW.MComm.Admin.WebUI.UserControls.Desktop.Events.EditAuditLog" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
...
<%@ Register TagPrefix="MOD" TagName="ListAuditAttributeValueLogData" Src="~/UserControls/Desktop/Events/ListAuditAttributeValueLogData.ascx" %>
<wilson:masterpage id="Masterpage" runat="server" templatefile="~/Templates/Desktop/DetailControl.ascx">
	<wilson:contentregion id="Title" runat="server">
		<asp:Label id="lblTitle" CssClass="subtitle" Runat="server">Edit Audit&nbsp;Log</asp:Label>&nbsp;<asp:Label id="lblTitleMessage" CssClass="subtitle" Runat="server"></asp:Label>
	...
	<wilson:contentregion id="ItemInfo" runat="server">
		...
		<table>
			<tr>
				...
				<td>
					<span class="ID">
					<MODC:PropVal id="propAuditLogID" runat="server" prop="AuditLogItem.AuditLogID" cssclass="ID"></MODC:PropVal>
					</span>
				</td>
			</tr>
		</table>
	...
	<wilson:contentregion id="DetailNavigation" runat="server">
		...
		<MOD:PageSectionLinks id="sectionLinks" runat="server" CssClass="SectionLink" SelectedCssClass="selSectionLink" ValidationList="Basics" SectionList="Basics,Audit_Attribute_Value_Logs"></MOD:PageSectionLinks>
		</div>
	</wilson:contentregion>
	...
	<MODC:PageSection id="Section_Basics" visible="false" runat="server">
		<table>
			<tr>
				<td valign="top"><span class="FormLabelRequired"><asp:Label ID="lblAuditLogIDDisplay" runat="server">Audit&nbsp;Log&nbsp;ID:</asp:Label></span></td>
				<td valign="top">
					<asp:Label id="lblAuditLogID" runat="server" CssClass="FormNormal"></asp:Label>
				</td>
			</tr>
			<tr>
				<td valign="top"><span class="FormLabelRequired"><asp:Label ID="lblEventCodeDisplay" runat="server">Event:</asp:Label></span></td>
				<td valign="top">
					<asp:DropDownList id="ddlEventCode" tabIndex="2" runat="server" CssClass="FormNormal"></asp:DropDownList>
	...
	<MODC:PageSection id="Section_Audit_Attribute_Value_Logs" visible="false" runat="server">
		<MOD:ListAuditAttributeValueLogData id="listAuditAttributeValueLogData" ListTitle="Audit&nbsp;Attribute&nbsp;Value&nbsp;Logs" WorkflowMode="Internal" AccessMode="Add" DisplayMode="SingleView" RequiresAuthentication="true" runat="server"></MOD:ListAuditAttributeValueLogData>
	</MODC:PageSection>
</wilson:masterpage>