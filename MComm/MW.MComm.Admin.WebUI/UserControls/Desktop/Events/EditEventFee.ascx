...
<%@ Control Language="c#" AutoEventWireup="false" CodeFile ="EditEventFee.ascx.cs" Inherits="MW.MComm.Admin.WebUI.UserControls.Desktop.Events.EditEventFee" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
...
<wilson:masterpage id="Masterpage" runat="server" templatefile="~/Templates/Desktop/DetailControl.ascx">
	<wilson:contentregion id="Title" runat="server">
		<asp:Label id="lblTitle" CssClass="subtitle" Runat="server">Edit Event&nbsp;Fee</asp:Label>&nbsp;<asp:Label id="lblTitleMessage" CssClass="subtitle" Runat="server"></asp:Label>
	...
	<wilson:contentregion id="ItemInfo" runat="server">
		...
		<table>
			<tr>
				...
				<td>
					<span class="ID">
					<MODC:PropVal id="propEventCode" runat="server" prop="EventFeeItem.EventCode" cssclass="ID"></MODC:PropVal>
					</span>
				</td>
			</tr>
			<tr>
				...
				<td>
					<span class="ID">
					<MODC:PropVal id="propFeeCode" runat="server" prop="EventFeeItem.FeeCode" cssclass="ID"></MODC:PropVal>
					</span>
				</td>
			</tr>
		</table>
	...
	<MODC:PageSection id="Section_Basics" visible="false" runat="server">
		<table>
			...
			<tr>
				<td valign="top"><span class="FormLabelRequired"><asp:Label ID="lblFeeCodeDisplay" runat="server">Fee:</asp:Label></span></td>
				<td valign="top">
					<asp:DropDownList id="ddlFeeCode" tabIndex="2" runat="server" CssClass="FormNormal"></asp:DropDownList>
					<asp:Label id="lblFeeCodeWorkingSet" runat="server" CssClass="FormNormal"> (from Fee working set)</asp:Label>
					<a id="lnkFeeCodeWorkingSet" runat="server" onclick="javascript:return PromptToDiscardChanges();" class="FormNormal">search</a>
					<asp:CompareValidator id="valFeeCode" ControlToValidate="ddlFeeCode" EnableClientScript="False" Display="Dynamic" Runat="server" Type="String" ValueToCompare="0" Operator="NotEqual" ErrorMessage="Please select a value from the list." ></asp:CompareValidator>
				</td>
			</tr>
			<tr>
