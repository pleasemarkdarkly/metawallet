...
<%@ Control Language="c#" AutoEventWireup="false" CodeFile ="EditSpecificEventAttribute.ascx.cs" Inherits="MW.MComm.Admin.WebUI.UserControls.Desktop.Events.EditSpecificEventAttribute" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
...
<wilson:masterpage id="Masterpage" runat="server" templatefile="~/Templates/Desktop/DetailControl.ascx">
	<wilson:contentregion id="Title" runat="server">
		<asp:Label id="lblTitle" CssClass="subtitle" Runat="server">Edit Specific&nbsp;Event&nbsp;Attribute</asp:Label>&nbsp;<asp:Label id="lblTitleMessage" CssClass="subtitle" Runat="server"></asp:Label>
	...
	<wilson:contentregion id="ItemInfo" runat="server">
		...
		<table>
			<tr>
				...
				<td>
					<span class="ID">
					<MODC:PropVal id="propEventCode" runat="server" prop="SpecificEventAttributeItem.EventCode" cssclass="ID"></MODC:PropVal>
					</span>
				</td>
			</tr>
			<tr>
				...
				<td>
					<span class="ID">
					<MODC:PropVal id="propBaseAttributeID" runat="server" prop="SpecificEventAttributeItem.BaseAttributeID" cssclass="ID"></MODC:PropVal>
					</span>
				</td>
			</tr>
		</table>
	...
	<MODC:PageSection id="Section_Basics" visible="false" runat="server">
		<table>
			...
			<tr>
				...
				<td valign="top">
					<asp:DropDownList id="ddlBaseAttributeID" tabIndex="2" runat="server" CssClass="FormNormal"></asp:DropDownList>
