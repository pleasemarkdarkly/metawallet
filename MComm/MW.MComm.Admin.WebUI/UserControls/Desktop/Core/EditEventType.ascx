...
<%@ Control Language="c#" AutoEventWireup="false" CodeFile ="EditEventType.ascx.cs" Inherits="MW.MComm.Admin.WebUI.UserControls.Desktop.Core.EditEventType" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
	...
	<MODC:PageSection id="Section_Basics" visible="false" runat="server">
		<table>
			...
			<tr>
				...
				<td valign="top">
					<asp:TextBox id="txtEventTypeName" tabIndex="2" runat="server" maxLength="100" Width="150" CssClass="FormNormal"></asp:TextBox>
