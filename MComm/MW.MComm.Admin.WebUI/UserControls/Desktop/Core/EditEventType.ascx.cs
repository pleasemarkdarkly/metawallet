...
namespace MW.MComm.Admin.WebUI.UserControls.Desktop.Core
{
	...
	public partial class EditEventType  : Components.Desktop.BaseFormlUserControl
	{
		...
		/// </summary>
		public BLL.Core.EventType EventTypeItem
		{
			get
			{
				return (BLL.Core.EventType) _entity;
			}
			set
			{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			try
			{
				...
				if (IsPostBack == true)
				{
					...
					if (_entity == null)
					{
						_entity = (BLL.Core.EventType)Session["EventTypeItem"];
					}
		...
		private void btnDelete_Click(object sender, EventArgs e)
		{
			...
			try
			{
				...
				if (WorkflowMode == WorkflowMode.External)
				{
					...
					BLL.Core.EventTypeManager.DeleteOneEventType(EventTypeItem, performCascade);
		...
		{
			BLL.Core.EventType vEventType = new BLL.Core.EventType();
		...
		{
			BLL.Core.EventType vEventType = EventTypeItem;
		...
		protected void LoadEntity()
		{
			...
			{
				_entity = BLL.Core.EventTypeManager.GetOneEventType(eventTypeCode, Globals.getDataOptions("", "", true, true));
			}
		}
		// ------------------------------------------------------------------------------
		...
		private void UpsertToDatabase(bool performCascade)
		{
			...
			if (AccessMode == MOD.Data.AccessMode.Add)
			{
				BLL.Core.EventTypeManager.AddOneEventType(vEventType, performCascade);
			}
			else if (AccessMode == MOD.Data.AccessMode.Edit)
			{
				BLL.Core.EventTypeManager.UpdateOneEventType(vEventType, performCascade);
			}
