...
{
	// ------------------------------------------------------------------------------
	/// <summary>List Debug Log Data is used to help manage DebugLog information.</summary>
	///
	/// File History:
	...
	/// <remarks></remarks>
	// ------------------------------------------------------------------------------
	public partial class ListDebugLogData  : Components.Desktop.BaseListUserControl
	{
		#region Fields
		#endregion Fields
		#region Properties
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "ListDebugLogData.Page_Load"));
			}
			finally
			{
			}
		...
		private void editDebugLog_DebugLogRemoved(BaseFormlUserControl sender, EntityEditEventArgs e)
		{
			...
			Globals.AddStatusMessage("Debug Log removed.");
		}
		// ------------------------------------------------------------------------------
		...
		private void dgPrimaryList_ItemDataBound(object sender, DataGridItemEventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "ListDebugLogData.dgPrimaryList_ItemDataBound"));
			}
			finally
			{
			}
		...
		{
			_collection = BLL.Core.DebugLogManager.GetAllDebugLogData(Globals.DBOptions, DataOptions, Globals.DebugLevel, Globals.CurrentUserID);
		}
		// ------------------------------------------------------------------------------
		...
		public void dgPrimaryList_ItemCommand(object sender, EventArgs e)
		{
			...
			if (args.CommandName == "Edit" || args.CommandName == "Delete")
			{
				...
				if (args.CommandName == "Edit")
				{
					...
					this.editDebugLog.AccessMode = MOD.Data.AccessMode.Edit;
				}
				else if (args.CommandName == "Delete")
				{
					Globals.ClearMessages();
					_collection.Remove(item);
					if (this.editDebugLog.DebugLogItem == item)
					{
						this.editDebugLog.AccessMode = MOD.Data.AccessMode.Add;
					}
					Globals.AddStatusMessage("Debug Log removed.");
				}
			}
		...
		private void Page_PreRender(object sender, EventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "ListDebugLogData.Page_PreRender"));
			}
			finally
			{
			}
