...
*/%>
<%@ Control Language="c#" Inherits="MW.MComm.Admin.WebUI.UserControls.Desktop.navigation.BreadCrumbNav" CodeFile="BreadCrumbNav.ascx.cs" %>
<asp:literal id="lblBreadCrumbNav" runat="server"></asp:literal>