...
namespace MW.MComm.Admin.WebUI.UserControls.Desktop.navigation
{
	...
	/// <summary>
	///		Summary description for SiteMapNav.
	/// </summary>
	public partial class SiteMapNav : System.Web.UI.UserControl
	{
		protected void Page_Load(object sender, System.EventArgs e)
		{
			if(!IsPostBack)
			{
				lblSiteMapNav.Text = Globals.getRenderedSiteNav(Globals.SiteMapNavigationXsl);
			}
		}
