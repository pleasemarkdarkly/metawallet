...
<%@ Control Language="c#" AutoEventWireup="false" CodeFile ="EditOrderStatus.ascx.cs" Inherits="MW.MComm.Admin.WebUI.UserControls.Desktop.Orders.EditOrderStatus" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
...
<wilson:masterpage id="Masterpage" runat="server" templatefile="~/Templates/Desktop/DetailControl.ascx">
	<wilson:contentregion id="Title" runat="server">
		<asp:Label id="lblTitle" CssClass="subtitle" Runat="server">Edit Order&nbsp;Status</asp:Label>&nbsp;<asp:Label id="lblTitleMessage" CssClass="subtitle" Runat="server"></asp:Label>
	...
	<wilson:contentregion id="ItemInfo" runat="server">
		...
		<table>
			<tr>
				...
				<td>
					<span class="ID">
					<MODC:PropVal id="propOrderStatusCode" runat="server" prop="OrderStatusItem.OrderStatusCode" cssclass="ID"></MODC:PropVal>
					</span>
				</td>
			</tr>
			<tr>
				...
				<td>
					<span class="ID">
					<MODC:PropVal id="propOrderStatusName" runat="server" prop="OrderStatusItem.OrderStatusName" cssclass="ID"></MODC:PropVal>
					</span>
				</td>
			</tr>
		</table>
	...
	<MODC:PageSection id="Section_Basics" visible="false" runat="server">
		<table>
			<tr>
				<td valign="top"><span class="FormLabelRequired"><asp:Label ID="lblOrderStatusCodeDisplay" runat="server">Order&nbsp;Status&nbsp;Code:</asp:Label></span></td>
				<td valign="top">
					<asp:TextBox id="txtOrderStatusCode" tabIndex="1" runat="server" maxLength="5" Width="100" CssClass="FormNormal"></asp:TextBox>
					<asp:RangeValidator id="valOrderStatusCode" ControlToValidate="txtOrderStatusCode" EnableClientScript="False" Display="Dynamic" Runat="server" Type="Integer" MinimumValue="-2147483648" MaximumValue="2147483647" ErrorMessage="Must be a valid int from -2147483648 to 2147483647." ></asp:RangeValidator>
					<asp:RequiredFieldValidator id="valOrderStatusCodeRequired" ControlToValidate="txtOrderStatusCode" EnableClientScript="False" Display="Dynamic" Runat="server" ErrorMessage="Please enter a valid int from 1 to 2147483647." ></asp:RequiredFieldValidator>
				</td>
			</tr>
			<tr>
				<td valign="top"><span class="FormLabelRequired"><asp:Label ID="lblOrderStatusNameDisplay" runat="server">Order&nbsp;Status&nbsp;Name:</asp:Label></span></td>
				<td valign="top">
					<asp:TextBox id="txtOrderStatusName" tabIndex="2" runat="server" maxLength="255" Width="300" CssClass="FormNormal"></asp:TextBox>
					<asp:RequiredFieldValidator id="valOrderStatusNameRequired" ControlToValidate="txtOrderStatusName" EnableClientScript="False" Display="Dynamic" Runat="server" ErrorMessage="Please enter some text." ></asp:RequiredFieldValidator>
				</td>
			</tr>
			<tr>
