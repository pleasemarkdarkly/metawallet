...
{
	// ------------------------------------------------------------------------------
	/// <summary>Working Debit Account Data is used to help manage DebitAccount information.</summary>
	///
	/// File History:
	...
	/// <remarks></remarks>
	// ------------------------------------------------------------------------------
	public partial class WorkingDebitAccountData  : Components.Desktop.BaseListUserControl
	{
		#region Fields
		#endregion Fields
		#region Properties
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "WorkingDebitAccountData.Page_Load"));
			}
			finally
			{
			}
		...
		private void dgPrimaryList_ItemDataBound(object sender, DataGridItemEventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "WorkingDebitAccountData.dgPrimaryList_ItemDataBound"));
			}
			finally
			{
			}
		...
		{
			_collection = (BLL.SortableList<BLL.Accounts.DebitAccount>) Session["Accounts/DebitAccountWorkingSet"];
			if (_collection != null)
			{
				((BLL.SortableList<BLL.Accounts.DebitAccount>)_collection).Sort(SortColumn, SortDirection);
		...
		public void dgPrimaryList_ItemCommand(object sender, EventArgs e)
		{
			...
			if (_collection != null)
			{
				...
				else if (args.CommandName == "Select")
				{
					int hashCode = int.Parse(args.CommandArgument.ToString());
					BLL.Accounts.DebitAccount item = ((BLL.SortableList<BLL.Accounts.DebitAccount>)_collection).Find(hashCode);
					Session["Accounts/DebitAccountWorkingSetItem"] = item.PrimaryIndex;
				}
			}
		}
		// ------------------------------------------------------------------------------
		...
		///
		// ------------------------------------------------------------------------------
		public void AddItem(BLL.Accounts.DebitAccount item)
		{
			_collection = (BLL.SortableList<BLL.Accounts.DebitAccount>) Session["Accounts/DebitAccountWorkingSet"];
			if (_collection == null)
			{
				_collection = new BLL.SortableList<BLL.Accounts.DebitAccount>();
			}
			...
			else
			{
				...
				TotalRecords = _collection.Count;
				Session["Accounts/DebitAccountWorkingSetItem"] = item.PrimaryIndex;
				Globals.AddStatusMessage("Debit Account working set item added.");
			}
			Session["Accounts/DebitAccountWorkingSet"] = _collection;
		}
		// ------------------------------------------------------------------------------
		/// <summary>Item command event handler for Debit Account list.</summary>
		///
		// ------------------------------------------------------------------------------
		public void RemoveItem(BLL.Accounts.DebitAccount item)
		{
			Globals.ClearMessages();
			_collection = (BLL.SortableList<BLL.Accounts.DebitAccount>) Session["Accounts/DebitAccountWorkingSet"];
			if (_collection != null)
			{
				...
				Globals.AddStatusMessage("Debit Account working set item removed.");
			}
			Session["Accounts/DebitAccountWorkingSet"] = _collection;
		}
		// ------------------------------------------------------------------------------
		...
		private void Page_PreRender(object sender, EventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "WorkingDebitAccountData.Page_PreRender"));
			}
			finally
			{
			}
