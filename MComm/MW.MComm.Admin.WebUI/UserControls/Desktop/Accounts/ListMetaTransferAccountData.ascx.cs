...
{
	// ------------------------------------------------------------------------------
	/// <summary>List Meta Transfer Account Data is used to help manage MetaTransferAccount information.</summary>
	///
	/// File History:
	...
	/// <remarks></remarks>
	// ------------------------------------------------------------------------------
	public partial class ListMetaTransferAccountData  : Components.Desktop.BaseListUserControl
	{
		#region Fields
		#endregion Fields
		#region Properties
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "ListMetaTransferAccountData.Page_Load"));
			}
			finally
			{
			}
		...
		private void editMetaTransferAccount_MetaTransferAccountAdded(BaseFormlUserControl sender, EntityEditEventArgs e)
		{
			...
			Globals.AddStatusMessage("Meta Transfer Account added.");
		}
		// ------------------------------------------------------------------------------
		...
		private void editMetaTransferAccount_MetaTransferAccountRemoved(BaseFormlUserControl sender, EntityEditEventArgs e)
		{
			...
			Globals.AddStatusMessage("Meta Transfer Account removed.");
		}
		// ------------------------------------------------------------------------------
		...
		private void dgPrimaryList_ItemDataBound(object sender, DataGridItemEventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "ListMetaTransferAccountData.dgPrimaryList_ItemDataBound"));
			}
			finally
			{
			}
		...
		protected override void LoadCollectionFromDatabase()
		{
			...
			{
				_collection = BLL.Accounts.MetaTransferAccountManager.GetAllMetaTransferAccountDataByAccountID(accountID, Globals.DBOptions, DataOptions, Globals.DebugLevel, Globals.CurrentUserID);
			}
			else
			{
				_collection = BLL.Accounts.MetaTransferAccountManager.GetAllMetaTransferAccountData(Globals.DBOptions, DataOptions, Globals.DebugLevel, Globals.CurrentUserID);
			}
		}
		// ------------------------------------------------------------------------------
		...
		public void dgPrimaryList_ItemCommand(object sender, EventArgs e)
		{
			...
			if (args.CommandName == "Edit" || args.CommandName == "Delete")
			{
				...
				if (args.CommandName == "Edit")
				{
					...
					this.editMetaTransferAccount.AccessMode = MOD.Data.AccessMode.Edit;
				}
				else if (args.CommandName == "Delete")
				{
					Globals.ClearMessages();
					_collection.Remove(item);
					if (this.editMetaTransferAccount.MetaTransferAccountItem == item)
					{
						this.editMetaTransferAccount.AccessMode = MOD.Data.AccessMode.Add;
					}
					Globals.AddStatusMessage("Meta Transfer Account removed.");
				}
			}
		...
		private void Page_PreRender(object sender, EventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "ListMetaTransferAccountData.Page_PreRender"));
			}
			finally
			{
			}
