...
{
	// ------------------------------------------------------------------------------
	/// <summary>Search Stored Value Account Data is used to help manage StoredValueAccount information.</summary>
	///
	/// File History:
	...
	/// <remarks></remarks>
	// ------------------------------------------------------------------------------
	public partial class SearchStoredValueAccountData  : Components.Desktop.BaseSearchUserControl
	{
		#region Fields
		#endregion Fields
		#region Properties
		...
		// ------------------------------------------------------------------------------
		/// <summary>Load page for Stored Value Account search.</summary>
		///
		// ------------------------------------------------------------------------------
		private void Page_Load(object sender, System.EventArgs e)
		{
			try
			{
				workingStoredValueAccountData.Visible = ProvideWorkingSet;
				base.OnLoad(); // base list control manages loading data
				if (WorkflowMode != WorkflowMode.Internal)
				{
					if (Session["SearchAccounts/StoredValueAccountData"] != null)
					{
						_collection = (BLL.SortableList<BLL.Accounts.StoredValueAccount>)Session["SearchAccounts/StoredValueAccountData"];
					}
				}
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "SearchStoredValueAccountData.Page_Load"));
			}
			finally
			{
			}
		...
		private void editStoredValueAccount_StoredValueAccountAdded(BaseFormlUserControl sender, EntityEditEventArgs e)
		{
			...
			{
				Globals.AddErrorMessage(this.Page, "Collection already contains this Stored Value Account", new object[0]);
			}
			else
			{
		...
		private void dgPrimaryList_ItemDataBound(object sender, DataGridItemEventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "SearchStoredValueAccountData.dgPrimaryList_ItemDataBound"));
			}
			finally
			{
			}
		...
		// ------------------------------------------------------------------------------
		/// <summary>Set Stored Value Account information from the ui.</summary>
		///
		// ------------------------------------------------------------------------------
		...
		protected override void LoadCollectionFromDatabase()
		{
			try
			{
				...
				{
					_collection = BLL.Accounts.StoredValueAccountManager.GetManyStoredValueAccountDataByCriteria(debitAccountNumber, accountName, currencyCode, lastModifiedDateStart, lastModifiedDateEnd, out totalRecords, out maximumListSizeExceeded, this.DataOptions);
					Session["SearchAccounts/StoredValueAccountData"] = _collection;
		...
		public void dgPrimaryList_ItemCommand(object sender, EventArgs e)
		{
			...
			if (args.CommandName == "Add" || args.CommandName == "Edit" || args.CommandName == "Delete")
			{
				...
				{
					workingStoredValueAccountData.AddItem(item);
				}
		...
		private void Page_PreRender(object sender, EventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "SearchStoredValueAccountData.Page_PreRender"));
			}
			finally
			{
			}
		...
		// ------------------------------------------------------------------------------
		/// <summary>Clear search form for Stored Value Account.</summary>
		///
		// ------------------------------------------------------------------------------
		...
		// ------------------------------------------------------------------------------
		/// <summary>Perform search for Stored Value Account items.</summary>
		///
		// ------------------------------------------------------------------------------
		private void btnSearch_Click(object sender, EventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "SearchStoredValueAccountData.btnSearch_Click"));
			}
			finally
			{
			}
