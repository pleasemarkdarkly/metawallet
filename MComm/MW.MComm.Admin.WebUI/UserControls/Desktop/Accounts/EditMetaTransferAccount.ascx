...
<%@ Control Language="c#" AutoEventWireup="false" CodeFile ="EditMetaTransferAccount.ascx.cs" Inherits="MW.MComm.Admin.WebUI.UserControls.Desktop.Accounts.EditMetaTransferAccount" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
...
<wilson:masterpage id="Masterpage" runat="server" templatefile="~/Templates/Desktop/DetailControl.ascx">
	<wilson:contentregion id="Title" runat="server">
		<asp:Label id="lblTitle" CssClass="subtitle" Runat="server">Edit Meta&nbsp;Transfer&nbsp;Account</asp:Label>&nbsp;<asp:Label id="lblTitleMessage" CssClass="subtitle" Runat="server"></asp:Label>
	...
	<wilson:contentregion id="ItemInfo" runat="server">
		...
		<table>
			<tr>
				...
				<td>
					<span class="ID">
					<MODC:PropVal id="propAccountID" runat="server" prop="MetaTransferAccountItem.AccountID" cssclass="ID"></MODC:PropVal>
					</span>
				</td>
			</tr>
			<tr>
				...
				<td>
					<span class="ID">
					<MODC:PropVal id="propAccountName" runat="server" prop="MetaTransferAccountItem.AccountName" cssclass="ID"></MODC:PropVal>
					</span>
				</td>
			</tr>
		</table>
	...
	<MODC:PageSection id="Section_Basics" visible="false" runat="server">
		<table>
			...
			<tr>
				<td valign="top"><span class="FormLabelRequired"><asp:Label ID="lblMetaTransferAccountNumberDisplay" runat="server">Meta&nbsp;Transfer&nbsp;Account&nbsp;Number:</asp:Label></span></td>
				<td valign="top">
					<asp:TextBox id="txtMetaTransferAccountNumber" tabIndex="2" runat="server" maxLength="100" Width="150" CssClass="FormNormal"></asp:TextBox>
					<asp:RequiredFieldValidator id="valMetaTransferAccountNumberRequired" ControlToValidate="txtMetaTransferAccountNumber" EnableClientScript="False" Display="Dynamic" Runat="server" ErrorMessage="Please enter some text." ></asp:RequiredFieldValidator>
				</td>
			</tr>
			<tr>
				<td valign="top"><span class="FormLabelRequired"><asp:Label ID="lblPaymentInstitutionCodeDisplay" runat="server">Payment&nbsp;Institution:</asp:Label></span></td>
				<td valign="top">
					<asp:DropDownList id="ddlPaymentInstitutionCode" tabIndex="3" runat="server" CssClass="FormNormal"></asp:DropDownList>
					<asp:CompareValidator id="valPaymentInstitutionCode" ControlToValidate="ddlPaymentInstitutionCode" EnableClientScript="False" Display="Dynamic" Runat="server" Type="String" ValueToCompare="0" Operator="NotEqual" ErrorMessage="Please select a value from the list." ></asp:CompareValidator>
				</td>
			</tr>
			<tr>
	...
	<MODC:PageSection id="Section_Additional_Info" visible="false" runat="server">
		<table>
			<tr>
				...
				<td valign="top">
					<asp:TextBox id="txtDescription" tabIndex="9" runat="server" Width="300" CssClass="FormNormal" TextMode="MultiLine" Rows="5" Columns="100"></asp:TextBox>
				</td>
			</tr>
		</table>
	</MODC:PageSection>
