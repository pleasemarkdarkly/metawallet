...
<%@ Control Language="c#" AutoEventWireup="false" CodeFile ="EditFundAccountType.ascx.cs" Inherits="MW.MComm.Admin.WebUI.UserControls.Desktop.Accounts.EditFundAccountType" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
...
<wilson:masterpage id="Masterpage" runat="server" templatefile="~/Templates/Desktop/DetailControl.ascx">
	<wilson:contentregion id="Title" runat="server">
		<asp:Label id="lblTitle" CssClass="subtitle" Runat="server">Edit Fund&nbsp;Account&nbsp;Type</asp:Label>&nbsp;<asp:Label id="lblTitleMessage" CssClass="subtitle" Runat="server"></asp:Label>
	</wilson:contentregion>
	<wilson:contentregion id="ItemInfo" runat="server">
		<div class="IDSection" id="ItemInfoContent" runat="server">
		<table>
			<tr>
				<td>Fund&nbsp;Account&nbsp;Type&nbsp;Code:</td>
				<td>
					<span class="ID">
					<MODC:PropVal id="propFundAccountTypeCode" runat="server" prop="FundAccountTypeItem.FundAccountTypeCode" cssclass="ID"></MODC:PropVal>
					</span>
				</td>
			</tr>
			<tr>
				<td>Fund&nbsp;Account&nbsp;Type&nbsp;Name:</td>
				<td>
					<span class="ID">
					<MODC:PropVal id="propFundAccountTypeName" runat="server" prop="FundAccountTypeItem.FundAccountTypeName" cssclass="ID"></MODC:PropVal>
					</span>
				</td>
			</tr>
		</table>
	...
	<MODC:PageSection id="Section_Basics" visible="false" runat="server">
		<table>
			<tr>
				<td valign="top"><span class="FormLabelRequired"><asp:Label ID="lblFundAccountTypeCodeDisplay" runat="server">Fund&nbsp;Account&nbsp;Type&nbsp;Code:</asp:Label></span></td>
				<td valign="top">
					<asp:TextBox id="txtFundAccountTypeCode" tabIndex="1" runat="server" maxLength="5" Width="100" CssClass="FormNormal"></asp:TextBox>
					<asp:RangeValidator id="valFundAccountTypeCode" ControlToValidate="txtFundAccountTypeCode" EnableClientScript="False" Display="Dynamic" Runat="server" Type="Integer" MinimumValue="-2147483648" MaximumValue="2147483647" ErrorMessage="Must be a valid int from -2147483648 to 2147483647." ></asp:RangeValidator>
					<asp:RequiredFieldValidator id="valFundAccountTypeCodeRequired" ControlToValidate="txtFundAccountTypeCode" EnableClientScript="False" Display="Dynamic" Runat="server" ErrorMessage="Please enter a valid int from 1 to 2147483647." ></asp:RequiredFieldValidator>
				</td>
			</tr>
			<tr>
				<td valign="top"><span class="FormLabelRequired"><asp:Label ID="lblFundAccountTypeNameDisplay" runat="server">Fund&nbsp;Account&nbsp;Type&nbsp;Name:</asp:Label></span></td>
				<td valign="top">
					<asp:TextBox id="txtFundAccountTypeName" tabIndex="2" runat="server" maxLength="255" Width="300" CssClass="FormNormal"></asp:TextBox>
					<asp:RequiredFieldValidator id="valFundAccountTypeNameRequired" ControlToValidate="txtFundAccountTypeName" EnableClientScript="False" Display="Dynamic" Runat="server" ErrorMessage="Please enter some text." ></asp:RequiredFieldValidator>
				</td>
			</tr>
			<tr>
