...
{
	// ------------------------------------------------------------------------------
	/// <summary>List Credit Account Data is used to help manage CreditAccount information.</summary>
	///
	/// File History:
	...
	/// <remarks></remarks>
	// ------------------------------------------------------------------------------
	public partial class ListCreditAccountData  : Components.Desktop.BaseListUserControl
	{
		#region Fields
		#endregion Fields
		#region Properties
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "ListCreditAccountData.Page_Load"));
			}
			finally
			{
			}
		...
		private void editCreditAccount_CreditAccountRemoved(BaseFormlUserControl sender, EntityEditEventArgs e)
		{
			...
			Globals.AddStatusMessage("Credit Account removed.");
		}
		// ------------------------------------------------------------------------------
		...
		private void dgPrimaryList_ItemDataBound(object sender, DataGridItemEventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "ListCreditAccountData.dgPrimaryList_ItemDataBound"));
			}
			finally
			{
			}
		...
		protected override void LoadCollectionFromDatabase()
		{
			...
			{
				_collection = BLL.Accounts.CreditAccountManager.GetAllCreditAccountDataByAccountID(accountID, Globals.DBOptions, DataOptions, Globals.DebugLevel, Globals.CurrentUserID);
			}
			else
			{
				_collection = BLL.Accounts.CreditAccountManager.GetAllCreditAccountData(Globals.DBOptions, DataOptions, Globals.DebugLevel, Globals.CurrentUserID);
			}
		}
		// ------------------------------------------------------------------------------
		...
		public void dgPrimaryList_ItemCommand(object sender, EventArgs e)
		{
			...
			if (args.CommandName == "Edit" || args.CommandName == "Delete")
			{
				...
				if (args.CommandName == "Edit")
				{
					...
					this.editCreditAccount.AccessMode = MOD.Data.AccessMode.Edit;
				}
				else if (args.CommandName == "Delete")
				{
					Globals.ClearMessages();
					_collection.Remove(item);
					if (this.editCreditAccount.CreditAccountItem == item)
					{
						this.editCreditAccount.AccessMode = MOD.Data.AccessMode.Add;
					}
					Globals.AddStatusMessage("Credit Account removed.");
				}
			}
		...
		private void Page_PreRender(object sender, EventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "ListCreditAccountData.Page_PreRender"));
			}
			finally
			{
			}
