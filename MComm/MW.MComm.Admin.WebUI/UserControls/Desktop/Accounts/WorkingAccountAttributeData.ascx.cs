...
{
	// ------------------------------------------------------------------------------
	/// <summary>Working Account Attribute Data is used to help manage AccountAttribute information.</summary>
	///
	/// File History:
	...
	/// <remarks></remarks>
	// ------------------------------------------------------------------------------
	public partial class WorkingAccountAttributeData  : Components.Desktop.BaseListUserControl
	{
		#region Fields
		#endregion Fields
		#region Properties
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "WorkingAccountAttributeData.Page_Load"));
			}
			finally
			{
			}
		...
		private void dgPrimaryList_ItemDataBound(object sender, DataGridItemEventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "WorkingAccountAttributeData.dgPrimaryList_ItemDataBound"));
			}
			finally
			{
			}
		...
		{
			_collection = (BLL.SortableList<BLL.Accounts.AccountAttribute>) Session["Accounts/AccountAttributeWorkingSet"];
			if (_collection != null)
			{
				((BLL.SortableList<BLL.Accounts.AccountAttribute>)_collection).Sort(SortColumn, SortDirection);
		...
		public void dgPrimaryList_ItemCommand(object sender, EventArgs e)
		{
			...
			if (_collection != null)
			{
				...
				else if (args.CommandName == "Select")
				{
					int hashCode = int.Parse(args.CommandArgument.ToString());
					BLL.Accounts.AccountAttribute item = ((BLL.SortableList<BLL.Accounts.AccountAttribute>)_collection).Find(hashCode);
					Session["Accounts/AccountAttributeWorkingSetItem"] = item.PrimaryIndex;
				}
			}
		}
		// ------------------------------------------------------------------------------
		...
		///
		// ------------------------------------------------------------------------------
		public void AddItem(BLL.Accounts.AccountAttribute item)
		{
			_collection = (BLL.SortableList<BLL.Accounts.AccountAttribute>) Session["Accounts/AccountAttributeWorkingSet"];
			if (_collection == null)
			{
				_collection = new BLL.SortableList<BLL.Accounts.AccountAttribute>();
			}
			...
			else
			{
				...
				TotalRecords = _collection.Count;
				Session["Accounts/AccountAttributeWorkingSetItem"] = item.PrimaryIndex;
				Globals.AddStatusMessage("Account Attribute working set item added.");
			}
			Session["Accounts/AccountAttributeWorkingSet"] = _collection;
		}
		// ------------------------------------------------------------------------------
		/// <summary>Item command event handler for Account Attribute list.</summary>
		///
		// ------------------------------------------------------------------------------
		public void RemoveItem(BLL.Accounts.AccountAttribute item)
		{
			Globals.ClearMessages();
			_collection = (BLL.SortableList<BLL.Accounts.AccountAttribute>) Session["Accounts/AccountAttributeWorkingSet"];
			if (_collection != null)
			{
				...
				Globals.AddStatusMessage("Account Attribute working set item removed.");
			}
			Session["Accounts/AccountAttributeWorkingSet"] = _collection;
		}
		// ------------------------------------------------------------------------------
		...
		private void Page_PreRender(object sender, EventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "WorkingAccountAttributeData.Page_PreRender"));
			}
			finally
			{
			}
