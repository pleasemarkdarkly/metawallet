...
<%@ Control Language="c#" AutoEventWireup="false" CodeFile ="EditNotificationLog.ascx.cs" Inherits="MW.MComm.Admin.WebUI.UserControls.Desktop.Notifications.EditNotificationLog" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
...
<%@ Register TagPrefix="MOD" TagName="ListNotificationAttributeValueLogData" Src="~/UserControls/Desktop/Notifications/ListNotificationAttributeValueLogData.ascx" %>
<%@ Register TagPrefix="MOD" TagName="ListNotificationDeliveryLogData" Src="~/UserControls/Desktop/Notifications/ListNotificationDeliveryLogData.ascx" %>
<wilson:masterpage id="Masterpage" runat="server" templatefile="~/Templates/Desktop/DetailControl.ascx">
	<wilson:contentregion id="Title" runat="server">
		<asp:Label id="lblTitle" CssClass="subtitle" Runat="server">Edit Notification&nbsp;Log</asp:Label>&nbsp;<asp:Label id="lblTitleMessage" CssClass="subtitle" Runat="server"></asp:Label>
	</wilson:contentregion>
	<wilson:contentregion id="ItemInfo" runat="server">
		<div class="IDSection" id="ItemInfoContent" runat="server">
		<table>
			<tr>
				<td>Notification&nbsp;Log&nbsp;ID:</td>
				<td>
					<span class="ID">
					<MODC:PropVal id="propNotificationLogID" runat="server" prop="NotificationLogItem.NotificationLogID" cssclass="ID"></MODC:PropVal>
					</span>
				</td>
			</tr>
		</table>
	...
	<wilson:contentregion id="DetailNavigation" runat="server">
		...
		<MOD:PageSectionLinks id="sectionLinks" runat="server" CssClass="SectionLink" SelectedCssClass="selSectionLink" ValidationList="Basics,Additional_Info" SectionList="Basics,Additional_Info,Notification_Attribute_Value_Logs,Notification_Delivery_Logs"></MOD:PageSectionLinks>
		</div>
	</wilson:contentregion>
	...
	<MODC:PageSection id="Section_Basics" visible="false" runat="server">
		<table>
			<tr>
				<td valign="top"><span class="FormLabelRequired"><asp:Label ID="lblNotificationLogIDDisplay" runat="server">Notification&nbsp;Log&nbsp;ID:</asp:Label></span></td>
				<td valign="top">
					<asp:Label id="lblNotificationLogID" runat="server" CssClass="FormNormal"></asp:Label>
				</td>
			</tr>
			<tr>
	...
	<MODC:PageSection id="Section_Additional_Info" visible="false" runat="server">
		<table>
			<tr>
				<td valign="top"><span class="FormLabelOptional"><asp:Label ID="lblNotificationSubjectDisplay" runat="server">Notification&nbsp;Subject:</asp:Label></span></td>
				<td valign="top">
					<asp:TextBox id="txtNotificationSubject" tabIndex="4" runat="server" maxLength="255" Width="300" CssClass="FormNormal"></asp:TextBox>
				</td>
			</tr>
			<tr>
				<td valign="top"><span class="FormLabelOptional"><asp:Label ID="lblNotificationMessageDisplay" runat="server">Notification&nbsp;Message:</asp:Label></span></td>
				<td valign="top">
					<asp:TextBox id="txtNotificationMessage" tabIndex="5" runat="server" maxLength="2147483647" Width="300" CssClass="FormNormal" TextMode="MultiLine" Rows="5" Columns="50"></asp:TextBox>
				</td>
			</tr>
		</table>
	</MODC:PageSection>
	<MODC:PageSection id="Section_Notification_Attribute_Value_Logs" visible="false" runat="server">
		<MOD:ListNotificationAttributeValueLogData id="listNotificationAttributeValueLogData" ListTitle="Notification&nbsp;Attribute&nbsp;Value&nbsp;Logs" WorkflowMode="Internal" AccessMode="Add" DisplayMode="SingleView" RequiresAuthentication="true" runat="server"></MOD:ListNotificationAttributeValueLogData>
	</MODC:PageSection>
	<MODC:PageSection id="Section_Notification_Delivery_Logs" visible="false" runat="server">
		<MOD:ListNotificationDeliveryLogData id="listNotificationDeliveryLogData" ListTitle="Notification&nbsp;Delivery&nbsp;Logs" WorkflowMode="Internal" AccessMode="Add" DisplayMode="SingleView" RequiresAuthentication="true" runat="server"></MOD:ListNotificationDeliveryLogData>
	</MODC:PageSection>
</wilson:masterpage>