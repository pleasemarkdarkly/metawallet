...
{
	// ------------------------------------------------------------------------------
	/// <summary>Working Site Label Data is used to help manage SiteLabel information.</summary>
	///
	/// File History:
	...
	/// <remarks></remarks>
	// ------------------------------------------------------------------------------
	public partial class WorkingSiteLabelData  : Components.Desktop.BaseListUserControl
	{
		#region Fields
		#endregion Fields
		#region Properties
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "WorkingSiteLabelData.Page_Load"));
			}
			finally
			{
			}
		...
		private void dgPrimaryList_ItemDataBound(object sender, DataGridItemEventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "WorkingSiteLabelData.dgPrimaryList_ItemDataBound"));
			}
			finally
			{
			}
		...
		{
			_collection = (BLL.SortableList<BLL.UserExperience.SiteLabel>) Session["UserExperience/SiteLabelWorkingSet"];
			if (_collection != null)
			{
				((BLL.SortableList<BLL.UserExperience.SiteLabel>)_collection).Sort(SortColumn, SortDirection);
		...
		public void dgPrimaryList_ItemCommand(object sender, EventArgs e)
		{
			...
			if (_collection != null)
			{
				...
				else if (args.CommandName == "Select")
				{
					int hashCode = int.Parse(args.CommandArgument.ToString());
					BLL.UserExperience.SiteLabel item = ((BLL.SortableList<BLL.UserExperience.SiteLabel>)_collection).Find(hashCode);
					Session["UserExperience/SiteLabelWorkingSetItem"] = item.PrimaryIndex;
				}
			}
		}
		// ------------------------------------------------------------------------------
		...
		///
		// ------------------------------------------------------------------------------
		public void AddItem(BLL.UserExperience.SiteLabel item)
		{
			_collection = (BLL.SortableList<BLL.UserExperience.SiteLabel>) Session["UserExperience/SiteLabelWorkingSet"];
			if (_collection == null)
			{
				_collection = new BLL.SortableList<BLL.UserExperience.SiteLabel>();
			}
			...
			else
			{
				...
				TotalRecords = _collection.Count;
				Session["UserExperience/SiteLabelWorkingSetItem"] = item.PrimaryIndex;
				Globals.AddStatusMessage("Site Label working set item added.");
			}
			Session["UserExperience/SiteLabelWorkingSet"] = _collection;
		}
		// ------------------------------------------------------------------------------
		/// <summary>Item command event handler for Site Label list.</summary>
		///
		// ------------------------------------------------------------------------------
		public void RemoveItem(BLL.UserExperience.SiteLabel item)
		{
			Globals.ClearMessages();
			_collection = (BLL.SortableList<BLL.UserExperience.SiteLabel>) Session["UserExperience/SiteLabelWorkingSet"];
			if (_collection != null)
			{
				...
				Globals.AddStatusMessage("Site Label working set item removed.");
			}
			Session["UserExperience/SiteLabelWorkingSet"] = _collection;
		}
		// ------------------------------------------------------------------------------
		...
		private void Page_PreRender(object sender, EventArgs e)
		{
			...
			{
				base.HandleError(CoreUtility.CustomAppException.WrapException(ex, "WorkingSiteLabelData.Page_PreRender"));
			}
			finally
			{
			}
