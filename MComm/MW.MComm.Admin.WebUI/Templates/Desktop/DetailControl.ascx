...
<%@ Control Language="c#" Inherits="MW.MComm.Admin.WebUI.Templates.Desktop.DetailControl" CodeFile="DetailControl.ascx.cs" %>
...
<div>
    ...
    <div style="margin-bottom: 5px"></div>
	<div>
		  <wilson:contentregion id="DetailNavigation" runat="server"></wilson:contentregion></div>
		  <div style="margin-bottom: 5px"></div>
	<div>
			<wilson:contentregion id="Content" runat="server"></wilson:contentregion></div>
		<!-- end content -->	
...
<div class="HelpPosition"><wilson:contentregion id="Help" runat="server"></wilson:contentregion></div>