...
<%@ Control Language="c#" Inherits="MW.MComm.Admin.WebUI.Templates.Desktop.FormControl" CodeFile="FormControl.ascx.cs" %>
<%@ Register TagPrefix="Wilson" Namespace="Wilson.MasterPages" Assembly="WilsonMasterPages" %>
<table>
	<tr>
		<td>
			<div class="subtitle"><wilson:contentregion id="Title" runat="server"></wilson:contentregion></div>
		</td>
	</tr>
	<tr>
		<td>
