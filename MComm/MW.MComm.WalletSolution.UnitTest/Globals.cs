...
namespace MW.MComm.WalletSolution.UnitTest
{
	...
	public class Globals : ApplicationOptionsProvider
	{
		...
		// ------------------------------------------------------------------
		/// <summary>This property retrieves the setting which determines whether all records created by unit testing should be deleted.</summary>
		// ------------------------------------------------------------------
		public static bool DeleteAllCreatedRecords
		{
			get
			{
				return Globals.getAppSettingBool("DeleteAllCreatedRecords", true);
			}
		}

		// ------------------------------------------------------------------
		/// <summary>This property retrieves the setting which determines whether lookup entity tests should be run.</summary>
		// ------------------------------------------------------------------
		public static bool RunLookupEntityTests
		{
			get
			{
				return Globals.getAppSettingBool("RunLookupEntityTests", true);
			}
		}

		// ------------------------------------------------------------------
		/// <summary>This property retrieves the setting which determines whether primary entity tests should be run.</summary>
		// ------------------------------------------------------------------
		public static bool RunPrimaryEntityTests
		{
			get
			{
				return Globals.getAppSettingBool("RunPrimaryEntityTests", true);
			}
		}

		// ------------------------------------------------------------------
		/// <summary>This property retrieves the setting which determines whether entity collection tests should be run.</summary>
		// ------------------------------------------------------------------
		public static bool RunCollectionTests
		{
			get
			{
				return Globals.getAppSettingBool("RunCollectionTests", true);
			}
		}

        // ------------------------------------------------------------------
        /// <summary>This property retrieves the setting which determines whether the database is a unit test db.</summary>
        // ------------------------------------------------------------------
        public static bool IsUnitTestConfiguration
        {
            get
            {
                return DBOptions.ConnectionString.Contains("_UnitTest");
            }
        }

		// ------------------------------------------------------------------
		/// <summary>This property retrieves the setting which determines at least how many records per entity can be added.</summary>
		// ------------------------------------------------------------------
		public static int MinimumLoadCountPerEntity
		{
			get
			{
				return Globals.getAppSettingInt("MinimumLoadCountPerEntity", 1);
			}
		}

		// ------------------------------------------------------------------
		/// <summary>This property retrieves the setting which determines at most how many records per entity can be added.</summary>
		// ------------------------------------------------------------------
		public static int MaximumLoadCountPerEntity
		{
			get
			{
				return Globals.getAppSettingInt("MaximumLoadCountPerEntity", 1000);
			}
		}

		// ------------------------------------------------------------------
		/// <summary>This property retrieves the setting which determines at least how many records per collection can be added.</summary>
		// ------------------------------------------------------------------
		public static int MinimumLoadCountPerCollection
		{
			get
			{
				return Globals.getAppSettingInt("MinimumLoadCountPerCollection", 1);
			}
		}

		// ------------------------------------------------------------------
		/// <summary>This property retrieves the setting which determines at most how many records per collection can be added.</summary>
		// ------------------------------------------------------------------
		public static int MaximumLoadCountPerCollection
		{
			get
			{
				return Globals.getAppSettingInt("MaximumLoadCountPerCollection", 10);
			}
		}

		// ------------------------------------------------------------------
		/// <summary>This property retrieves the setting which determines at least how many get all operations per entity can be done.</summary>
		// ------------------------------------------------------------------
		public static int MinimumGetAllCountPerEntity
		{
			get
			{
				return Globals.getAppSettingInt("MinimumGetAllCountPerEntity", 1);
			}
		}

		// ------------------------------------------------------------------
		/// <summary>This property retrieves the setting which determines at most how many get all operations per entity can be done.</summary>
		// ------------------------------------------------------------------
		public static int MaximumGetAllCountPerEntity
		{
			get
			{
				return Globals.getAppSettingInt("MaximumGetAllCountPerEntity", 100);
			}
		}
        ...
        // ------------------------------------------------------------------
        /// <summary>This method retrieves the expected factor of time for a serialization of an entity in relation to its search time.</summary>
        // ------------------------------------------------------------------
        public static double ExpectedSerializationPerfTimeFactor
        {
            get
            {
                // get value from application setting
                return MW.MComm.WalletSolution.BLL.Config.ConfigurationContext.Current.AllValues.GetDoubleValue("ExpectedSerializationPerfTimeFactor", 0.00);
            }
        }

        // ------------------------------------------------------------------
        /// <summary>This method retrieves the expected factor of time for a deserialization of an entity in relation to its search time.</summary>
        // ------------------------------------------------------------------
        public static double ExpectedDeserializationPerfTimeFactor
        {
            get
            {
                // get value from application setting
                return MW.MComm.WalletSolution.BLL.Config.ConfigurationContext.Current.AllValues.GetDoubleValue("ExpectedDeserializationPerfTimeFactor", 0.00);
            }
        }

        // ------------------------------------------------------------------
        /// <summary>This method retrieves the maximum factor of time for a serialization of an entity in relation to its search time before an error is signaled.</summary>
        // ------------------------------------------------------------------
        public static double MaximumSerializationPerfTimeFactor
        {
            get
            {
                // get value from application setting
                return MW.MComm.WalletSolution.BLL.Config.ConfigurationContext.Current.AllValues.GetDoubleValue("MaximumSerializationPerfTimeFactor", 0.00);
            }
        }

        // ------------------------------------------------------------------
        /// <summary>This method retrieves the maximum factor of time for a deserialization of an entity in relation to its search time before an error is signaled.</summary>
        // ------------------------------------------------------------------
        public static double MaximumDeserializationPerfTimeFactor
        {
            get
            {
                // get value from application setting
                return MW.MComm.WalletSolution.BLL.Config.ConfigurationContext.Current.AllValues.GetDoubleValue("MaximumDeserializationPerfTimeFactor", 0.00);
            }
        }
