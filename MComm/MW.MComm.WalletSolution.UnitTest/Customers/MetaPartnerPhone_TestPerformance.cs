...
namespace MW.MComm.WalletSolution.UnitTest.Customers
{
    ...
    /// <remarks></remarks>
    // ------------------------------------------------------------------------------
    [TestFixture, FixtureCategory("Performance.Customers"), Author("Common"), Importance(TestImportance.Serious), TestsOn(typeof(BLL.Customers.MetaPartnerPhone))]
    public partial class MetaPartnerPhone_TestPerformance : BaseUnitTest
    {
        ...
        // ------------------------------------------------------------------------------
        public MetaPartnerPhone_TestPerformance() : base()
        {
        }
        ...
        // ------------------------------------------------------------------------------
        /// <summary>This method is the performance entity test for MetaPartnerPhone.</summary>
        // ------------------------------------------------------------------------------
        [Test]
        public void Customers_MetaPartnerPhone_PerformanceTest()
        {
            try
            {
                Console.WriteLine("******************** Customers_MetaPartnerPhone_PerformanceTest START ********************");
                ...
                TestHelper.ReportValueToConsole("Customers_MetaPartnerPhone_PerformanceTest: Value generation method: Random seed -- Current ticks", currentTicks.ToString());
                ...
                {
                    TestHelper.ReportValueToConsole("Customers_MetaPartnerPhone_PerformanceTest: " + TestHelper.GetUnitTestPerformanceLevelString((UnitTestPerformanceLevel)(i + 1)) + " time (in seconds)", perfTimeLevels[i]);
                }
                TestHelper.ReportValueToConsole("Customers_MetaPartnerPhone_PerformanceTest: " + TestHelper.GetUnitTestPerformanceLevelString(UnitTestPerformanceLevel.Unacceptable) + " time (in seconds) is beyond", perfTimeLevels[(((int)UnitTestPerformanceLevel.Unacceptable - 1) - 1)]);
                ...
                TestHelper.ReportValueToConsole("Customers_MetaPartnerPhone_PerformanceTest: page size", pageSize);
                TestHelper.ReportValueToConsole("Customers_MetaPartnerPhone_PerformanceTest: maxListSize", maxListSize);
                ...
                TestHelper.ReportValueToConsole("Customers_MetaPartnerPhone_PerformanceTest: GetManyMetaPartnerPhoneDataByCriteria test count", loadCount.ToString());
                for (int i=0; i < loadCount; i++)
                {
                    long startTicks = 0;
                    long endTicks = 0;
                    double secondsInterval = 0.00;
                    BLL.SortableList<BLL.Customers.MetaPartnerPhone> items = null;

                    TestHelper.ReportValueToConsole("Customers_MetaPartnerPhone_PerformanceTest: Loop Iteration", i);
                    ...
                    TestHelper.ReportValueToConsole("Customers_MetaPartnerPhone_PerformanceTest: GetManyMetaPartnerPhoneDataByCriteria acceptable search time (in seconds)", acceptableTime);
                    try
                    {
                        // get many
                        Results.ResetCurrentPerfMetric();
                        Results.SetPerfMetricName("Customers.MetaPartnerPhone.GetMany." + i.ToString());
                        items = MetaPartnerPhone_Manager.GetManyMetaPartnerPhoneDataByCriteriaTest(dbOptions, Results);
                        TestHelper.ReportValueToConsole("Customers_MetaPartnerPhone_PerformanceTest: GetManyMetaPartnerPhoneDataByCriteria succeeded for MetaPartnerPhone. The count", items.Count.ToString());
                        ...
                        perfStr = "GetManyMetaPartnerPhoneDataByCriteria search time (in seconds) for MetaPartnerPhone count " + items.Count + " was " + avgCallsTime + ". " + TestHelper.GetUnitTestPerformanceLevelString(perfLevel) + ".";
                    ...
                    if (items != null)
                    {
                        TestHelper.ReportValueToConsole("Customers_MetaPartnerPhone_PerformanceTest: GetManyMetaPartnerPhoneDataByCriteria acceptable serialization time (in seconds)", acceptableTime);
                        try
                        {
                            // serialize
                            Results.ResetCurrentPerfMetric();
                            Results.SetPerfMetricName("Customers.MetaPartnerPhone.Serialize." + i.ToString());
                            ...
                            perfLevel = TestHelper.GetPerformanceLevelFromTime(avgCallsTime, perfTimeLevels);
                            perfStr = "GetManyMetaPartnerPhoneDataByCriteria serialization time (in seconds) for MetaPartnerPhone count " + items.Count + " was " + avgCallsTime + ". " + TestHelper.GetUnitTestPerformanceLevelString(perfLevel) + ".";
                            throw new UnitTestException(TestHelper.GetUnitTestErrorTypeForPerformanceLevel(perfLevel), perfStr, null);
                        }
                        catch (System.Exception ex)
                        {
                        ...
                        TestHelper.ReportValueToConsole("Customers_MetaPartnerPhone_PerformanceTest: GetManyMetaPartnerPhoneDataByCriteria acceptable deserialization time (in seconds)", acceptableTime);
                        try
                        {
                            // deserialize
                            Results.ResetCurrentPerfMetric();
                            Results.SetPerfMetricName("Customers.MetaPartnerPhone.Deserialize." + i.ToString());
                            ...
                            perfLevel = TestHelper.GetPerformanceLevelFromTime(avgCallsTime, perfTimeLevels);
                            perfStr = "GetManyMetaPartnerPhoneDataByCriteria deserialization time (in seconds) for MetaPartnerPhone count " + itemCount + " was " + avgCallsTime + ". " + TestHelper.GetUnitTestPerformanceLevelString(perfLevel) + ".";
                            throw new UnitTestException(TestHelper.GetUnitTestErrorTypeForPerformanceLevel(perfLevel), perfStr, null);
                        }
                        catch (System.Exception ex)
                        {
                ...
                if (numGetDataSearches > 0)
                {
                    ...
                    TestHelper.ReportValueToConsole("Customers_MetaPartnerPhone_PerformanceTest: GetManyMetaPartnerPhoneDataByCriteria AVERAGE SEARCH TIME (in seconds)", avgGetDataSearchSecs);
                }
                else
                {
                    Console.WriteLine("Customers_MetaPartnerPhone_PerformanceTest: GetManyMetaPartnerPhoneDataByCriteria -- Could not perform search. NO AVERAGE SEARCH TIME AVAILABLE.");
                }
                if (numSerializations > 0)
                {
                    avgSerializeDataSecs /= numSerializations;
                    TestHelper.ReportValueToConsole("Customers_MetaPartnerPhone_PerformanceTest: GetManyMetaPartnerPhoneDataByCriteria AVERAGE SERIALIZATION TIME (in seconds)", avgSerializeDataSecs);
                }
                else
                {
                    Console.WriteLine("Customers_MetaPartnerPhone_PerformanceTest: GetManyMetaPartnerPhoneDataByCriteria -- Could not serialize. NO AVERAGE SERIALIZATION TIME AVAILABLE.");
                }
                if (numDeserializations > 0)
                {
                    avgDeserializeDataSecs /= numDeserializations;
                    TestHelper.ReportValueToConsole("Customers_MetaPartnerPhone_PerformanceTest: GetManyMetaPartnerPhoneDataByCriteria AVERAGE DESERIALIZATION TIME (in seconds)", avgDeserializeDataSecs);
                }
                else
                {
                    Console.WriteLine("Customers_MetaPartnerPhone_PerformanceTest: GetManyMetaPartnerPhoneDataByCriteria -- Could not deserialize. NO AVERAGE DESERIALIZATION TIME AVAILABLE.");
                }
                ...
                Console.WriteLine("******************** Customers_MetaPartnerPhone_PerformanceTest END **********************");
                Console.WriteLine();
                Console.WriteLine();
                if ((ErrorIndex > 0) || (WarningIndex > 0))
                {
                    Console.WriteLine("==================== Customers_MetaPartnerPhone_PerformanceTest Error/Warning Details ====");
                    Console.WriteLine();
                }
            }
            catch (System.Exception ex)
