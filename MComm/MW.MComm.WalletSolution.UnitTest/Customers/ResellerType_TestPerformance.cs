...
namespace MW.MComm.WalletSolution.UnitTest.Customers
{
    ...
    /// <remarks></remarks>
    // ------------------------------------------------------------------------------
    [TestFixture, FixtureCategory("Performance.Customers"), Author("Common"), Importance(TestImportance.Serious), TestsOn(typeof(BLL.Customers.ResellerType))]
    public partial class ResellerType_TestPerformance : BaseUnitTest
    {
        ...
        // ------------------------------------------------------------------------------
        public ResellerType_TestPerformance() : base()
        {
        }
        ...
        // ------------------------------------------------------------------------------
        /// <summary>This method is the performance entity test for ResellerType.</summary>
        // ------------------------------------------------------------------------------
        [Test]
        public void Customers_ResellerType_PerformanceTest()
        {
            try
            {
                Console.WriteLine("******************** Customers_ResellerType_PerformanceTest START ********************");
                ...
                Console.WriteLine("GetAllResellerTypeData test count is {0}.", loadCount.ToString());
                for (int i=0; i < loadCount; i++)
                {
                    try
                    {
                        BLL.SortableList<BLL.Customers.ResellerType> items = ResellerType_Manager.GetAllResellerTypeDataTest(Results);
                        Console.WriteLine("GetAllResellerTypeData succeeded for ResellerType.");
                        ...
                        items = (BLL.SortableList<BLL.Customers.ResellerType>)oItems;
                        oItems = null;
                        items = null;
                    }
                    catch (System.Exception ex)
                    {
                        ...
                        {
                            UpdateUnitTestErrorInfo(UnitTestErrorType.Functional, "GetAllResellerTypeData failed for ResellerType", itemStr, ex, strExtraInfo);
                        }
                    }
                }

                Console.WriteLine("******************** Customers_ResellerType_PerformanceTest END **********************");
                Console.WriteLine();
                Console.WriteLine();
                if ((ErrorIndex > 0) || (WarningIndex > 0))
                {
                    Console.WriteLine("==================== Customers_ResellerType_PerformanceTest Error/Warning Details ====");
                    Console.WriteLine();
                }
            }
            catch (System.Exception ex)
