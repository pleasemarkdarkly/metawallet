...
namespace MW.MComm.WalletSolution.UnitTest.UserExperience
{
    ...
    /// <remarks></remarks>
    // ------------------------------------------------------------------------------
    [TestFixture, FixtureCategory("Performance.UserExperience"), Author("Common"), Importance(TestImportance.Serious), TestsOn(typeof(BLL.UserExperience.SiteLabelDefinition))]
    public partial class SiteLabelDefinition_TestPerformance : BaseUnitTest
    {
        ...
        // ------------------------------------------------------------------------------
        public SiteLabelDefinition_TestPerformance() : base()
        {
        }
        ...
        // ------------------------------------------------------------------------------
        /// <summary>This method is the performance entity test for SiteLabelDefinition.</summary>
        // ------------------------------------------------------------------------------
        [Test]
        public void UserExperience_SiteLabelDefinition_PerformanceTest()
        {
            try
            {
                Console.WriteLine("******************** UserExperience_SiteLabelDefinition_PerformanceTest START ********************");
                ...
                Console.WriteLine("GetAllSiteLabelDefinitionData test count is {0}.", loadCount.ToString());
                for (int i=0; i < loadCount; i++)
                {
                    try
                    {
                        BLL.SortableList<BLL.UserExperience.SiteLabelDefinition> items = SiteLabelDefinition_Manager.GetAllSiteLabelDefinitionDataTest(Results);
                        Console.WriteLine("GetAllSiteLabelDefinitionData succeeded for SiteLabelDefinition.");
                        ...
                        items = (BLL.SortableList<BLL.UserExperience.SiteLabelDefinition>)oItems;
                        oItems = null;
                        items = null;
                    }
                    catch (System.Exception ex)
                    {
                        ...
                        {
                            UpdateUnitTestErrorInfo(UnitTestErrorType.Functional, "GetAllSiteLabelDefinitionData failed for SiteLabelDefinition", itemStr, ex, strExtraInfo);
                        }
                    }
                }

                Console.WriteLine("******************** UserExperience_SiteLabelDefinition_PerformanceTest END **********************");
                Console.WriteLine();
                Console.WriteLine();
                if ((ErrorIndex > 0) || (WarningIndex > 0))
                {
                    Console.WriteLine("==================== UserExperience_SiteLabelDefinition_PerformanceTest Error/Warning Details ====");
                    Console.WriteLine();
                }
            }
            catch (System.Exception ex)
