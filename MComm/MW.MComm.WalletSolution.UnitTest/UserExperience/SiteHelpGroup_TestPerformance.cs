...
namespace MW.MComm.WalletSolution.UnitTest.UserExperience
{
    ...
    /// <remarks></remarks>
    // ------------------------------------------------------------------------------
    [TestFixture, FixtureCategory("Performance.UserExperience"), Author("Common"), Importance(TestImportance.Serious), TestsOn(typeof(BLL.UserExperience.SiteHelpGroup))]
    public partial class SiteHelpGroup_TestPerformance : BaseUnitTest
    {
        ...
        // ------------------------------------------------------------------------------
        public SiteHelpGroup_TestPerformance() : base()
        {
        }
        ...
        // ------------------------------------------------------------------------------
        /// <summary>This method is the performance entity test for SiteHelpGroup.</summary>
        // ------------------------------------------------------------------------------
        [Test]
        public void UserExperience_SiteHelpGroup_PerformanceTest()
        {
            try
            {
                Console.WriteLine("******************** UserExperience_SiteHelpGroup_PerformanceTest START ********************");
                ...
                Console.WriteLine("GetAllSiteHelpGroupData test count is {0}.", loadCount.ToString());
                for (int i=0; i < loadCount; i++)
                {
                    try
                    {
                        BLL.SortableList<BLL.UserExperience.SiteHelpGroup> items = SiteHelpGroup_Manager.GetAllSiteHelpGroupDataTest(Results);
                        Console.WriteLine("GetAllSiteHelpGroupData succeeded for SiteHelpGroup.");
                        ...
                        items = (BLL.SortableList<BLL.UserExperience.SiteHelpGroup>)oItems;
                        oItems = null;
                        items = null;
                    }
                    catch (System.Exception ex)
                    {
                        ...
                        {
                            UpdateUnitTestErrorInfo(UnitTestErrorType.Functional, "GetAllSiteHelpGroupData failed for SiteHelpGroup", itemStr, ex, strExtraInfo);
                        }
                    }
                }

                Console.WriteLine("******************** UserExperience_SiteHelpGroup_PerformanceTest END **********************");
                Console.WriteLine();
                Console.WriteLine();
                if ((ErrorIndex > 0) || (WarningIndex > 0))
                {
                    Console.WriteLine("==================== UserExperience_SiteHelpGroup_PerformanceTest Error/Warning Details ====");
                    Console.WriteLine();
                }
            }
            catch (System.Exception ex)
