...
namespace MW.MComm.WalletSolution.UnitTest.Payments
{
    ...
    /// <remarks></remarks>
    // ------------------------------------------------------------------------------
    [TestFixture, FixtureCategory("Basic.Payments"), Author("Common"), Importance(TestImportance.Serious), TestsOn(typeof(BLL.Payments.PaymentTransactionAttributeValueLog))]
    public partial class PaymentTransactionAttributeValueLog_TestBasic : BaseUnitTest
    {
        ...
        // ------------------------------------------------------------------------------
        public PaymentTransactionAttributeValueLog_TestBasic() : base()
        {
        }
        ...
        // ------------------------------------------------------------------------------
        /// <summary>This method is the basic entity test for PaymentTransactionAttributeValueLog.</summary>
        // ------------------------------------------------------------------------------
        [Test]
        public void Payments_PaymentTransactionAttributeValueLog_BasicTest()
        {
            try
            {
                ...
                Console.WriteLine("******************** Payments_PaymentTransactionAttributeValueLog_BasicTest START ********************");
                ...
                BLL.Payments.PaymentTransactionAttributeValueLog item = null;
                int currentTicks = (int)DateTime.Now.Ticks;
                TestHelper.ReportValueToConsole("Payments_PaymentTransactionAttributeValueLog_BasicTest: Value generation method: Random seed -- Current ticks", currentTicks.ToString());
                ...
                TestHelper.ReportValueToConsole("Payments_PaymentTransactionAttributeValueLog_BasicTest: Next entity add load count", loadCount.ToString());
                ...
                // add items
                //
                TestHelper.ReportValueToConsole("Payments_PaymentTransactionAttributeValueLog_BasicTest: Add PaymentTransactionAttributeValueLog count", loadCount.ToString());
                for (int i=0; i < loadCount; i++)
                {
                    Results.IsCollision = false;
                    try
                    {
                        item = PaymentTransactionAttributeValueLog_Manager.AddOnePaymentTransactionAttributeValueLogTest(true, Results);
                        ...
                        else
                        {
                            ...
                            entityID["PaymentTransactionAttributeValueLogID"] = item.PaymentTransactionAttributeValueLogID;
                            idList.Add(entityID);
                            TestHelper.ReportValueToConsole("Payments_PaymentTransactionAttributeValueLog_BasicTest: Add succeeded for PaymentTransactionAttributeValueLog", item.PrimaryKey.ToString());
                            ...
                            item = (BLL.Payments.PaymentTransactionAttributeValueLog)oItem;
                            oItem = null;
                            item = null;
                        }
                    }
                    catch (System.Exception ex)
                    {
                        ...
                        {
                            UpdateUnitTestErrorInfo(UnitTestErrorType.Functional, "Serialization failed for PaymentTransactionAttributeValueLog", itemStr, serialEx, strExtraInfo);
                        }
                        ...
                        {
                            UpdateUnitTestErrorInfo(UnitTestErrorType.Functional, "Add failed for PaymentTransactionAttributeValueLog", itemStr, ex, strExtraInfo);
                        }
                    }
                }

                // TODO: Assert Warning if PaymentTransactionAttributeValueLog Add count is not the same as Update count
                ...
                Console.WriteLine("******************** Payments_PaymentTransactionAttributeValueLog_BasicTest END **********************");
                Console.WriteLine();
                Console.WriteLine();
                if ((ErrorIndex > 0) || (WarningIndex > 0))
                {
                    Console.WriteLine("==================== Payments_PaymentTransactionAttributeValueLog_BasicTest Error/Warning Details ====");
                    Console.WriteLine();
                }
            }
            catch (System.Exception ex)
