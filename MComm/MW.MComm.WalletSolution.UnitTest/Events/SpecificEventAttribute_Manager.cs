...
namespace MW.MComm.WalletSolution.UnitTest.Events
{
    ...
    public partial class SpecificEventAttribute_Manager
    {
        ...
        // ------------------------------------------------------------------------------
        public SpecificEventAttribute_Manager()
        {
            //
            // constructor logic
            //
        ...
        // ------------------------------------------------------------------------------
        /// <summary>This method is used to add SpecificEventAttribute items.</summary>
        // ------------------------------------------------------------------------------
        public static void PopulateItem(BLL.Events.SpecificEventAttribute item, MOD.Data.NamedObjectCollection useCollections, bool performCascade, bool isAddOperation, bool isCollectionOperation, MOD.Test.TestResults results)
        {
            if (item == null)
            {
                return;
            ...
            //
            // populate the SpecificEventAttribute item
            //
            int totalRecords = 0;
