...
namespace MW.MComm.WalletSolution.UnitTest.Notifications
{
    ...
    /// <remarks></remarks>
    // ------------------------------------------------------------------------------
    [TestFixture, FixtureCategory("Search.Notifications"), Author("Common"), Importance(TestImportance.Serious), TestsOn(typeof(BLL.Notifications.NotificationDeliveryType))]
    public partial class NotificationDeliveryType_TestSearch : BaseUnitTest
    {
        ...
        // ------------------------------------------------------------------------------
        public NotificationDeliveryType_TestSearch() : base()
        {
        }
        ...
        // ------------------------------------------------------------------------------
        /// <summary>This method is the search entity test for NotificationDeliveryType.</summary>
        // ------------------------------------------------------------------------------
        [Test]
        public void Notifications_NotificationDeliveryType_SearchTest()
        {
            try
            {
                Console.WriteLine("******************** Notifications_NotificationDeliveryType_SearchTest START ********************");
                ...
                Console.WriteLine("******************** Notifications_NotificationDeliveryType_SearchTest END **********************");
                Console.WriteLine();
                Console.WriteLine();
                if ((ErrorIndex > 0) || (WarningIndex > 0))
                {
                    Console.WriteLine("==================== Notifications_NotificationDeliveryType_SearchTest Error/Warning Details ====");
                    Console.WriteLine();
                }
            }
            catch (System.Exception ex)
