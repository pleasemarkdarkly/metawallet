...
namespace MW.MComm.WalletSolution.UnitTest.Notifications
{
    ...
    /// <remarks></remarks>
    // ------------------------------------------------------------------------------
    [TestFixture, FixtureCategory("Basic.Notifications"), Author("Common"), Importance(TestImportance.Serious), TestsOn(typeof(BLL.Notifications.NotificationAttributeValueLog))]
    public partial class NotificationAttributeValueLog_TestBasic : BaseUnitTest
    {
        ...
        // ------------------------------------------------------------------------------
        public NotificationAttributeValueLog_TestBasic() : base()
        {
        }
        ...
        // ------------------------------------------------------------------------------
        /// <summary>This method is the basic entity test for NotificationAttributeValueLog.</summary>
        // ------------------------------------------------------------------------------
        [Test]
        public void Notifications_NotificationAttributeValueLog_BasicTest()
        {
            try
            {
                ...
                Console.WriteLine("******************** Notifications_NotificationAttributeValueLog_BasicTest START ********************");
                ...
                BLL.Notifications.NotificationAttributeValueLog item = null;
                int currentTicks = (int)DateTime.Now.Ticks;
                TestHelper.ReportValueToConsole("Notifications_NotificationAttributeValueLog_BasicTest: Value generation method: Random seed -- Current ticks", currentTicks.ToString());
                ...
                TestHelper.ReportValueToConsole("Notifications_NotificationAttributeValueLog_BasicTest: Next entity add load count", loadCount.ToString());
                ...
                // add items
                //
                TestHelper.ReportValueToConsole("Notifications_NotificationAttributeValueLog_BasicTest: Add NotificationAttributeValueLog count", loadCount.ToString());
                for (int i=0; i < loadCount; i++)
                {
                    Results.IsCollision = false;
                    try
                    {
                        item = NotificationAttributeValueLog_Manager.AddOneNotificationAttributeValueLogTest(true, Results);
                        ...
                        else
                        {
                            ...
                            entityID["NotificationAttributeValueLogID"] = item.NotificationAttributeValueLogID;
                            idList.Add(entityID);
                            TestHelper.ReportValueToConsole("Notifications_NotificationAttributeValueLog_BasicTest: Add succeeded for NotificationAttributeValueLog", item.PrimaryKey.ToString());
                            ...
                            item = (BLL.Notifications.NotificationAttributeValueLog)oItem;
                            oItem = null;
                            item = null;
                        }
                    }
                    catch (System.Exception ex)
                    {
                        ...
                        {
                            UpdateUnitTestErrorInfo(UnitTestErrorType.Functional, "Serialization failed for NotificationAttributeValueLog", itemStr, serialEx, strExtraInfo);
                        }
                        ...
                        {
                            UpdateUnitTestErrorInfo(UnitTestErrorType.Functional, "Add failed for NotificationAttributeValueLog", itemStr, ex, strExtraInfo);
                        }
                    }
                }

                // TODO: Assert Warning if NotificationAttributeValueLog Add count is not the same as Update count
                ...
                Console.WriteLine("******************** Notifications_NotificationAttributeValueLog_BasicTest END **********************");
                Console.WriteLine();
                Console.WriteLine();
                if ((ErrorIndex > 0) || (WarningIndex > 0))
                {
                    Console.WriteLine("==================== Notifications_NotificationAttributeValueLog_BasicTest Error/Warning Details ====");
                    Console.WriteLine();
                }
            }
            catch (System.Exception ex)
