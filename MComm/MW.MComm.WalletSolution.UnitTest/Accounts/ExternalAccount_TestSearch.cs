...
namespace MW.MComm.WalletSolution.UnitTest.Accounts
{
    ...
    /// <remarks></remarks>
    // ------------------------------------------------------------------------------
    [TestFixture, FixtureCategory("Search.Accounts"), Author("Common"), Importance(TestImportance.Serious), TestsOn(typeof(BLL.Accounts.ExternalAccount))]
    public partial class ExternalAccount_TestSearch : BaseUnitTest
    {
        ...
        // ------------------------------------------------------------------------------
        public ExternalAccount_TestSearch() : base()
        {
        }
        ...
        // ------------------------------------------------------------------------------
        /// <summary>This method is the search entity test for ExternalAccount.</summary>
        // ------------------------------------------------------------------------------
        [Test]
        public void Accounts_ExternalAccount_SearchTest()
        {
            try
            {
                Console.WriteLine("******************** Accounts_ExternalAccount_SearchTest START ********************");
                ...
                TestHelper.ReportValueToConsole("Accounts_ExternalAccount_SearchTest: Value generation method: Random seed -- Current ticks", currentTicks.ToString());
                ...
                Console.WriteLine("******************** Accounts_ExternalAccount_SearchTest END **********************");
                Console.WriteLine();
                Console.WriteLine();
                if ((ErrorIndex > 0) || (WarningIndex > 0))
                {
                    Console.WriteLine("==================== Accounts_ExternalAccount_SearchTest Error/Warning Details ====");
                    Console.WriteLine();
                }
            }
